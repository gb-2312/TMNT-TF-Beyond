...
- D 1 - I - 0x0268CF 09:A8BF: CC A8     .word ofs_050_A8CC_00_проверка_условий_для_запуска_таймер_для_прилета_сплинтера
...
ofs_050_A8CC_00_проверка_условий_для_запуска_таймер_для_прилета_сплинтера:
