...
.export loc_0x03D228
.export loc_0x03D266
.export sub_0x03D269_записать_FF_в_буфер_с_индексом_X
.export loc_0x03D269_записать_FF_в_буфер_с_индексом_X
.export sub_0x03D26B_записать_FF_в_буфер
.export loc_0x03D26B_записать_FF_в_буфер
.export sub_0x03D26D_записать_A_в_буфер_с_чтением_индекса
.export loc_0x03D26D_записать_A_в_буфер_с_чтением_индекса
.export sub_0x03D26F_записать_A_в_буфер_без_чтения_индекса
...
.export sub_0x03F6D2
.export loc_0x03F6D2
.export sub_0x03F6F5_нарисовать_на_экране
.export loc_0x03F6F5_нарисовать_на_экране
.export sub_0x03F724
.export loc_0x03F724
...
.incbin "DPCM.bin"
; todo добавить последний байт из 0x03CF50 в DPCM
...
C - - - - - 0x03D07C 0F:D06C: 9D 80 04  STA ram_obj_0480,X
C - - - - - 0x03D07F 0F:D06F: 9D 90 04  STA ram_obj_0490,X
...
C - - - - - 0x03D085 0F:D075: 9D 60 04  STA ram_obj_0460,X
C - - - - - 0x03D088 0F:D078: 9D 70 04  STA ram_obj_0470,X
...
C - - - - - 0x03D08F 0F:D07F: DD D0 05  CMP ram_obj_05D0,X
C - - - - - 0x03D092 0F:D082: B0 03     BCS bra_D087
C - - - - - 0x03D094 0F:D084: 9D D0 05  STA ram_obj_05D0,X
bra_D087:
C - - - - - 0x03D097 0F:D087: B9 B3 D0  LDA tbl_D0B3_индекс,Y
C - - - - - 0x03D09A 0F:D08A: 85 00     STA ram_0000
C - - - - - 0x03D09C 0F:D08C: DE C0 05  DEC ram_obj_anim_timer,X
C - - - - - 0x03D09F 0F:D08F: 10 14     BPL bra_D0A5
C - - - - - 0x03D0A1 0F:D091: DE D0 05  DEC ram_obj_05D0,X
C - - - - - 0x03D0A4 0F:D094: 10 06     BPL bra_D09C
C - - - - - 0x03D0A6 0F:D096: B9 E7 D0  LDA tbl_D0E7_колво_картинок_в_анимации,Y
C - - - - - 0x03D0A9 0F:D099: 9D D0 05  STA ram_obj_05D0,X
bra_D09C:
C - - - - - 0x03D0AC 0F:D09C: B9 CD D0  LDA tbl_D0CD_продолжительность_кадра_анимации,Y
C - - - - - 0x03D0AF 0F:D09F: 20 0E E1  JSR sub_E10E
C - - - - - 0x03D0B2 0F:D0A2: 9D C0 05  STA ram_obj_anim_timer,X
bra_D0A5:
C - - - - - 0x03D0B5 0F:D0A5: 18        CLC
C - - - - - 0x03D0B6 0F:D0A6: A5 00     LDA ram_0000
C - - - - - 0x03D0B8 0F:D0A8: 7D D0 05  ADC ram_obj_05D0,X
C - - - - - 0x03D0BB 0F:D0AB: A8        TAY
C - - - - - 0x03D0BC 0F:D0AC: B9 01 D1  LDA tbl_D101_анимация,Y
C - - - - - 0x03D0BF 0F:D0AF: 9D 00 04  STA ram_plr_anim_id,X
...
tbl_D0CD_продолжительность_кадра_анимации:
; задержка между кадрами анимаций
- D 2 - - - 0x03D0DD 0F:D0CD: 0A        .byte $0A   ; 00
- - - - - - 0x03D0DE 0F:D0CE: 02        .byte $02   ; 01
- D 2 - - - 0x03D0DF 0F:D0CF: 08        .byte $08   ; 02
- D 2 - - - 0x03D0E0 0F:D0D0: 03        .byte $03   ; 03
- D 2 - - - 0x03D0E1 0F:D0D1: 05        .byte $05   ; 04
- D 2 - - - 0x03D0E2 0F:D0D2: 05        .byte $05   ; 05
- D 2 - - - 0x03D0E3 0F:D0D3: 07        .byte $07   ; 06
- D 2 - - - 0x03D0E4 0F:D0D4: 07        .byte $07   ; 07
- D 2 - - - 0x03D0E5 0F:D0D5: 06        .byte $06   ; 08
- D 2 - - - 0x03D0E6 0F:D0D6: 06        .byte $06   ; 09
- D 2 - - - 0x03D0E7 0F:D0D7: 06        .byte $06   ; 0A
- D 2 - - - 0x03D0E8 0F:D0D8: 08        .byte $08   ; 0B
- D 2 - - - 0x03D0E9 0F:D0D9: 0A        .byte $0A   ; 0C
- D 2 - - - 0x03D0EA 0F:D0DA: 0A        .byte $0A   ; 0D
- D 2 - - - 0x03D0EB 0F:D0DB: 08        .byte $08   ; 0E
- D 2 - - - 0x03D0EC 0F:D0DC: 06        .byte $06   ; 0F
- D 2 - - - 0x03D0ED 0F:D0DD: 08        .byte $08   ; 10
- D 2 - - - 0x03D0EE 0F:D0DE: 08        .byte $08   ; 11
- D 2 - - - 0x03D0EF 0F:D0DF: 03        .byte $03   ; 12
- D 2 - - - 0x03D0F0 0F:D0E0: 06        .byte $06   ; 13
- D 2 - - - 0x03D0F1 0F:D0E1: 06        .byte $06   ; 14
- D 2 - - - 0x03D0F2 0F:D0E2: 06        .byte $06   ; 15
- D 2 - - - 0x03D0F3 0F:D0E3: 06        .byte $06   ; 16
- D 2 - - - 0x03D0F4 0F:D0E4: 04        .byte $04   ; 17
- D 2 - - - 0x03D0F5 0F:D0E5: 03        .byte $03   ; 18
- D 2 - - - 0x03D0F6 0F:D0E6: 06        .byte $06   ; 19
...
con_D104_01_len = * - off_D104_01 - $01
...
C - - - - - 0x03D17C 0F:D16C: BD 10 05  LDA ram_obj_0510,X
...
C - - - - - 0x03D189 0F:D179: 9D 10 05  STA ram_obj_0510,X
...
C - - - - - 0x03D199 0F:D189: BD 10 05  LDA ram_obj_0510,X
...
C - - - - - 0x03D1B2 0F:D1A2: 9D 90 04  STA ram_obj_0490,X
C - - - - - 0x03D1B5 0F:D1A5: A5 00     LDA ram_0000
C - - - - - 0x03D1B7 0F:D1A7: 9D 80 04  STA ram_obj_0480,X
...
C - - - - - 0x03D1C9 0F:D1B9: BD 80 04  LDA ram_obj_0480,X
...
C - - - - - 0x03D1D7 0F:D1C7: 7D 90 04  ADC ram_obj_0490,X
C - - - - - 0x03D1DA 0F:D1CA: 9D 90 04  STA ram_obj_0490,X
C - - - - - 0x03D1DD 0F:D1CD: A5 00     LDA ram_0000
C - - - - - 0x03D1DF 0F:D1CF: 7D 80 04  ADC ram_obj_0480,X
C - - - - - 0x03D1E2 0F:D1D2: 9D 80 04  STA ram_obj_0480,X
bra_D1D5_RTS:
...
C - - - - - 0x03D1F2 0F:D1E2: BC 20 05  LDY ram_obj_0520,X
...
C - - - - - 0x03D22B 0F:D21B: BD 10 05  LDA ram_obj_0510,X
C - - - - - 0x03D22E 0F:D21E: 29 BF     AND #$BF
C - - - - - 0x03D230 0F:D220: 05 00     ORA ram_0000
C - - - - - 0x03D232 0F:D222: 9D 10 05  STA ram_obj_0510,X
...
C - - - - - 0x03D23C 0F:D22C: BD 40 04  LDA ram_obj_pos_X,X
C - - - - - 0x03D23F 0F:D22F: D9 40 04  CMP ram_obj_pos_X,Y
...
; 0x03D27B можно неплохо оптимизировать, если просто написать прямой код
loc_0x03D266:
C D 2 - - - 0x03D266 0F:D256: 20 5D D2  JSR sub_D25D_записать_A_в_буфер_с_чтением_индекса
...
C - - - - - 0x03D31E 0F:D30E: A5 2C     LDA ram_002C
...
C - - - - - 0x03D335 0F:D325: A9 2D     LDA #$2D
C - - - - - 0x03D337 0F:D327: 4C 90 F6  JMP loc_F690
bra_D32A:
...
C - - - - - 0x03D34A 0F:D33A: A9 05     LDA #$05
...
C - - - - - 0x03D35A 0F:D34A: 20 7C D3  JSR sub_D37C_вычислить_поинтер_палитры
...
; bzk optimize
sub_D37C_вычислить_поинтер_палитры:
...
; bzk optimize
tbl_D392:
- D 2 - - - 0x03D3A2 0F:D392: EA        .byte < (tbl_0x02EFFA_палитра + $2600)

tbl_D393:
- D 2 - - - 0x03D3A3 0F:D393: D5        .byte > (tbl_0x02EFFA_палитра + $2600)
...
C - - - - - 0x03D601 0F:D5F1: B9 CB B2  LDA tbl_0x0272DA + $01,Y
C - - - - - 0x03D604 0F:D5F4: 95 35     STA ram_0035,X
C - - - - - 0x03D606 0F:D5F6: 60        RTS
bra_D5F7:
; night палитра
- - - - - - 0x03D607 0F:D5F7: B9 9B D6  LDA tbl_D69B,Y
- - - - - - 0x03D60A 0F:D5FA: 95 34     STA ram_0034,X
- - - - - - 0x03D60C 0F:D5FC: B9 9C D6  LDA tbl_D69B + $01,Y
...
sub_D60F:
C - - - - - 0x03D61F 0F:D60F: A5 31     LDA ram_0031
...
; bzk garbage
- - - - - - 0x03D629 0F:D619: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03D630 0F:D620: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03D640 0F:D630: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03D650 0F:D640: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03D660 0F:D650: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03D670 0F:D660: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03D680 0F:D670: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03D690 0F:D680: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03D6A0 0F:D690: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
...
C - - - - - 0x03D747 0F:D737: BD 00 04  LDA ram_plr_anim_id,X
C - - - - - 0x03D74A 0F:D73A: F0 52     BEQ bra_D78E
C - - - - - 0x03D74C 0F:D73C: BC 30 04  LDY ram_obj_0430,X
...
bra_D747:
C - - - - - 0x03D757 0F:D747: BD 00 04  LDA ram_plr_anim_id,X
...
C - - - - - 0x03D764 0F:D754: AD 26 05  LDA ram_obj_0520 + $06
bra_D757:
...
C - - - - - 0x03D76D 0F:D75D: BC 00 05  LDY ram_obj_0500,X
C - - - - - 0x03D770 0F:D760: 84 00     STY ram_0000
C - - - - - 0x03D772 0F:D762: BC 10 04  LDY ram_obj_pos_Y,X
...
C - - - - - 0x03D784 0F:D774: BC 40 04  LDY ram_obj_pos_X,X
C - - - - - 0x03D787 0F:D777: 84 02     STY ram_0002
C - - - - - 0x03D789 0F:D779: BC 10 05  LDY ram_obj_0510,X
C - - - - - 0x03D78C 0F:D77C: 84 06     STY ram_0006
C - - - - - 0x03D78E 0F:D77E: BD 00 04  LDA ram_plr_anim_id,X
C - - - - - 0x03D791 0F:D781: 20 A3 D7  JSR sub_D7A3
C - - - - - 0x03D794 0F:D784: A6 05     LDX ram_0005
C - - - - - 0x03D796 0F:D786: BD 00 04  LDA ram_plr_anim_id,X
...
; bzk garbage
- - - - - - 0x03D89C 0F:D88C: 86 00     STX ram_0000
- - - - - - 0x03D89E 0F:D88E: A2 00     LDX #$00
- - - - - - 0x03D8A0 0F:D890: 85 02     STA ram_0002
- - - - - - 0x03D8A2 0F:D892: 29 F0     AND #$F0
- - - - - - 0x03D8A4 0F:D894: 85 01     STA ram_0001
- - - - - - 0x03D8A6 0F:D896: 45 02     EOR ram_0002
- - - - - - 0x03D8A8 0F:D898: 85 02     STA ram_0002
- - - - - - 0x03D8AA 0F:D89A: B5 00     LDA ram_0000,X
- - - - - - 0x03D8AC 0F:D89C: 29 0F     AND #$0F
- - - - - - 0x03D8AE 0F:D89E: 65 02     ADC ram_0002
- - - - - - 0x03D8B0 0F:D8A0: C9 0A     CMP #$0A
- - - - - - 0x03D8B2 0F:D8A2: 90 02     BCC bra_D8A6
- - - - - - 0x03D8B4 0F:D8A4: 69 05     ADC #$05
bra_D8A6:
- - - - - - 0x03D8B6 0F:D8A6: 65 01     ADC ram_0001
- - - - - - 0x03D8B8 0F:D8A8: 85 01     STA ram_0001
- - - - - - 0x03D8BA 0F:D8AA: B5 00     LDA ram_0000,X
- - - - - - 0x03D8BC 0F:D8AC: 29 F0     AND #$F0
- - - - - - 0x03D8BE 0F:D8AE: 65 01     ADC ram_0001
- - - - - - 0x03D8C0 0F:D8B0: B0 04     BCS bra_D8B6
- - - - - - 0x03D8C2 0F:D8B2: C9 A0     CMP #$A0
- - - - - - 0x03D8C4 0F:D8B4: 90 03     BCC bra_D8B9_RTS
bra_D8B6:
- - - - - - 0x03D8C6 0F:D8B6: E9 A0     SBC #$A0
- - - - - - 0x03D8C8 0F:D8B8: 38        SEC
bra_D8B9_RTS:
- - - - - - 0x03D8C9 0F:D8B9: 60        RTS


; bzk garbage
- - - - - - 0x03D8CA 0F:D8BA: 86 04     STX ram_0004
- - - - - - 0x03D8CC 0F:D8BC: 84 05     STY ram_0005
- - - - - - 0x03D8CE 0F:D8BE: 85 00     STA ram_0000
- - - - - - 0x03D8D0 0F:D8C0: A9 00     LDA #$00
- - - - - - 0x03D8D2 0F:D8C2: 85 01     STA ram_0001
- - - - - - 0x03D8D4 0F:D8C4: 85 02     STA ram_0002
- - - - - - 0x03D8D6 0F:D8C6: A0 08     LDY #$08
- - - - - - 0x03D8D8 0F:D8C8: 46 00     LSR ram_0000
bra_D8CA_loop:
- - - - - - 0x03D8DA 0F:D8CA: 90 0D     BCC bra_D8D9
- - - - - - 0x03D8DC 0F:D8CC: 18        CLC
- - - - - - 0x03D8DD 0F:D8CD: A5 04     LDA ram_0004
- - - - - - 0x03D8DF 0F:D8CF: 65 01     ADC ram_0001
- - - - - - 0x03D8E1 0F:D8D1: 85 01     STA ram_0001
- - - - - - 0x03D8E3 0F:D8D3: A5 05     LDA ram_0005
- - - - - - 0x03D8E5 0F:D8D5: 65 02     ADC ram_0002
- - - - - - 0x03D8E7 0F:D8D7: 85 02     STA ram_0002
bra_D8D9:
- - - - - - 0x03D8E9 0F:D8D9: 66 02     ROR ram_0002
- - - - - - 0x03D8EB 0F:D8DB: 66 01     ROR ram_0001
- - - - - - 0x03D8ED 0F:D8DD: 66 00     ROR ram_0000
- - - - - - 0x03D8EF 0F:D8DF: 88        DEY
- - - - - - 0x03D8F0 0F:D8E0: D0 E8     BNE bra_D8CA_loop
...
; bzk garbage
- - - - - - 0x03D942 0F:D932: A0 00     LDY #$00
- - - - - - 0x03D944 0F:D934: B9 40 04  LDA ram_obj_pos_X,Y
- - - - - - 0x03D947 0F:D937: 85 08     STA ram_0008
- - - - - - 0x03D949 0F:D939: B9 10 04  LDA ram_obj_pos_Y,Y
- - - - - - 0x03D94C 0F:D93C: 85 09     STA ram_0009
- - - - - - 0x03D94E 0F:D93E: BD 40 04  LDA ram_obj_pos_X,X
- - - - - - 0x03D951 0F:D941: 85 0A     STA ram_000A
- - - - - - 0x03D953 0F:D943: BD 10 04  LDA ram_obj_pos_Y,X
- - - - - - 0x03D956 0F:D946: 85 0B     STA ram_000B
- - - - - - 0x03D958 0F:D948: A9 00     LDA #$00
- - - - - - 0x03D95A 0F:D94A: 85 04     STA ram_0004
- - - - - - 0x03D95C 0F:D94C: A5 08     LDA ram_0008
- - - - - - 0x03D95E 0F:D94E: 38        SEC
- - - - - - 0x03D95F 0F:D94F: E5 0A     SBC ram_000A
- - - - - - 0x03D961 0F:D951: B0 05     BCS bra_D958
- - - - - - 0x03D963 0F:D953: E6 04     INC ram_0004
- - - - - - 0x03D965 0F:D955: 20 FC D1  JSR sub_D1FC_EOR
bra_D958:
- - - - - - 0x03D968 0F:D958: 85 00     STA ram_0000
- - - - - - 0x03D96A 0F:D95A: 85 06     STA ram_0006
- - - - - - 0x03D96C 0F:D95C: A5 09     LDA ram_0009
- - - - - - 0x03D96E 0F:D95E: 38        SEC
- - - - - - 0x03D96F 0F:D95F: E5 0B     SBC ram_000B
- - - - - - 0x03D971 0F:D961: 85 01     STA ram_0001
- - - - - - 0x03D973 0F:D963: B0 0B     BCS bra_D970
- - - - - - 0x03D975 0F:D965: A5 04     LDA ram_0004
- - - - - - 0x03D977 0F:D967: 09 02     ORA #$02
- - - - - - 0x03D979 0F:D969: 85 04     STA ram_0004
- - - - - - 0x03D97B 0F:D96B: A5 01     LDA ram_0001
- - - - - - 0x03D97D 0F:D96D: 20 FC D1  JSR sub_D1FC_EOR
bra_D970:
- - - - - - 0x03D980 0F:D970: 85 01     STA ram_0001
- - - - - - 0x03D982 0F:D972: 85 07     STA ram_0007
loc_D974_loop:
- - - - - - 0x03D984 0F:D974: A5 00     LDA ram_0000
- - - - - - 0x03D986 0F:D976: 29 F8     AND #$F8
- - - - - - 0x03D988 0F:D978: D0 06     BNE bra_D980
- - - - - - 0x03D98A 0F:D97A: A5 01     LDA ram_0001
- - - - - - 0x03D98C 0F:D97C: 29 F8     AND #$F8
- - - - - - 0x03D98E 0F:D97E: F0 07     BEQ bra_D987
bra_D980:
- - - - - - 0x03D990 0F:D980: 46 00     LSR ram_0000
- - - - - - 0x03D992 0F:D982: 46 01     LSR ram_0001
- - - - - - 0x03D994 0F:D984: 4C 74 D9  JMP loc_D974_loop
bra_D987:
- - - - - - 0x03D997 0F:D987: A5 00     LDA ram_0000
- - - - - - 0x03D999 0F:D989: 4A        LSR
- - - - - - 0x03D99A 0F:D98A: 85 02     STA ram_0002
- - - - - - 0x03D99C 0F:D98C: A5 01     LDA ram_0001
- - - - - - 0x03D99E 0F:D98E: 0A        ASL
- - - - - - 0x03D99F 0F:D98F: 0A        ASL
- - - - - - 0x03D9A0 0F:D990: 65 02     ADC ram_0002
- - - - - - 0x03D9A2 0F:D992: A8        TAY
- - - - - - 0x03D9A3 0F:D993: B9 BF D9  LDA tbl_D9BF,Y
- - - - - - 0x03D9A6 0F:D996: 85 02     STA ram_0002
- - - - - - 0x03D9A8 0F:D998: 46 00     LSR ram_0000
- - - - - - 0x03D9AA 0F:D99A: B0 03     BCS bra_D99F
- - - - - - 0x03D9AC 0F:D99C: 20 07 D2  JSR sub_D207_LSRx4
bra_D99F:
- - - - - - 0x03D9AF 0F:D99F: 29 0F     AND #$0F
- - - - - - 0x03D9B1 0F:D9A1: 85 05     STA ram_0005
- - - - - - 0x03D9B3 0F:D9A3: A4 04     LDY ram_0004
- - - - - - 0x03D9B5 0F:D9A5: F0 0B     BEQ bra_D9B2
- - - - - - 0x03D9B7 0F:D9A7: C0 03     CPY #$03
- - - - - - 0x03D9B9 0F:D9A9: F0 07     BEQ bra_D9B2
- - - - - - 0x03D9BB 0F:D9AB: A9 08     LDA #$08
- - - - - - 0x03D9BD 0F:D9AD: 38        SEC
- - - - - - 0x03D9BE 0F:D9AE: E5 05     SBC ram_0005
- - - - - - 0x03D9C0 0F:D9B0: 85 05     STA ram_0005
bra_D9B2:
- - - - - - 0x03D9C2 0F:D9B2: B9 BB D9  LDA tbl_D9BB,Y
- - - - - - 0x03D9C5 0F:D9B5: 18        CLC
- - - - - - 0x03D9C6 0F:D9B6: 65 05     ADC ram_0005
- - - - - - 0x03D9C8 0F:D9B8: 85 05     STA ram_0005
- - - - - - 0x03D9CA 0F:D9BA: 60        RTS


; bzk garbage
tbl_D9BB:
- - - - - - 0x03D9CB 0F:D9BB: 00        .byte $00   ; 
- - - - - - 0x03D9CC 0F:D9BC: 08        .byte $08   ; 
- - - - - - 0x03D9CD 0F:D9BD: 18        .byte $18   ; 
- - - - - - 0x03D9CE 0F:D9BE: 10        .byte $10   ; 


; bzk garbage
tbl_D9BF:
- - - - - - 0x03D9CF 0F:D9BF: 40        .byte $40   ; 
- - - - - - 0x03D9D0 0F:D9C0: 00        .byte $00   ; 
- - - - - - 0x03D9D1 0F:D9C1: 00        .byte $00   ; 
- - - - - - 0x03D9D2 0F:D9C2: 00        .byte $00   ; 
- - - - - - 0x03D9D3 0F:D9C3: 84        .byte $84   ; 
- - - - - - 0x03D9D4 0F:D9C4: 22        .byte $22   ; 
- - - - - - 0x03D9D5 0F:D9C5: 11        .byte $11   ; 
- - - - - - 0x03D9D6 0F:D9C6: 11        .byte $11   ; 
- - - - - - 0x03D9D7 0F:D9C7: 86        .byte $86   ; 
- - - - - - 0x03D9D8 0F:D9C8: 43        .byte $43   ; 
- - - - - - 0x03D9D9 0F:D9C9: 22        .byte $22   ; 
- - - - - - 0x03D9DA 0F:D9CA: 21        .byte $21   ; 
- - - - - - 0x03D9DB 0F:D9CB: 86        .byte $86   ; 
- - - - - - 0x03D9DC 0F:D9CC: 54        .byte $54   ; 
- - - - - - 0x03D9DD 0F:D9CD: 33        .byte $33   ; 
- - - - - - 0x03D9DE 0F:D9CE: 22        .byte $22   ; 
- - - - - - 0x03D9DF 0F:D9CF: 87        .byte $87   ; 
- - - - - - 0x03D9E0 0F:D9D0: 65        .byte $65   ; 
- - - - - - 0x03D9E1 0F:D9D1: 43        .byte $43   ; 
- - - - - - 0x03D9E2 0F:D9D2: 33        .byte $33   ; 
- - - - - - 0x03D9E3 0F:D9D3: 87        .byte $87   ; 
- - - - - - 0x03D9E4 0F:D9D4: 65        .byte $65   ; 
- - - - - - 0x03D9E5 0F:D9D5: 54        .byte $54   ; 
- - - - - - 0x03D9E6 0F:D9D6: 43        .byte $43   ; 
- - - - - - 0x03D9E7 0F:D9D7: 87        .byte $87   ; 
- - - - - - 0x03D9E8 0F:D9D8: 66        .byte $66   ; 
- - - - - - 0x03D9E9 0F:D9D9: 54        .byte $54   ; 
- - - - - - 0x03D9EA 0F:D9DA: 44        .byte $44   ; 
- - - - - - 0x03D9EB 0F:D9DB: 87        .byte $87   ; 
- - - - - - 0x03D9EC 0F:D9DC: 76        .byte $76   ; 
- - - - - - 0x03D9ED 0F:D9DD: 55        .byte $55   ; 
- - - - - - 0x03D9EE 0F:D9DE: 44        .byte $44   ; 
...
- - - - - - 0x03DA00 0F:D9F0: 20 4C DA  JSR sub_DA4C
- - - - - - 0x03DA03 0F:D9F3: A5 0C     LDA ram_000C
- - - - - - 0x03DA05 0F:D9F5: 85 03     STA ram_0003
- - - - - - 0x03DA07 0F:D9F7: 86 A8     STX ram_00A8
- - - - - - 0x03DA09 0F:D9F9: A6 08     LDX ram_0008
- - - - - - 0x03DA0B 0F:D9FB: A4 09     LDY ram_0009
- - - - - - 0x03DA0D 0F:D9FD: 20 83 DA  JSR sub_DA83
- - - - - - 0x03DA10 0F:DA00: A6 A8     LDX ram_00A8
- - - - - - 0x03DA12 0F:DA02: A5 01     LDA ram_0001
- - - - - - 0x03DA14 0F:DA04: 9D 80 04  STA ram_obj_0480,X
- - - - - - 0x03DA17 0F:DA07: A5 02     LDA ram_0002
- - - - - - 0x03DA19 0F:DA09: 9D 90 04  STA ram_obj_0490,X
- - - - - - 0x03DA1C 0F:DA0C: A5 0C     LDA ram_000C
- - - - - - 0x03DA1E 0F:DA0E: 85 03     STA ram_0003
- - - - - - 0x03DA20 0F:DA10: A6 0A     LDX ram_000A
- - - - - - 0x03DA22 0F:DA12: A4 0B     LDY ram_000B
- - - - - - 0x03DA24 0F:DA14: 20 83 DA  JSR sub_DA83
- - - - - - 0x03DA27 0F:DA17: A6 A8     LDX ram_00A8
- - - - - - 0x03DA29 0F:DA19: A5 02     LDA ram_0002
- - - - - - 0x03DA2B 0F:DA1B: 9D 70 04  STA ram_obj_0470,X
- - - - - - 0x03DA2E 0F:DA1E: A5 01     LDA ram_0001
- - - - - - 0x03DA30 0F:DA20: 9D 60 04  STA ram_obj_0460,X
- - - - - - 0x03DA33 0F:DA23: 60        RTS


; bzk garbage
sub_DA24:
- - - - - - 0x03DA34 0F:DA24: A9 00     LDA #$00
- - - - - - 0x03DA36 0F:DA26: 85 08     STA ram_0008
- - - - - - 0x03DA38 0F:DA28: 85 09     STA ram_0009
- - - - - - 0x03DA3A 0F:DA2A: A5 04     LDA ram_0004
- - - - - - 0x03DA3C 0F:DA2C: 29 0F     AND #$0F
- - - - - - 0x03DA3E 0F:DA2E: A8        TAY
- - - - - - 0x03DA3F 0F:DA2F: B9 73 DA  LDA tbl_DA73,Y
- - - - - - 0x03DA42 0F:DA32: 85 09     STA ram_0009
- - - - - - 0x03DA44 0F:DA34: A5 04     LDA ram_0004
- - - - - - 0x03DA46 0F:DA36: C9 08     CMP #$08
- - - - - - 0x03DA48 0F:DA38: 90 11     BCC bra_DA4B_RTS
- - - - - - 0x03DA4A 0F:DA3A: C9 18     CMP #$18
- - - - - - 0x03DA4C 0F:DA3C: B0 0D     BCS bra_DA4B_RTS
- - - - - - 0x03DA4E 0F:DA3E: A5 09     LDA ram_0009
- - - - - - 0x03DA50 0F:DA40: 20 FC D1  JSR sub_D1FC_EOR
- - - - - - 0x03DA53 0F:DA43: 85 09     STA ram_0009
- - - - - - 0x03DA55 0F:DA45: A5 08     LDA ram_0008
- - - - - - 0x03DA57 0F:DA47: 69 FF     ADC #$FF
- - - - - - 0x03DA59 0F:DA49: 85 08     STA ram_0008
bra_DA4B_RTS:
- - - - - - 0x03DA5B 0F:DA4B: 60        RTS


; bzk garbage
sub_DA4C:
- - - - - - 0x03DA5C 0F:DA4C: A9 00     LDA #$00
- - - - - - 0x03DA5E 0F:DA4E: 85 0A     STA ram_000A
- - - - - - 0x03DA60 0F:DA50: 85 0B     STA ram_000B
- - - - - - 0x03DA62 0F:DA52: A5 04     LDA ram_0004
- - - - - - 0x03DA64 0F:DA54: 18        CLC
- - - - - - 0x03DA65 0F:DA55: 69 08     ADC #$08
- - - - - - 0x03DA67 0F:DA57: 29 0F     AND #$0F
- - - - - - 0x03DA69 0F:DA59: A8        TAY
- - - - - - 0x03DA6A 0F:DA5A: B9 73 DA  LDA tbl_DA73,Y
- - - - - - 0x03DA6D 0F:DA5D: 85 0B     STA ram_000B
- - - - - - 0x03DA6F 0F:DA5F: A5 04     LDA ram_0004
- - - - - - 0x03DA71 0F:DA61: 29 10     AND #$10
- - - - - - 0x03DA73 0F:DA63: F0 0D     BEQ bra_DA72_RTS
- - - - - - 0x03DA75 0F:DA65: A5 0B     LDA ram_000B
- - - - - - 0x03DA77 0F:DA67: 20 FC D1  JSR sub_D1FC_EOR
- - - - - - 0x03DA7A 0F:DA6A: 85 0B     STA ram_000B
- - - - - - 0x03DA7C 0F:DA6C: A5 0A     LDA ram_000A
- - - - - - 0x03DA7E 0F:DA6E: 69 FF     ADC #$FF
- - - - - - 0x03DA80 0F:DA70: 85 0A     STA ram_000A
bra_DA72_RTS:
- - - - - - 0x03DA82 0F:DA72: 60        RTS


; bzk garbage
tbl_DA73:
- - - - - - 0x03DA83 0F:DA73: 80        .byte $80   ; 
- - - - - - 0x03DA84 0F:DA74: 7D        .byte $7D   ; 
- - - - - - 0x03DA85 0F:DA75: 75        .byte $75   ; 
- - - - - - 0x03DA86 0F:DA76: 6A        .byte $6A   ; 
- - - - - - 0x03DA87 0F:DA77: 59        .byte $59   ; 
- - - - - - 0x03DA88 0F:DA78: 47        .byte $47   ; 
- - - - - - 0x03DA89 0F:DA79: 30        .byte $30   ; 
- - - - - - 0x03DA8A 0F:DA7A: 19        .byte $19   ; 
- - - - - - 0x03DA8B 0F:DA7B: 00        .byte $00   ; 
- - - - - - 0x03DA8C 0F:DA7C: 19        .byte $19   ; 
- - - - - - 0x03DA8D 0F:DA7D: 30        .byte $30   ; 
- - - - - - 0x03DA8E 0F:DA7E: 47        .byte $47   ; 
- - - - - - 0x03DA8F 0F:DA7F: 59        .byte $59   ; 
- - - - - - 0x03DA90 0F:DA80: 6A        .byte $6A   ; 
- - - - - - 0x03DA91 0F:DA81: 75        .byte $75   ; 
- - - - - - 0x03DA92 0F:DA82: 7D        .byte $7D   ; 


; bzk garbage
sub_DA83:
- - - - - - 0x03DA93 0F:DA83: A9 00     LDA #$00
- - - - - - 0x03DA95 0F:DA85: 85 01     STA ram_0001
- - - - - - 0x03DA97 0F:DA87: 85 02     STA ram_0002
- - - - - - 0x03DA99 0F:DA89: 86 08     STX ram_0008
- - - - - - 0x03DA9B 0F:DA8B: 84 09     STY ram_0009
bra_DA8D_loop:
- - - - - - 0x03DA9D 0F:DA8D: A5 09     LDA ram_0009
- - - - - - 0x03DA9F 0F:DA8F: 18        CLC
- - - - - - 0x03DAA0 0F:DA90: 65 02     ADC ram_0002
- - - - - - 0x03DAA2 0F:DA92: 85 02     STA ram_0002
- - - - - - 0x03DAA4 0F:DA94: A5 08     LDA ram_0008
- - - - - - 0x03DAA6 0F:DA96: 65 01     ADC ram_0001
- - - - - - 0x03DAA8 0F:DA98: 85 01     STA ram_0001
- - - - - - 0x03DAAA 0F:DA9A: C6 03     DEC ram_0003
- - - - - - 0x03DAAC 0F:DA9C: D0 EF     BNE bra_DA8D_loop
...
C - - - - - 0x03DAF3 0F:DAE3: 9D 50 04  STA ram_obj_0450,X
C - - - - - 0x03DAF6 0F:DAE6: 9D 20 04  STA ram_obj_0420,X
...
C - - - - - 0x03DB0E 0F:DAFE: 9D 70 05  STA ram_obj_0570,X
C - - - - - 0x03DB11 0F:DB01: 9D 80 05  STA ram_obj_0580,X
C - - - - - 0x03DB14 0F:DB04: 20 30 E9  JSR sub_E930
C - - - - - 0x03DB17 0F:DB07: 9D A0 05  STA ram_obj_05A0,X
C - - - - - 0x03DB1A 0F:DB0A: 9D B0 05  STA ram_obj_05B0,X
C - - - - - 0x03DB1D 0F:DB0D: 9D C0 05  STA ram_obj_anim_timer,X
C - - - - - 0x03DB20 0F:DB10: 9D D0 05  STA ram_obj_05D0,X
C - - - - - 0x03DB23 0F:DB13: 9D E0 05  STA ram_obj_05E0,X
C - - - - - 0x03DB26 0F:DB16: 9D F0 05  STA ram_obj_05F0,X
C - - - - - 0x03DB29 0F:DB19: 9D A0 04  STA ram_obj_04A0,X
C - - - - - 0x03DB2C 0F:DB1C: 9D B0 04  STA ram_obj_04B0,X
...
bra_DB2B:
C - - - - - 0x03DB3B 0F:DB2B: 9D 60 04  STA ram_obj_0460,X
C - - - - - 0x03DB3E 0F:DB2E: 9D 70 04  STA ram_obj_0470,X
bra_DB31:
C - - - - - 0x03DB41 0F:DB31: 9D 80 04  STA ram_obj_0480,X
C - - - - - 0x03DB44 0F:DB34: 9D 90 04  STA ram_obj_0490,X
...
- - - - - - 0x03DB52 0F:DB42: 9D 60 04  STA ram_obj_0460,X
- - - - - - 0x03DB55 0F:DB45: 9D 70 04  STA ram_obj_0470,X
...
C - - - - - 0x03DB5F 0F:DB4F: BD 70 04  LDA ram_obj_0470,X
C - - - - - 0x03DB62 0F:DB52: 7D 20 04  ADC ram_obj_0420,X
C - - - - - 0x03DB65 0F:DB55: 9D 20 04  STA ram_obj_0420,X
C - - - - - 0x03DB68 0F:DB58: BD 60 04  LDA ram_obj_0460,X
C - - - - - 0x03DB6B 0F:DB5B: 10 01     BPL bra_DB5E
C - - - - - 0x03DB6D 0F:DB5D: 88        DEY
bra_DB5E:
C - - - - - 0x03DB6E 0F:DB5E: 7D 10 04  ADC ram_obj_pos_Y,X
C - - - - - 0x03DB71 0F:DB61: 9D 10 04  STA ram_obj_pos_Y,X
...
C - - - - - 0x03DB78 0F:DB68: BD 90 04  LDA ram_obj_0490,X
C - - - - - 0x03DB7B 0F:DB6B: 7D 50 04  ADC ram_obj_0450,X
C - - - - - 0x03DB7E 0F:DB6E: 9D 50 04  STA ram_obj_0450,X
C - - - - - 0x03DB81 0F:DB71: BD 80 04  LDA ram_obj_0480,X
C - - - - - 0x03DB84 0F:DB74: 10 01     BPL bra_DB77
C - - - - - 0x03DB86 0F:DB76: 88        DEY
bra_DB77:
C - - - - - 0x03DB87 0F:DB77: 7D 40 04  ADC ram_obj_pos_X,X
C - - - - - 0x03DB8A 0F:DB7A: 9D 40 04  STA ram_obj_pos_X,X
C - - - - - 0x03DB8D 0F:DB7D: 98        TYA
C - - - - - 0x03DB8E 0F:DB7E: 7D 30 04  ADC ram_obj_0430,X
C - - - - - 0x03DB91 0F:DB81: 9D 30 04  STA ram_obj_0430,X
...
- - - - - - 0x03DB9B 0F:DB8B: BD 70 04  LDA ram_obj_0470,X
- - - - - - 0x03DB9E 0F:DB8E: 7D 20 04  ADC ram_obj_0420,X
- - - - - - 0x03DBA1 0F:DB91: 85 05     STA ram_0005
- - - - - - 0x03DBA3 0F:DB93: BD 60 04  LDA ram_obj_0460,X
- - - - - - 0x03DBA6 0F:DB96: 10 01     BPL bra_DB99
- - - - - - 0x03DBA8 0F:DB98: 88        DEY
bra_DB99:
- - - - - - 0x03DBA9 0F:DB99: 7D 10 04  ADC ram_obj_pos_Y,X
- - - - - - 0x03DBAC 0F:DB9C: 85 04     STA ram_0004
sub_DB9E:
- - - - - - 0x03DBAE 0F:DB9E: A0 00     LDY #$00
- - - - - - 0x03DBB0 0F:DBA0: 18        CLC
- - - - - - 0x03DBB1 0F:DBA1: BD 90 04  LDA ram_obj_0490,X
- - - - - - 0x03DBB4 0F:DBA4: 7D 50 04  ADC ram_obj_0450,X
- - - - - - 0x03DBB7 0F:DBA7: 85 02     STA ram_0002
- - - - - - 0x03DBB9 0F:DBA9: BD 80 04  LDA ram_obj_0480,X
- - - - - - 0x03DBBC 0F:DBAC: 10 01     BPL bra_DBAF
- - - - - - 0x03DBBE 0F:DBAE: 88        DEY
bra_DBAF:
- - - - - - 0x03DBBF 0F:DBAF: 7D 40 04  ADC ram_obj_pos_X,X
...
C - - - - - 0x03DBC5 0F:DBB5: BD 50 04  LDA ram_obj_0450,X
C - - - - - 0x03DBC8 0F:DBB8: 99 50 04  STA ram_obj_0450,Y
C - - - - - 0x03DBCB 0F:DBBB: BD 40 04  LDA ram_obj_pos_X,X
C - - - - - 0x03DBCE 0F:DBBE: 99 40 04  STA ram_obj_pos_X,Y
C - - - - - 0x03DBD1 0F:DBC1: BD 30 04  LDA ram_obj_0430,X
C - - - - - 0x03DBD4 0F:DBC4: 99 30 04  STA ram_obj_0430,Y
C - - - - - 0x03DBD7 0F:DBC7: BD 20 04  LDA ram_obj_0420,X
C - - - - - 0x03DBDA 0F:DBCA: 99 20 04  STA ram_obj_0420,Y
C - - - - - 0x03DBDD 0F:DBCD: BD 10 04  LDA ram_obj_pos_Y,X
C - - - - - 0x03DBE0 0F:DBD0: 99 10 04  STA ram_obj_pos_Y,Y
...
tbl_DC29:
- - - - - - 0x03DC39 0F:DC29: 0D        .byte $0D, $09   ; 00
...
- - - - - - 0x03DC49 0F:DC39: 5C        .byte $5C, $5E   ; 10
...
C - - - - - 0x03DC6B 0F:DC5B: 7D 70 04  ADC ram_obj_0470,X
C - - - - - 0x03DC6E 0F:DC5E: 9D 70 04  STA ram_obj_0470,X
C - - - - - 0x03DC71 0F:DC61: 98        TYA
C - - - - - 0x03DC72 0F:DC62: 7D 60 04  ADC ram_obj_0460,X
C - - - - - 0x03DC75 0F:DC65: 9D 60 04  STA ram_obj_0460,X
C - - - - - 0x03DC78 0F:DC68: 60        RTS



sub_0x03DC79:
C - - - - - 0x03DC79 0F:DC69: BD 60 04  LDA ram_obj_0460,X
C - - - - - 0x03DC7C 0F:DC6C: 30 07     BMI bra_DC75
C - - - - - 0x03DC7E 0F:DC6E: A9 AF     LDA #$AF
C - - - - - 0x03DC80 0F:DC70: DD 10 04  CMP ram_obj_pos_Y,X
C - - - - - 0x03DC83 0F:DC73: 90 0F     BCC bra_DC84
bra_DC75:
C - - - - - 0x03DC85 0F:DC75: 20 92 DC  JSR sub_DC92
C - - - - - 0x03DC88 0F:DC78: BD 60 04  LDA ram_obj_0460,X
C - - - - - 0x03DC8B 0F:DC7B: 30 13     BMI bra_DC90
C - - - - - 0x03DC8D 0F:DC7D: A9 AF     LDA #$AF
C - - - - - 0x03DC8F 0F:DC7F: DD 10 04  CMP ram_obj_pos_Y,X
...
C - - - - - 0x03DCC5 0F:DCB5: 9D 90 04  STA ram_obj_0490,X
...
sub_0x03DCE6:
C - - - - - 0x03DCE6 0F:DCD6: 9D 60 04  STA ram_obj_0460,X
C - - - - - 0x03DCE9 0F:DCD9: 98        TYA
C - - - - - 0x03DCEA 0F:DCDA: 29 F0     AND #$F0
C - - - - - 0x03DCEC 0F:DCDC: 9D 70 04  STA ram_obj_0470,X
...
C - - - - - 0x03DCF3 0F:DCE3: 9D 80 04  STA ram_obj_0480,X
C - - - - - 0x03DCF6 0F:DCE6: 98        TYA
C - - - - - 0x03DCF7 0F:DCE7: 29 F0     AND #$F0
C - - - - - 0x03DCF9 0F:DCE9: 9D 90 04  STA ram_obj_0490,X
...
C - - - - - 0x03DCFF 0F:DCEF: DD 10 04  CMP ram_obj_pos_Y,X
...
C - - - - - 0x03DD10 0F:DD00: 9D 00 05  STA ram_obj_0500,X
C - - - - - 0x03DD13 0F:DD03: 60        RTS



sub_0x03DD14:
C - - - - - 0x03DD14 0F:DD04: BD 40 04  LDA ram_obj_pos_X,X
...
sub_0x03DD75:
loc_0x03DD75:
C D 2 - - - 0x03DD75 0F:DD65: BD 10 05  LDA ram_obj_0510,X
C - - - - - 0x03DD78 0F:DD68: 49 40     EOR #$40
C - - - - - 0x03DD7A 0F:DD6A: 9D 10 05  STA ram_obj_0510,X
...
C - - - - - 0x03DD99 0F:DD89: 59 80 04  EOR ram_obj_0480,Y
C - - - - - 0x03DD9C 0F:DD8C: 30 1A     BMI bra_DDA8
C - - - - - 0x03DD9E 0F:DD8E: BD 80 04  LDA ram_obj_0480,X
C - - - - - 0x03DDA1 0F:DD91: D9 80 04  CMP ram_obj_0480,Y
C - - - - - 0x03DDA4 0F:DD94: D0 06     BNE bra_DD9C
C - - - - - 0x03DDA6 0F:DD96: BD 90 04  LDA ram_obj_0490,X
C - - - - - 0x03DDA9 0F:DD99: D9 90 04  CMP ram_obj_0490,Y
bra_DD9C:
C - - - - - 0x03DDAC 0F:DD9C: BD 80 04  LDA ram_obj_0480,X
...
C - - - - - 0x03DDC2 0F:DDB2: 8D A6 04  STA ram_obj_04A0 + $06
...
;                                              |    |    |    |    |    |    +----- 06 shred
;                                              |    |    |    |    |    |    |
- D 2 - - - 0x03DDC6 0F:DDB6: FC        .byte $FC, $FD, $FC, $FC, $FE, $03, $FF   ; 00 leo
- D 2 - - - 0x03DDCD 0F:DDBD: FE        .byte $FE, $FD, $FC, $FD, $FE, $01, $00   ; 01 raph
- D 2 - - - 0x03DDD4 0F:DDC4: FD        .byte $FD, $FE, $FD, $FD, $FF, $05, $FF   ; 02 mike
- D 2 - - - 0x03DDDB 0F:DDCB: FC        .byte $FC, $FD, $FC, $FC, $FE, $03, $FF   ; 03 don
...
C - - - - - 0x03DE05 0F:DDF5: 9D 7A 06  STA ram_plr_067A,X
C - - - - - 0x03DE08 0F:DDF8: 9D 60 05  STA ram_obj_0560,X
...
sub_DE09_очистить_00AE_00B5:
sub_0x03DE19_очистить_00AE_00B5:
loc_0x03DE19_очистить_00AE_00B5:
C D 2 - - - 0x03DE19 0F:DE09: 20 16 DE  JSR sub_DE16_очистить_00B2_00B5
...
sub_DE16_очистить_00B2_00B5:
loc_DE16_очистить_00B2_00B5:
...
C - - - - - 0x03DEA7 0F:DE97: 9D E0 04  STA ram_obj_04E0,X
...
C - - - - - 0x03DEBF 0F:DEAF: 9D F0 05  STA ram_obj_05F0,X
C - - - - - 0x03DEC2 0F:DEB2: 38        SEC
C - - - - - 0x03DEC3 0F:DEB3: BD 90 05  LDA ram_obj_0590,X
...
C - - - - - 0x03DEE9 0F:DED9: B9 40 04  LDA ram_obj_pos_X,Y
C - - - - - 0x03DEEC 0F:DEDC: 99 4C 04  STA ram_044C,Y
C - - - - - 0x03DEEF 0F:DEDF: B9 10 04  LDA ram_obj_pos_Y,Y
...
C - - - - - 0x03DF07 0F:DEF7: 99 0C 04  STA ram_plr_040C,Y ; 040C 040D 
...
C - - - - - 0x03DF0D 0F:DEFD: DD 40 04  CMP ram_obj_pos_X,X
C - - - - - 0x03DF10 0F:DF00: 90 07     BCC bra_DF09
C - - - - - 0x03DF12 0F:DF02: A9 18     LDA #$18
C - - - - - 0x03DF14 0F:DF04: DD 40 04  CMP ram_obj_pos_X,X
C - - - - - 0x03DF17 0F:DF07: 90 03     BCC bra_DF0C_RTS
bra_DF09:
C - - - - - 0x03DF19 0F:DF09: 9D 40 04  STA ram_obj_pos_X,X
bra_DF0C_RTS:
...
sub_0x03DF1D:
C - - - - - 0x03DF1D 0F:DF0D: DD 10 04  CMP ram_obj_pos_Y,X
...
sub_0x03DF48:
loc_0x03DF48:
C D 2 - - - 0x03DF48 0F:DF38: 9D D0 05  STA ram_obj_05D0,X
C - - - - - 0x03DF4B 0F:DF3B: A9 00     LDA #$00
C - - - - - 0x03DF4D 0F:DF3D: 9D C0 05  STA ram_obj_anim_timer,X
bra_DF40_RTS:
...
C - - - - - 0x03DF61 0F:DF51: DE C0 05  DEC ram_obj_anim_timer,X
C - - - - - 0x03DF64 0F:DF54: 10 2F     BPL bra_DF85
C - - - - - 0x03DF66 0F:DF56: BD D0 05  LDA ram_obj_05D0,X
C - - - - - 0x03DF69 0F:DF59: F0 2A     BEQ bra_DF85
loc_DF5B:
C D 2 - - - 0x03DF6B 0F:DF5B: DE D0 05  DEC ram_obj_05D0,X
C - - - - - 0x03DF6E 0F:DF5E: BD D0 05  LDA ram_obj_05D0,X
...
C - - - - - 0x03DF79 0F:DF69: 9D C0 05  STA ram_obj_anim_timer,X
...
C - - - - - 0x03DF92 0F:DF82: 9D C0 05  STA ram_obj_anim_timer,X
bra_DF85:
C - - - - - 0x03DF95 0F:DF85: A4 00     LDY ram_0000
C - - - - - 0x03DF97 0F:DF87: BD D0 05  LDA ram_obj_05D0,X
...
C - - - - - 0x03DFC4 0F:DFB4: 8D 0D 04  STA ram_plr_040C + $01
...
C - - - - - 0x03DFD8 0F:DFC8: 9D 00 05  STA ram_obj_0500,X
...
tbl_DFE6:
off_E000_start = tbl_E000
- D 2 - - - 0x03DFF6 0F:DFE6: 00        .byte off_E000_00 - off_E000_start
- D 2 - - - 0x03DFF7 0F:DFE7: 06        .byte off_E006_01 - off_E000_start
- D 2 - - - 0x03DFF8 0F:DFE8: 12        .byte off_E012_02 - off_E000_start
- D 2 - - - 0x03DFF9 0F:DFE9: 1E        .byte off_E01E_03 - off_E000_start
- D 2 - - - 0x03DFFA 0F:DFEA: 26        .byte off_E026_04 - off_E000_start
- D 2 - - - 0x03DFFB 0F:DFEB: 3A        .byte off_E03A_05 - off_E000_start
- D 2 - - - 0x03DFFC 0F:DFEC: 58        .byte off_E058_06 - off_E000_start
- D 2 - - - 0x03DFFD 0F:DFED: 58        .byte off_E058_07 - off_E000_start
- D 2 - - - 0x03DFFE 0F:DFEE: 6A        .byte off_E06A_08 - off_E000_start
- D 2 - - - 0x03DFFF 0F:DFEF: 76        .byte off_E076_09 - off_E000_start
- D 2 - - - 0x03E000 0F:DFF0: 9C        .byte off_E09C_0A - off_E000_start
- D 2 - - - 0x03E001 0F:DFF1: A6        .byte off_E0A6_0B - off_E000_start
- D 2 - - - 0x03E002 0F:DFF2: AA        .byte off_E0AA_0C - off_E000_start
- D 2 - - - 0x03E003 0F:DFF3: B6        .byte off_E0B6_0D - off_E000_start
- D 2 - - - 0x03E004 0F:DFF4: C2        .byte off_E0C2_0E - off_E000_start
- D 2 - - - 0x03E005 0F:DFF5: CA        .byte off_E0CA_0F - off_E000_start
- D 2 - - - 0x03E006 0F:DFF6: CE        .byte off_E0CE_10 - off_E000_start
- D 2 - - - 0x03E007 0F:DFF7: D6        .byte off_E0D6_11 - off_E000_start
- D 2 - - - 0x03E008 0F:DFF8: DE        .byte off_E0DE_12 - off_E000_start
- D 2 - - - 0x03E009 0F:DFF9: E4        .byte off_E0E4_13 - off_E000_start
- D 2 - - - 0x03E00A 0F:DFFA: E4        .byte off_E0E4_14 - off_E000_start
- - - - - - 0x03E00B 0F:DFFB: E4        .byte off_E0E4_15 - off_E000_start
- D 2 - - - 0x03E00C 0F:DFFC: E4        .byte off_E0E4_16 - off_E000_start
- D 2 - - - 0x03E00D 0F:DFFD: EE        .byte off_E0EE_17 - off_E000_start
- D 2 - - - 0x03E00E 0F:DFFE: F2        .byte off_E0F2_18 - off_E000_start
- D 2 - - - 0x03E00F 0F:DFFF: F8        .byte off_E0F8_19 - off_E000_start
...
- D 3 - - - 0x03E082 0F:E072: 00        .byte $00, $06   ; 72
...
- D 3 - - - 0x03E0B2 0F:E0A2: 00        .byte $00, $06   ; A2
...
- - - - - - 0x03E119 0F:E109: 05        .byte $05   ; 02 mike
...
- - - - - - 0x03E1DC 0F:E1CC: FC E8     .word ofs_001_E8FC_20
...
C - - - - - 0x03E2B0 0F:E2A0: 20 5B D2  JSR sub_D25B_записать_FF_в_буфер
...
C - - - - - 0x03E31C 0F:E30C: 99 02 04  STA ram_plr_0402,Y ; 0402 0403 
...
C - - - - - 0x03E39F 0F:E38F: CE 60 05  DEC ram_obj_0560
C - - - - - 0x03E3A2 0F:E392: F0 11     BEQ bra_E3A5
C - - - - - 0x03E3A4 0F:E394: AC 60 05  LDY ram_obj_0560
...
- D 3 - - - 0x03E3E6 0F:E3D6: 00        .byte con_prg__bank + $00   ; 3B
- D 3 - - - 0x03E3E7 0F:E3D7: 00        .byte con_prg__bank + $00   ; 3C
...
- D 3 - - - 0x03E3E9 0F:E3D9: 04        .byte $04   ; 01 raph
- D 3 - - - 0x03E3EA 0F:E3DA: 04        .byte $04   ; 02 mike
- D 3 - - - 0x03E3EB 0F:E3DB: 04        .byte $04   ; 03 don
- D 3 - - - 0x03E3EC 0F:E3DC: 04        .byte $04   ; 04 casey
- D 3 - - - 0x03E3ED 0F:E3DD: 04        .byte $04   ; 05 hot
...
C - - - - - 0x03E43E 0F:E42E: 9D 10 04  STA ram_obj_pos_Y,X
...
C - - - - - 0x03E44F 0F:E43F: 9D 00 05  STA ram_obj_0500,X
...
C - - - - - 0x03E49D 0F:E48D: A4 2C     LDY ram_002C
C - - - - - 0x03E49F 0F:E48F: F0 03     BEQ bra_E494
...
C - - - - - 0x03E4A9 0F:E499: 8D 72 06  STA ram_0672
C - - - - - 0x03E4AC 0F:E49C: B9 7A E9  LDA tbl_E979 + $01,Y
C - - - - - 0x03E4AF 0F:E49F: 8D 73 06  STA ram_0673
C - - - - - 0x03E4B2 0F:E4A2: 60        RTS



ofs_001_E4A3_07:
C - - J - - 0x03E4B3 0F:E4A3: A4 2C     LDY ram_002C
C - - - - - 0x03E4B5 0F:E4A5: AD 72 06  LDA ram_0672
C - - - - - 0x03E4B8 0F:E4A8: 0D 73 06  ORA ram_0673
...
C - - - - - 0x03E4CC 0F:E4BC: B9 55 01  LDA ram_0155,Y
C - - - - - 0x03E4CF 0F:E4BF: 39 56 01  AND ram_0156,Y
...
C - - - - - 0x03E50F 0F:E4FF: DD 10 04  CMP ram_obj_pos_Y,X
C - - - - - 0x03E512 0F:E502: B0 E2     BCS bra_E4E6
C - - - - - 0x03E514 0F:E504: BD 90 05  LDA ram_obj_0590,X
C - - - - - 0x03E517 0F:E507: F0 07     BEQ bra_E510
C - - - - - 0x03E519 0F:E509: BD 45 06  LDA ram_0645,X
C - - - - - 0x03E51C 0F:E50C: D0 D8     BNE bra_E4E6
; bzk optimize
C - - - - - 0x03E51E 0F:E50E: EA        NOP
C - - - - - 0x03E51F 0F:E50F: EA        NOP
bra_E510:
...
- - - - - - 0x03E532 0F:E522: A9 29     LDA #$29
- - - - - - 0x03E534 0F:E524: 20 8B F6  JSR sub_F68B
...
C - - - - - 0x03E54C 0F:E53C: 8D B0 04  STA ram_obj_04B0
...
C - - - - - 0x03E569 0F:E559: 4E B0 04  LSR ram_obj_04B0
C - - - - - 0x03E56C 0F:E55C: 60        RTS



ofs_001_E55D_09:
C - - J - - 0x03E56D 0F:E55D: AD B0 04  LDA ram_obj_04B0
...
C - - - - - 0x03E577 0F:E567: CE B0 04  DEC ram_obj_04B0
bra_E56A_RTS:
C - - - - - 0x03E57A 0F:E56A: 60        RTS
bra_E56B:
C - - - - - 0x03E57B 0F:E56B: A6 2C     LDX ram_002C
...
C - - - - - 0x03E599 0F:E589: A6 2C     LDX ram_002C
...
C - - - - - 0x03E5CC 0F:E5BC: A4 2C     LDY ram_002C
C - - - - - 0x03E5CE 0F:E5BE: 88        DEY
C - - - - - 0x03E5CF 0F:E5BF: F0 4D     BEQ bra_E60E
- - - - - - 0x03E5D1 0F:E5C1: 4C 7D E6  JMP loc_E67D
bra_E5C4:
sub_E5C4:
C - - - - - 0x03E5D4 0F:E5C4: A9 05     LDA #$05
C - - - - - 0x03E5D6 0F:E5C6: 85 95     STA ram_0095
...
bra_E5D2:
C - - - - - 0x03E5E2 0F:E5D2: E6 95     INC ram_0095
...
C - - - - - 0x03E5F2 0F:E5E2: A6 2C     LDX ram_002C
C - - - - - 0x03E5F4 0F:E5E4: F0 06     BEQ bra_E5EC
...
loc_E5F8:
C D 3 - - - 0x03E608 0F:E5F8: A9 17     LDA #$17
...
bra_E634_loop:
C - - - - - 0x03E644 0F:E634: B9 30 01  LDA ram_0130,Y
...
sub_E68A:
loc_0x03E69A:
C D 3 - - - 0x03E69A 0F:E68A: A9 0D     LDA #$0D
bra_E68C:
...
C - - - - - 0x03E6F6 0F:E6E6: 8D 0C 04  STA ram_plr_040C
C - - - - - 0x03E6F9 0F:E6E9: E6 95     INC ram_0095
C - - - - - 0x03E6FB 0F:E6EB: A9 30     LDA #$30
C - - - - - 0x03E6FD 0F:E6ED: 8D 60 05  STA ram_obj_0560
...
C - - - - - 0x03E716 0F:E706: AD 60 05  LDA ram_obj_0560
C - - - - - 0x03E719 0F:E709: F0 05     BEQ bra_E710
C - - - - - 0x03E71B 0F:E70B: CE 60 05  DEC ram_obj_0560
...
C - - - - - 0x03E72D 0F:E71D: BD C0 05  LDA ram_obj_anim_timer,X
...
- - - - - - 0x03E789 0F:E779: 8D 60 05  STA ram_obj_0560
- - - - - - 0x03E78C 0F:E77C: E6 95     INC ram_0095
- - - - - - 0x03E78E 0F:E77E: A5 AE     LDA ram_00AE
...
ofs_001_E78B_14:
- - - - - - 0x03E79B 0F:E78B: CE 60 05  DEC ram_obj_0560
- - - - - - 0x03E79E 0F:E78E: D0 DF     BNE bra_E76F_RTS
- - - - - - 0x03E7A0 0F:E790: A9 01     LDA #$01
- - - - - - 0x03E7A2 0F:E792: 85 2C     STA ram_002C
- - - - - - 0x03E7A4 0F:E794: 85 94     STA ram_0094
- - - - - - 0x03E7A6 0F:E796: 4C 16 DE  JMP loc_DE16_очистить_00B2_00B5
...
C - - - - - 0x03E7BB 0F:E7AB: 20 E5 F6  JSR sub_F6E5_нарисовать_на_экране
...
C - - - - - 0x03E7E7 0F:E7D7: 8D 30 05  STA ram_obj_0530
...
C - - - - - 0x03E7F7 0F:E7E7: 8D 10 06  STA ram_plr_0610
C - - - - - 0x03E7FA 0F:E7EA: 8D 11 06  STA ram_plr_0610 + $01
...
C - - - - - 0x03E88D 0F:E87D: 8D 60 05  STA ram_obj_0560
bra_E880_RTS:
...
ofs_001_E8EA_1E:
C - - J - - 0x03E8FA 0F:E8EA: 20 33 D3  JSR sub_D333
C - - - - - 0x03E8FD 0F:E8ED: EA        NOP
...
ofs_001_E8FC_20:
- - - - - - 0x03E90C 0F:E8FC: A9 06     LDA #$06
- - - - - - 0x03E90E 0F:E8FE: 85 B6     STA ram_00B6
...
C - - - - - 0x03E928 0F:E918: 4C 16 B0  JMP loc_0x027026
bra_E91B:
C - - - - - 0x03E92B 0F:E91B: 20 E7 F5  JSR sub_F5E7_swap_prg_16
C - - - - - 0x03E92E 0F:E91E: 20 30 BD  JSR sub_0x02FD40
C - - - - - 0x03E931 0F:E921: A4 00     LDY ram_0000
C - - - - - 0x03E933 0F:E923: B9 55 01  LDA ram_0155,Y
C - - - - - 0x03E936 0F:E926: 30 03     BMI bra_E92B
C - - - - - 0x03E938 0F:E928: 4C 23 B0  JMP loc_0x027033
bra_E92B:
- - - - - - 0x03E93B 0F:E92B: A9 00     LDA #$00
- - - - - - 0x03E93D 0F:E92D: 4C 5E B0  JMP sub_0x02706E
...
bra_E939:
C - - - - - 0x03E949 0F:E939: 9D 90 05  STA ram_obj_0590,X
bra_E93C_RTS:
...
tbl_E952_индекс:
off_E957_start = tbl_E957
- D 3 - - - 0x03E962 0F:E952: 00        .byte off_E957_00 - off_E957_start
- D 3 - - - 0x03E963 0F:E953: 08        .byte off_E95F_01 - off_E957_start
- - - - - - 0x03E964 0F:E954: 10        .byte off_E967_02 - off_E957_start
- - - - - - 0x03E965 0F:E955: 18        .byte off_E96F_03 - off_E957_start
- D 3 - - - 0x03E966 0F:E956: 20        .byte off_E977_04 - off_E957_start
...
C - - - - - 0x03E9D3 0F:E9C3: BD 40 04  LDA ram_obj_pos_X,X
...
C - - - - - 0x03E9E7 0F:E9D7: B9 40 04  LDA ram_obj_pos_X,Y
...
C - - - - - 0x03E9F5 0F:E9E5: FD 40 04  SBC ram_obj_pos_X,X
...
C - - - - - 0x03EA00 0F:E9F0: B9 40 04  LDA ram_obj_pos_X,Y
...
loc_EA6F:
C D 3 - - - 0x03EA7F 0F:EA6F: 20 59 D2  JSR sub_D259_записать_FF_в_буфер_с_индексом_X
...
sub_EA96:
sub_0x03EAA6:
C - - - - - 0x03EAA6 0F:EA96: AD 30 05  LDA ram_obj_0530
...
C - - - - - 0x03EB3C 0F:EB2C: 20 59 D2  JSR sub_D259_записать_FF_в_буфер_с_индексом_X
...
bra_EB5E_FE:
C - - - - - 0x03EB6E 0F:EB5E: 20 5B D2  JSR sub_D25B_записать_FF_в_буфер
bra_EB61:
...
bra_EBA6_loop:
C - - - - - 0x03EBB6 0F:EBA6: A6 A8     LDX ram_00A8    ; счетчик цикла
...
C - - - - - 0x03EBE4 0F:EBD4: 20 5F D2  JSR sub_D25F_записать_A_в_буфер_без_чтения_индекса
C - - - - - 0x03EBE7 0F:EBD7: C8        INY
C - - - - - 0x03EBE8 0F:EBD8: C9 FF     CMP #$FF
C - - - - - 0x03EBEA 0F:EBDA: D0 F5     BNE bra_EBD1
bra_EBDC:
C - - - - - 0x03EBEC 0F:EBDC: C6 A8     DEC ram_00A8    ; счетчик цикла
...
C - - - - - 0x03EC07 0F:EBF7: 20 5F D2  JSR sub_D25F_записать_A_в_буфер_без_чтения_индекса
...
C - - - - - 0x03ECA1 0F:EC91: BD 80 04  LDA ram_obj_0480,X
C - - - - - 0x03ECA4 0F:EC94: 1D 90 04  ORA ram_obj_0490,X
C - - - - - 0x03ECA7 0F:EC97: 19 80 04  ORA ram_obj_0480,Y
C - - - - - 0x03ECAA 0F:EC9A: 19 90 04  ORA ram_obj_0490,Y
C - - - - - 0x03ECAD 0F:EC9D: F0 13     BEQ bra_ECB2
C - - - - - 0x03ECAF 0F:EC9F: AD D6 06  LDA ram_06D6
C - - - - - 0x03ECB2 0F:ECA2: 30 10     BMI bra_ECB4
C - - - - - 0x03ECB4 0F:ECA4: BD 80 04  LDA ram_obj_0480,X
C - - - - - 0x03ECB7 0F:ECA7: 30 09     BMI bra_ECB2
C - - - - - 0x03ECB9 0F:ECA9: B9 80 04  LDA ram_obj_0480,Y
...
bra_ECB4:
C - - - - - 0x03ECC4 0F:ECB4: BD 80 04  LDA ram_obj_0480,X
C - - - - - 0x03ECC7 0F:ECB7: F0 02     BEQ bra_ECBB
C - - - - - 0x03ECC9 0F:ECB9: 10 F7     BPL bra_ECB2
bra_ECBB:
C - - - - - 0x03ECCB 0F:ECBB: B9 80 04  LDA ram_obj_0480,Y
...
C - - - - - 0x03ECE9 0F:ECD9: BD 40 04  LDA ram_obj_pos_X,X
...
sub_0x03ECF8:
C - - - - - 0x03ECF8 0F:ECE8: BD 80 04  LDA ram_obj_0480,X
C - - - - - 0x03ECFB 0F:ECEB: 30 06     BMI bra_ECF3
C - - - - - 0x03ECFD 0F:ECED: A9 E7     LDA #$E7
C - - - - - 0x03ECFF 0F:ECEF: DD 40 04  CMP ram_obj_pos_X,X
C - - - - - 0x03ED02 0F:ECF2: 60        RTS
bra_ECF3:
C - - - - - 0x03ED03 0F:ECF3: BD 40 04  LDA ram_obj_pos_X,X
...
C - - - - - 0x03ED34 0F:ED24: B9 80 06  LDA ram_0680,Y ; 0680 0681 0682 0683 0684 0685 0686 0687 0688 0689 068A 068B 068C 068D 068E 068F 0690 
C - - - - - 0x03ED37 0F:ED27: 60        RTS
bra_ED28:
C - - - - - 0x03ED38 0F:ED28: B9 A0 06  LDA ram_06A0,Y ; 06A0 06A1 06A2 06A3 06A4 06A5 06A6 06A7 06A8 06A9 06AA 06AB 06AC 06AD 06AE 06AF 06B0 06B1 06B2 
...
- - - - - - 0x03ED64 0F:ED54: 50        .byte $50   ; 01 raph
- - - - - - 0x03ED65 0F:ED55: 50        .byte $50   ; 02 mike
- - - - - - 0x03ED66 0F:ED56: 50        .byte $50   ; 03 don
...
C - - - - - 0x03ED73 0F:ED63: B9 80 04  LDA ram_obj_0480,Y
C - - - - - 0x03ED76 0F:ED66: 19 90 04  ORA ram_obj_0490,Y
C - - - - - 0x03ED79 0F:ED69: F0 0C     BEQ bra_ED77
C - - - - - 0x03ED7B 0F:ED6B: B9 D6 06  LDA ram_06D6,Y
C - - - - - 0x03ED7E 0F:ED6E: 59 80 04  EOR ram_obj_0480,Y
...
C - - - - - 0x03ED8E 0F:ED7E: 59 10 05  EOR ram_obj_0510,Y
...
sub_0x03ED9F_запись_кнопки_hold_и_press:   ; bzk optimize, A = 0 нужен только в 0x03573F
...
C - - - - - 0x03EE22 0F:EE12: F0 17     BEQ bra_EE2B    ; jmp
...
C - - - - - 0x03EE40 0F:EE30: 4D A6 05  EOR ram_obj_05A0 + $06
C - - - - - 0x03EE43 0F:EE33: 29 01     AND #$01
C - - - - - 0x03EE45 0F:EE35: F0 F6     BEQ bra_EE2D
C - - - - - 0x03EE47 0F:EE37: AD A6 05  LDA ram_obj_05A0 + $06
...
- - - - - - 0x03EE73 0F:EE63: D0 FC     BNE bra_EE61_loop
- - - - - - 0x03EE75 0F:EE65: 60        RTS



sub_0x03EE76:
C - - - - - 0x03EE76 0F:EE66: BD 90 05  LDA ram_obj_0590,X
C - - - - - 0x03EE79 0F:EE69: 19 90 05  ORA ram_obj_0590,Y
C - - - - - 0x03EE7C 0F:EE6C: C9 40     CMP #$40
C - - - - - 0x03EE7E 0F:EE6E: 90 1B     BCC bra_EE8B
C - - - - - 0x03EE80 0F:EE70: 38        SEC
C - - - - - 0x03EE81 0F:EE71: BD 90 05  LDA ram_obj_0590,X
C - - - - - 0x03EE84 0F:EE74: F9 90 05  SBC ram_obj_0590,Y
...
C - - - - - 0x03EE8E 0F:EE7E: B9 90 05  LDA ram_obj_0590,Y
C - - - - - 0x03EE91 0F:EE81: FD 90 05  SBC ram_obj_0590,X
...
sub_EE97:
C - - - - - 0x03EEA7 0F:EE97: B9 40 04  LDA ram_obj_pos_X,Y
C - - - - - 0x03EEAA 0F:EE9A: 38        SEC
C - - - - - 0x03EEAB 0F:EE9B: FD 40 04  SBC ram_obj_pos_X,X
C - - - - - 0x03EEAE 0F:EE9E: 85 0E     STA ram_000E
C - - - - - 0x03EEB0 0F:EEA0: B9 30 04  LDA ram_obj_0430,Y
C - - - - - 0x03EEB3 0F:EEA3: FD 30 04  SBC ram_obj_0430,X
...
sub_0x03EEB9:
C - - - - - 0x03EEB9 0F:EEA9: B9 10 04  LDA ram_obj_pos_Y,Y
C - - - - - 0x03EEBC 0F:EEAC: 38        SEC
C - - - - - 0x03EEBD 0F:EEAD: FD 10 04  SBC ram_obj_pos_Y,X
...
C - - - - - 0x03EECB 0F:EEBB: B9 00 04  LDA ram_plr_anim_id,Y
...
C - - - - - 0x03EF8D 0F:EF7D: D9 40 04  CMP ram_obj_pos_X,Y
...
C - - - - - 0x03EFD6 0F:EFC6: AD B6 05  LDA ram_obj_05B0 + $06
...
- D 3 - - - 0x03EFE7 0F:EFD7: 0A        .byte $0A   ; 5F
...
; con_0x030C10_04
; con_0x030C10_05
C - - - - - 0x03F044 0F:F034: 20 E5 F6  JSR sub_F6E5_нарисовать_на_экране
...
- D 3 - - - 0x03F145 0F:F135: 13        .byte $13   ; 01 raph
- D 3 - - - 0x03F146 0F:F136: 12        .byte $12   ; 02 mike
- D 3 - - - 0x03F147 0F:F137: 13        .byte $13   ; 03 don
...
bra_F1BB_loop:
C - - - - - 0x03F1CB 0F:F1BB: B9 22 01  LDA ram_0122,Y
C - - - - - 0x03F1CE 0F:F1BE: D9 75 F3  CMP tbl_F375,Y
C - - - - - 0x03F1D1 0F:F1C1: D0 05     BNE bra_F1C8
C - - - - - 0x03F1D3 0F:F1C3: 88        DEY
C - - - - - 0x03F1D4 0F:F1C4: 10 F5     BPL bra_F1BB_loop
C - - - - - 0x03F1D6 0F:F1C6: 30 2C     BMI bra_F1F4    ; jmp
bra_F1C8:
...
C - - - - - 0x03F1E7 0F:F1D7: 99 13 01  STA ram_0113,Y
C - - - - - 0x03F1EA 0F:F1DA: A9 00     LDA #$00
C - - - - - 0x03F1EC 0F:F1DC: 99 14 01  STA ram_0114,Y
C - - - - - 0x03F1EF 0F:F1DF: 99 15 01  STA ram_0115,Y
C - - - - - 0x03F1F2 0F:F1E2: 88        DEY
C - - - - - 0x03F1F3 0F:F1E3: 88        DEY
C - - - - - 0x03F1F4 0F:F1E4: 88        DEY
C - - - - - 0x03F1F5 0F:F1E5: 10 EE     BPL bra_F1D5_loop
C - - - - - 0x03F1F7 0F:F1E7: 85 31     STA ram_0031
...
C - - - - - 0x03F424 0F:F414: 65 27     ADC ram_0027
...
C - - - - - 0x03F462 0F:F452: 8D 00 04  STA ram_plr_anim_id
...
; bzk optimize, в 0027 будет 00 или 80
; какой смысл, если индекс все равно будет * 02?
; то есть от 0027 ничего не поменяется
...
; con_0x030C10_04
; con_0x030C10_05
C - - - - - 0x03F47B 0F:F46B: 20 E5 F6  JSR sub_F6E5_нарисовать_на_экране
...
C - - - - - 0x03F49F 0F:F48F: A5 27     LDA ram_0027
...
sub_F600_swap_prg_16:   ; bzk optimize, прыжок на 0x03F5F7 (а может не надо, раз 3 команды выше не выполняются)
bra_F600:
C - - - - - 0x03F610 0F:F600: A0 06     LDY #$06
C - - - - - 0x03F612 0F:F602: 84 42     STY ram_0042
...
C - - - - - 0x03F61E 0F:F60E: 84 42     STY ram_0042
...
C - - - - - 0x03F688 0F:F678: 84 43     STY ram_0043
...
C - - - - - 0x03F692 0F:F682: 84 43     STY ram_0043
...
sub_F6E5_нарисовать_на_экране:
sub_0x03F6F5_нарисовать_на_экране:
loc_0x03F6F5_нарисовать_на_экране:
...
sub_0x03F73F_нарисовать_рожи_персов_на_экране_выбора_карты:
; bzk optimize, 00 никогда не запишется, нету ссылок
C - - - - - 0x03F73F 0F:F72F: A9 02     LDA #$02
C - - - - - 0x03F741 0F:F731: 2C        .byte $2C   ; BIT
- - - - - - 0x03F742 0F:F732: A9 00     LDA #$00
C - - - - - 0x03F744 0F:F734: 85 0A     STA ram_000A    ; флаг добавления атрибутов фона
C - - - - - 0x03F746 0F:F736: 20 F3 F5  JSR sub_F5F3_swap_prg_1C
C - - - - - 0x03F749 0F:F739: 20 52 84  JSR sub_0x038462_нарисовать_рожи_персов_на_экране_выбора_карты
C - - - - - 0x03F74C 0F:F73C: 4C 17 F6  JMP loc_F617_restore_prg
...
C - - - - - 0x03F795 0F:F785: AC 71 05  LDY ram_obj_0570 + $01
...
C - - - - - 0x03F846 0F:F836: B9 3D F8  LDA tbl_F83C + $01,Y
...
- D 3 - - - 0x03F85C 0F:F84C: B2 FA     .word ofs_067_FAB2_08
- D 3 - - - 0x03F85E 0F:F84E: BA FA     .word ofs_067_FABA_09
- D 3 - - - 0x03F860 0F:F850: D4 FA     .word ofs_067_FAD4_0A
- D 3 - - - 0x03F862 0F:F852: A7 FA     .word ofs_067_FAA7_0B
- D 3 - - - 0x03F864 0F:F854: 07 FB     .word ofs_067_FB07_0C
- D 3 - - - 0x03F866 0F:F856: 35 FB     .word ofs_067_FB35_0D
- D 3 - - - 0x03F868 0F:F858: 2D FB     .word ofs_067_FB2D_0E
- D 3 - - - 0x03F86A 0F:F85A: 3D FB     .word ofs_067_FB3D_0F
- D 3 - - - 0x03F86C 0F:F85C: 68 FB     .word ofs_067_FB68_10
...
C - - - - - 0x03F87E 0F:F86E: B9 42 00  LDA ram_0042,Y
...
tbl_F885:
off_F890_start = tbl_F890
- D 3 - - - 0x03F895 0F:F885: 00        .byte off_F890_00 - off_F890_start
- D 3 - - - 0x03F896 0F:F886: 0A        .byte off_F89A_01 - off_F890_start
- D 3 - - - 0x03F897 0F:F887: 00        .byte off_F890_02 - off_F890_start
- D 3 - - - 0x03F898 0F:F888: 0A        .byte off_F89A_03 - off_F890_start
- D 3 - - - 0x03F899 0F:F889: 0A        .byte off_F89A_04 - off_F890_start
- D 3 - - - 0x03F89A 0F:F88A: 0A        .byte off_F89A_05 - off_F890_start
- D 3 - - - 0x03F89B 0F:F88B: 14        .byte off_F8A4_06 - off_F890_start
...
- D 3 - - - 0x03F9CF 0F:F9BF: 00        .byte $00   ; 04 ram_0129
- D 3 - - - 0x03F9D0 0F:F9C0: 00        .byte $00   ; 05 ram_0129 + $01
...
C - - - - - 0x03FA86 0F:FA76: 6D 30 05  ADC ram_obj_0530
...
- - - - - - 0x03FCD1 0F:FCC1: 3B        .byte $3B   ; 07


; bzk garbage
- - - - - - 0x03FCD2 0F:FCC2: EA        NOP
- - - - - - 0x03FCD3 0F:FCC3: EA        NOP
- - - - - - 0x03FCD4 0F:FCC4: EA        NOP
- - - - - - 0x03FCD5 0F:FCC5: EA        NOP
- - - - - - 0x03FCD6 0F:FCC6: EA        NOP
- - - - - - 0x03FCD7 0F:FCC7: EA        NOP
- - - - - - 0x03FCD8 0F:FCC8: EA        NOP
...
C - - - - - 0x03FD69 0F:FD59: BD 36 06  LDA ram_plr_0636,X
C - - - - - 0x03FD6C 0F:FD5C: F0 14     BEQ bra_FD72
C - - - - - 0x03FD6E 0F:FD5E: DE 36 06  DEC ram_plr_0636,X
C - - - - - 0x03FD71 0F:FD61: BD 10 05  LDA ram_obj_0510,X
...
C - - - - - 0x03FDD9 0F:FDC9: BD 60 04  LDA ram_obj_0460,X
C - - - - - 0x03FDDC 0F:FDCC: 30 0F     BMI bra_FDDD
C - - - - - 0x03FDDE 0F:FDCE: 1D 60 04  ORA ram_obj_0460,X
C - - - - - 0x03FDE1 0F:FDD1: F0 0A     BEQ bra_FDDD
C - - - - - 0x03FDE3 0F:FDD3: A9 B1     LDA #$B1
C - - - - - 0x03FDE5 0F:FDD5: DD 10 04  CMP ram_obj_pos_Y,X
C - - - - - 0x03FDE8 0F:FDD8: B0 03     BCS bra_FDDD
C - - - - - 0x03FDEA 0F:FDDA: 9D 10 04  STA ram_obj_pos_Y,X
bra_FDDD:
...
bra_FE07_loop:
C - - - - - 0x03FE17 0F:FE07: BD E0 05  LDA ram_obj_05E0,X
C - - - - - 0x03FE1A 0F:FE0A: 10 27     BPL bra_FE33
C - - - - - 0x03FE1C 0F:FE0C: 38        SEC
C - - - - - 0x03FE1D 0F:FE0D: BD 50 04  LDA ram_obj_0450,X
C - - - - - 0x03FE20 0F:FE10: ED 3D 06  SBC ram_063D
C - - - - - 0x03FE23 0F:FE13: 9D 50 04  STA ram_obj_0450,X
...
bra_FE22:
C - - - - - 0x03FE32 0F:FE22: BD 40 04  LDA ram_obj_pos_X,X
C - - - - - 0x03FE35 0F:FE25: ED 3C 06  SBC ram_063C
C - - - - - 0x03FE38 0F:FE28: 9D 40 04  STA ram_obj_pos_X,X
C - - - - - 0x03FE3B 0F:FE2B: BD 30 04  LDA ram_obj_0430,X
C - - - - - 0x03FE3E 0F:FE2E: E5 00     SBC ram_0000
C - - - - - 0x03FE40 0F:FE30: 9D 30 04  STA ram_obj_0430,X
bra_FE33:
...
C - - - - - 0x03FE6E 0F:FE5E: A9 00     LDA #$00
...
C - - - - - 0x03FE82 0F:FE72: DE 90 05  DEC ram_obj_0590,X
...
C - - - - - 0x03FE8F 0F:FE7F: BD 90 05  LDA ram_obj_0590,X
bra_FE82_RTS:
C - - - - - 0x03FE92 0F:FE82: 60        RTS
loc_0x03FE93:
C D 3 - - - 0x03FE93 0F:FE83: BC 20 05  LDY ram_obj_0520,X
...
C - - - - - 0x03FEB3 0F:FEA3: B9 10 04  LDA ram_obj_pos_Y,Y
...
bra_FEB6:
C - - - - - 0x03FEC6 0F:FEB6: 9D F0 05  STA ram_obj_05F0,X
...
bra_FF5B:
C - - - - - 0x03FF6B 0F:FF5B: AD 90 05  LDA ram_obj_0590
C - - - - - 0x03FF6E 0F:FF5E: CD 91 05  CMP ram_obj_0590 + $01
loc_FF61:
...
; bzk garbage
- - - - - - 0x03FF82 0F:FF72: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03FF90 0F:FF80: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03FFA0 0F:FF90: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03FFB0 0F:FFA0: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03FFC0 0F:FFB0: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x03FFD0 0F:FFC0: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
...
- - - - - - 0x040000 0F:FFF0: FF        .byte $FF, $FF, $FF, $FF, $FF   ; 
