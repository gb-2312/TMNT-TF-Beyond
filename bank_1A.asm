...
C - - - - - 0x034929 0D:8919: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
bra_8FB0:
C - - - - - 0x034FC0 0D:8FB0: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
- - - - - - 0x03504B 0D:903B: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
- - - - - - 0x0351EC 0D:91DC: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
- - - - - - 0x035260 0D:9250: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
C - - - - - 0x0353AC 0D:939C: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
C - - - - - 0x03561F 0D:960F: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
; if достаточно близко
C - - - - - 0x035629 0D:9619: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
bra_96A8:
C - - - - - 0x0356B8 0D:96A8: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
; if достаточно близко
C - - - - - 0x0356C2 0D:96B2: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
C - - - - - 0x03570B 0D:96FB: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
- - - - - - 0x035D94 0D:9D84: 20 A9 EE  JSR sub_EEA9_вычислить_разницу_pos_Y_персов
...
sub_EEA9_вычислить_разницу_pos_Y_персов:
; перемещено из банка FF
