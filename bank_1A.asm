...
C - - - - - 0x034932 0D:8922: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
C - - - - - 0x034AE1 0D:8AD1: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
C - - - - - 0x034FC5 0D:8FB5: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
- - - - - - 0x035050 0D:9040: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
- - - - - - 0x0351F1 0D:91E1: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
- - - - - - 0x035265 0D:9255: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
C - - - - - 0x0353B1 0D:93A1: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
- - - - - - 0x03549B 0D:948B: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
C - - - - - 0x035624 0D:9614: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
C - - - - - 0x0356BD 0D:96AD: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
C - - - - - 0x0356C7 0D:96B7: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
C - - - - - 0x035710 0D:9700: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
C - - - - - 0x0359AC 0D:999C: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
- - - - - - 0x035D99 0D:9D89: 20 3E EE  JSR sub_EE3E_проверка_близости_объектов_с_областью_A
...
sub_EE3E_проверка_близости_объектов_с_областью_A:
; перемещено из банка FF
; A = размер хитбокса
; на выходе C
    ; 0 = попадает в хитбокс
    ; 1 = вне хитбокса
