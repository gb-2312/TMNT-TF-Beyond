...
C - - - - - 0x03450F 0D:84FF: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x03463B 0D:862B: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
bra_862E:
...
C - - - - - 0x034654 0D:8644: 20 2F EE  JSR sub_EE2F_проверка_запущенного_мяча_соперником
...
ofs_032_869C_05:
C - - J - - 0x0346AC 0D:869C: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
C - - - - - 0x0346AF 0D:869F: C9 3C     CMP #$3C
C - - - - - 0x0346B1 0D:86A1: 90 03     BCC bra_86A6
C - - - - - 0x0346B3 0D:86A3: 4C FB 89  JMP loc_89FB
bra_86A6:
C - - - - - 0x0346B6 0D:86A6: 4C 96 ED  JMP loc_ED96_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x0346E2 0D:86D2: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
bra_86D5:
...
bra_8731:
C - - - - - 0x034741 0D:8731: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
bra_8734:
...
ofs_033_8796_11:
C - - J - - 0x0347A6 0D:8796: 20 2F EE  JSR sub_EE2F_проверка_запущенного_мяча_соперником
...
bra_88C7:
C - - - - - 0x0348D7 0D:88C7: 4C 96 ED  JMP loc_ED96_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x0348DD 0D:88CD: 20 20 ED  JSR sub_ED20_чтение_поведения_cpu
...
C - - - - - 0x034923 0D:8913: 4C 96 ED  JMP loc_ED96_очистка_адресов_cpu_при_необходимости
bra_8916:
...
C - - - - - 0x034A01 0D:89F1: 20 2F EE  JSR sub_EE2F_проверка_запущенного_мяча_соперником
...
bra_8AA9:
- - - - - - 0x034AB9 0D:8AA9: 4C 96 ED  JMP loc_ED96_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x034ACD 0D:8ABD: 4C 96 ED  JMP loc_ED96_очистка_адресов_cpu_при_необходимости
bra_8AC0:
C - - - - - 0x034AD0 0D:8AC0: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
C - - - - - 0x034E01 0D:8DF1: 20 C6 ED  JSR sub_EDC6_генератор_рандома_по_сложности_игры_1
...
bra_8E08:
loc_8E08:
C D 0 - - - 0x034E18 0D:8E08: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
ofs_029_8E17_00:
C - - J - - 0x034E27 0D:8E17: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x034E5E 0D:8E4E: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x034E61 0D:8E51: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
C - - - - - 0x034E64 0D:8E54: B9 B4 90  LDA tbl_90B4_шаблоны_leo,Y
C - - - - - 0x034E67 0D:8E57: 60        RTS
bra_8E58:
loc_8E58:
C D 0 - - - 0x034E68 0D:8E58: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x034E6B 0D:8E5B: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
...
loc_8E62:
C D 0 - - - 0x034E72 0D:8E62: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
...
bra_8E77:
C - - - - - 0x034E87 0D:8E77: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_8E7D:
C - - - - - 0x034E8D 0D:8E7D: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
bra_8EA2:
C - - - - - 0x034EB2 0D:8EA2: 20 5A ED  JSR sub_ED5A
...
bra_8EBE:
loc_8EBE:
C D 0 - - - 0x034ECE 0D:8EBE: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
ofs_029_8EC4_01:
C - - J - - 0x034ED4 0D:8EC4: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x034ED7 0D:8EC7: 90 F5     BCC bra_8EBE
C - - - - - 0x034ED9 0D:8EC9: 20 5A ED  JSR sub_ED5A
...
C - - - - - 0x034F06 0D:8EF6: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x034F16 0D:8F06: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x034F19 0D:8F09: B0 2C     BCS bra_8F37
loc_8F0B:
C D 0 - - - 0x034F1B 0D:8F0B: A9 16     LDA #con_шаблон_ai_16
C - - - - - 0x034F1D 0D:8F0D: 60        RTS
bra_8F0E:
C - - - - - 0x034F1E 0D:8F0E: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x034F21 0D:8F11: A9 34     LDA #con_шаблон_ai_34
C - - - - - 0x034F23 0D:8F13: 60        RTS
bra_8F14:
C - - - - - 0x034F24 0D:8F14: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x034F27 0D:8F17: A5 11     LDA ram_0011
C - - - - - 0x034F29 0D:8F19: C9 01     CMP #$01
C - - - - - 0x034F2B 0D:8F1B: F0 0D     BEQ bra_8F2A
C - - - - - 0x034F2D 0D:8F1D: 20 C6 ED  JSR sub_EDC6_генератор_рандома_по_сложности_игры_1
...
bra_8F2A:
C - - - - - 0x034F3A 0D:8F2A: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
ofs_029_8F94_02:
C - - J - - 0x034FA4 0D:8F94: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x034FB2 0D:8FA2: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
bra_8FC2:
C - - - - - 0x034FD2 0D:8FC2: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
bra_8FD7:
C - - - - - 0x034FE7 0D:8FD7: 20 5A ED  JSR sub_ED5A
...
C - - - - - 0x034FF4 0D:8FE4: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x034FF7 0D:8FE7: 90 32     BCC bra_901B
C - - - - - 0x034FF9 0D:8FE9: A5 12     LDA ram_0012
C - - - - - 0x034FFB 0D:8FEB: D0 12     BNE bra_8FFF
C - - - - - 0x034FFD 0D:8FED: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
C - - - - - 0x035000 0D:8FF0: B0 0D     BCS bra_8FFF    ; if false
; if true
- - - - - - 0x035002 0D:8FF2: 20 C6 ED  JSR sub_EDC6_генератор_рандома_по_сложности_игры_1
...
bra_9015:
C - - - - - 0x035025 0D:9015: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
ofs_029_901E_03:
C - - J - - 0x03502E 0D:901E: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x035040 0D:9030: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
bra_904A:
C - - - - - 0x03505A 0D:904A: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
ofs_028_90C9_00:
C - - J - - 0x0350D9 0D:90C9: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x0350DC 0D:90CC: 90 60     BCC bra_912E
C - - - - - 0x0350DE 0D:90CE: 20 5A ED  JSR sub_ED5A
C - - - - - 0x0350E1 0D:90D1: 90 07     BCC bra_90DA
C - - - - - 0x0350E3 0D:90D3: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
...
C - - - - - 0x035100 0D:90F0: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
C - - - - - 0x035103 0D:90F3: C9 60     CMP #$60
C - - - - - 0x035105 0D:90F5: B0 22     BCS bra_9119
C - - - - - 0x035107 0D:90F7: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x03510A 0D:90FA: A9 1F     LDA #con_шаблон_ai_1F
C - - - - - 0x03510C 0D:90FC: 60        RTS
bra_90FD:
C - - - - - 0x03510D 0D:90FD: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x035119 0D:9109: 20 C2 EC  JSR sub_ECC2_генератор_рандома_для_Y_1
...
bra_911C:
C - - - - - 0x03512C 0D:911C: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_912E:
loc_912E:
- - - - - - 0x03513E 0D:912E: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_914A:
C - - - - - 0x03515A 0D:914A: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
bra_9161:
C - - - - - 0x035171 0D:9161: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x0351C2 0D:91B2: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
bra_91BC:
C - - - - - 0x0351CC 0D:91BC: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x0351E7 0D:91D7: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
; if достаточно близко
- - - - - - 0x0351F6 0D:91E6: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x03520A 0D:91FA: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
bra_920F:
C - - - - - 0x03521F 0D:920F: 20 C2 EC  JSR sub_ECC2_генератор_рандома_для_Y_1
...
ofs_028_9231_03:
C - - J - - 0x035241 0D:9231: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x035244 0D:9234: B0 03     BCS bra_9239
- - - - - - 0x035246 0D:9236: 4C 2E 91  JMP loc_912E
bra_9239:
C - - - - - 0x035249 0D:9239: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
bra_925D:
C - - - - - 0x03526D 0D:925D: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
bra_9268:
- - - - - - 0x035278 0D:9268: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
- - - - - - 0x03527B 0D:926B: A9 0F     LDA #con_шаблон_ai_0F
- - - - - - 0x03527D 0D:926D: 60        RTS
bra_926E:
C - - - - - 0x03527E 0D:926E: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
...
ofs_027_92B1_00:
C - - J - - 0x0352C1 0D:92B1: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x0352C4 0D:92B4: 90 2D     BCC bra_92E3
C - - - - - 0x0352C6 0D:92B6: 20 5A ED  JSR sub_ED5A
...
C - - - - - 0x0352D7 0D:92C7: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_92E3:
- - - - - - 0x0352F3 0D:92E3: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
- - - - - - 0x0352F6 0D:92E6: A9 08     LDA #con_шаблон_ai_08
- - - - - - 0x0352F8 0D:92E8: 60        RTS
bra_92E9:
C - - - - - 0x0352F9 0D:92E9: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x0352FC 0D:92EC: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
...
bra_92FE:
C - - - - - 0x03530E 0D:92FE: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
ofs_027_930D_01:
C - - J - - 0x03531D 0D:930D: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x035334 0D:9324: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
C - - - - - 0x035342 0D:9332: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
...
sub_9339:
C - - - - - 0x035349 0D:9339: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
C - - - - - 0x035356 0D:9346: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
ofs_027_9353_03:
C - - J - - 0x035363 0D:9353: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
bra_935E:
C - - - - - 0x03536E 0D:935E: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
bra_936F:
ofs_027_936F_02:
C - - - - - 0x03537F 0D:936F: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x035382 0D:9372: B0 06     BCS bra_937A
- - - - - - 0x035384 0D:9374: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
; if достаточно близко
C - - - - - 0x0353B7 0D:93A7: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
- - - - - - 0x0353F4 0D:93E4: 20 5A ED  JSR sub_ED5A
...
bra_9407:
C - - - - - 0x035417 0D:9407: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x03541A 0D:940A: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
...
C - - - - - 0x03542E 0D:941E: 20 C2 EC  JSR sub_ECC2_генератор_рандома_для_Y_1
...
tbl_9428:
; bzk bug? должно читаться через Y, как и все остальные случаи с JSR sub_ECC2_генератор_рандома_для_Y_1?
...
bra_942C:
C - - - - - 0x03543C 0D:942C: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_943B:
loc_943B:
- - - - - - 0x03544B 0D:943B: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
ofs_026_9441_01:
C - - J - - 0x035451 0D:9441: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
bra_9459:
C - - - - - 0x035469 0D:9459: 20 5A ED  JSR sub_ED5A
C - - - - - 0x03546C 0D:945C: B0 A9     BCS bra_9407
C - - - - - 0x03546E 0D:945E: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
; if достаточно близко
- - - - - - 0x0354A0 0D:9490: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x0354AC 0D:949C: 20 C2 EC  JSR sub_ECC2_генератор_рандома_для_Y_1
...
C - - - - - 0x0354B7 0D:94A7: 20 C2 EC  JSR sub_ECC2_генератор_рандома_для_Y_1
...
ofs_026_94EC_03:
C - - J - - 0x0354FC 0D:94EC: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x0354FF 0D:94EF: B0 03     BCS bra_94F4
- - - - - - 0x035501 0D:94F1: 4C 3B 94  JMP loc_943B
bra_94F4:
C - - - - - 0x035504 0D:94F4: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
bra_94FF:
C - - - - - 0x03550F 0D:94FF: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
bra_9511:
C - - - - - 0x035521 0D:9511: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
C - - - - - 0x035524 0D:9514: B9 87 95  LDA tbl_9587_шаблоны_mike,Y
C - - - - - 0x035527 0D:9517: 60        RTS
bra_9518:
C - - - - - 0x035528 0D:9518: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
ofs_026_951E_02:
C - - J - - 0x03552E 0D:951E: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x035531 0D:9521: B0 03     BCS bra_9526
- - - - - - 0x035533 0D:9523: 4C 3B 94  JMP loc_943B
bra_9526:
C - - - - - 0x035536 0D:9526: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
bra_9531:
C - - - - - 0x035541 0D:9531: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
bra_9556:
C - - - - - 0x035566 0D:9556: 20 2F EE  JSR sub_EE2F_проверка_запущенного_мяча_соперником
C - - - - - 0x035569 0D:9559: 90 0E     BCC bra_9569_true
C - - - - - 0x03556B 0D:955B: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
bra_9569_true:
- - - - - - 0x035579 0D:9569: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
- - - - - - 0x03557C 0D:956C: A9 3D     LDA #con_шаблон_ai_3D
- - - - - - 0x03557E 0D:956E: 60        RTS
bra_956F:
C - - - - - 0x03557F 0D:956F: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x035582 0D:9572: A9 22     LDA #con_шаблон_ai_22
C - - - - - 0x035584 0D:9574: 60        RTS
bra_9575:
loc_9575:
C D 0 - - - 0x035585 0D:9575: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x0355AD 0D:959D: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
ofs_025_95B4_00:
C - - J - - 0x0355C4 0D:95B4: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
- - - - - - 0x0355D9 0D:95C9: 20 5A ED  JSR sub_ED5A
...
C - - - - - 0x0355E7 0D:95D7: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x0355EA 0D:95DA: 20 C2 EC  JSR sub_ECC2_генератор_рандома_для_Y_1
...
bra_9640:
C - - - - - 0x035650 0D:9640: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
C - - - - - 0x035653 0D:9643: B9 3C 98  LDA tbl_983C_шаблоны_casey,Y
C - - - - - 0x035656 0D:9646: 60        RTS
bra_9647:
- - - - - - 0x035657 0D:9647: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_965E:
loc_965E:
C D 0 - - - 0x03566E 0D:965E: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
ofs_025_966F_01:
C - - J - - 0x03567F 0D:966F: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x03569C 0D:968C: 20 5A ED  JSR sub_ED5A
...
C - - - - - 0x0356D5 0D:96C5: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
bra_96D9:
loc_96D9:
C D 0 - - - 0x0356E9 0D:96D9: 20 5A ED  JSR sub_ED5A
; bzk optimize, максимальный операнд
C - - - - - 0x0356EC 0D:96DC: B0 80     BCS bra_965E
C - - - - - 0x0356EE 0D:96DE: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x03572D 0D:971D: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
C - - - - - 0x035730 0D:9720: C9 38     CMP #$38
C - - - - - 0x035732 0D:9722: B0 24     BCS bra_9748
loc_9724:
C D 0 - - - 0x035734 0D:9724: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_9748:
C - - - - - 0x035758 0D:9748: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x03575B 0D:974B: B0 0D     BCS bra_975A
bra_974D:
- - - - - - 0x03575D 0D:974D: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
- - - - - - 0x035760 0D:9750: A9 16     LDA #con_шаблон_ai_16
- - - - - - 0x035762 0D:9752: 60        RTS
bra_9753:
loc_9753:
C - - - - - 0x035764 0D:9754: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x03577E 0D:976E: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
bra_9771:
...
ofs_025_977D_03:
C - - J - - 0x03578D 0D:977D: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x035798 0D:9788: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
ofs_025_97A6_02:
C - - J - - 0x0357B6 0D:97A6: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x0357B9 0D:97A9: 90 BE     BCC bra_9769
C - - - - - 0x0357BB 0D:97AB: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x0357BE 0D:97AE: 90 9D     BCC bra_974D
C - - - - - 0x0357C0 0D:97B0: 20 5A ED  JSR sub_ED5A
...
C - - - - - 0x03580F 0D:97FF: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
C - - - - - 0x03583E 0D:982E: F0 06     BEQ bra_9836_raph
                                    .else
                                        ...
                                        BEQ bra_9836_raph
                                    .endif
C - - - - - 0x035840 0D:9830: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x035843 0D:9833: A9 3A     LDA #con_шаблон_ai_3A
C - - - - - 0x035845 0D:9835: 60        RTS
bra_9836_raph:
; con_fighter_raph
; con_fighter___raph
C - - - - - 0x035846 0D:9836: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x035872 0D:9862: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x03587D 0D:986D: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x0358B8 0D:98A8: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
bra_98B2:
C - - - - - 0x0358C2 0D:98B2: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x0358C5 0D:98B5: A9 10     LDA #con_шаблон_ai_10
C - - - - - 0x0358C7 0D:98B7: 60        RTS
bra_98B8:
C - - - - - 0x0358C8 0D:98B8: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x0358CB 0D:98BB: A9 2C     LDA #con_шаблон_ai_2C
C - - - - - 0x0358CD 0D:98BD: 60        RTS
bra_98BE:
C - - - - - 0x0358CE 0D:98BE: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x0358D1 0D:98C1: A9 32     LDA #con_шаблон_ai_32
C - - - - - 0x0358D3 0D:98C3: 60        RTS
bra_98C4:
C - - - - - 0x0358D4 0D:98C4: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_98D0:
C - - - - - 0x0358E0 0D:98D0: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_98D6:
loc_98D6:
C D 0 - - - 0x0358E6 0D:98D6: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_990D:
C - - - - - 0x03591D 0D:990D: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_9913:
C - - - - - 0x035923 0D:9913: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x035926 0D:9916: B0 06     BCS bra_991E
bra_9918:
C - - - - - 0x035928 0D:9918: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_9933:
- - - - - - 0x035943 0D:9933: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
- - - - - - 0x035946 0D:9936: 20 C2 EC  JSR sub_ECC2_генератор_рандома_для_Y_1
...
ofs_024_993D_03:
C - - J - - 0x03594D 0D:993D: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x035950 0D:9940: 90 D6     BCC bra_9918
C - - - - - 0x035952 0D:9942: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
bra_9950:
C - - - - - 0x035960 0D:9950: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x035973 0D:9963: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
bra_9980:
C - - - - - 0x035990 0D:9980: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x035993 0D:9983: 90 93     BCC bra_9918
C - - - - - 0x035995 0D:9985: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
; if достаточно близко
C - - - - - 0x0359B1 0D:99A1: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
loc_99A7:
C D 0 - - - 0x0359B7 0D:99A7: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
loc_99AD:
C D 0 - - - 0x0359BD 0D:99AD: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_99B3:
C - - - - - 0x0359C3 0D:99B3: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
...
ofs_023_99F6_00:
C - - J - - 0x035A06 0D:99F6: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x035A09 0D:99F9: B0 03     BCS bra_99FE
- - - - - - 0x035A0B 0D:99FB: 4C 82 9A  JMP loc_9A82
bra_99FE:
C - - - - - 0x035A0E 0D:99FE: 20 5A ED  JSR sub_ED5A
...
bra_9A3C:
C - - - - - 0x035A4C 0D:9A3C: 20 C6 ED  JSR sub_EDC6_генератор_рандома_по_сложности_игры_1
...
bra_9A50:
- - - - - - 0x035A60 0D:9A50: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
loc_9A59:
C D 0 - - - 0x035A69 0D:9A59: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
C - - - - - 0x035A6C 0D:9A5C: C9 60     CMP #$60
C - - - - - 0x035A6E 0D:9A5E: B0 03     BCS bra_9A63
C - - - - - 0x035A70 0D:9A60: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
bra_9A63:
...
bra_9A66:
C - - - - - 0x035A76 0D:9A66: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x035A79 0D:9A69: 20 C2 EC  JSR sub_ECC2_генератор_рандома_для_Y_1
...
bra_9A70:
C - - - - - 0x035A80 0D:9A70: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
bra_9A82:
loc_9A82:
C D 0 - - - 0x035A92 0D:9A82: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
ofs_023_9A88_01:
C - - J - - 0x035A98 0D:9A88: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x035A9B 0D:9A8B: 90 F5     BCC bra_9A82
C - - - - - 0x035A9D 0D:9A8D: 20 5A ED  JSR sub_ED5A
...
C - - - - - 0x035AD8 0D:9AC8: 20 14 EE  JSR sub_EE14_проверка_доступности_мяча_для_подбора
...
bra_9AE5:
C - - - - - 0x035AF5 0D:9AE5: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
...
C - - - - - 0x035B04 0D:9AF4: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
C - - - - - 0x035B07 0D:9AF7: 20 C2 EC  JSR sub_ECC2_генератор_рандома_для_Y_1
...
C - - - - - 0x035B25 0D:9B15: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
ofs_023_9B2B_03:
C - - J - - 0x035B3B 0D:9B2B: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x035B50 0D:9B40: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
bra_9B5B:
loc_9B5B:
C D 0 - - - 0x035B6B 0D:9B5B: 20 96 ED  JSR sub_ED96_очистка_адресов_cpu_при_необходимости
...
ofs_023_9B61_02:
C - - J - - 0x035B71 0D:9B61: 20 2C ED  JSR sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x035BC7 0D:9BB7: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
C - - - - - 0x035C8B 0D:9C7B: 20 C6 ED  JSR sub_EDC6_генератор_рандома_по_сложности_игры_1
C - - - - - 0x035C8E 0D:9C7E: C9 10     CMP #$10
C - - - - - 0x035C90 0D:9C80: 90 28     BCC bra_9CAA_RTS
C - - - - - 0x035C92 0D:9C82: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
- - - - - - 0x035CF0 0D:9CE0: 20 CD EC  JSR sub_ECCD_генератор_рандома_для_Y_2
...
C - - - - - 0x035D5A 0D:9D4A: 20 C6 ED  JSR sub_EDC6_генератор_рандома_по_сложности_игры_1
...
C - - - - - 0x035D85 0D:9D75: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x035D88 0D:9D78: B0 19     BCS bra_9D93
- - - - - - 0x035D8A 0D:9D7A: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
; if персы достаточно далеко друг от друга
- - - - - - 0x035EA6 0D:9E96: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
bra_9EC3:
- - - - - - 0x035ED3 0D:9EC3: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x035FFC 0D:9FEC: 20 C2 EC  JSR sub_ECC2_генератор_рандома_для_Y_1
...
bra_A072:
loc_A072:
- - - - - - 0x036082 0D:A072: 20 FE ED  JSR sub_EDFE_проверка_наличия_мяча_у_игрока_X
...
- - - - - - 0x036165 0D:A155: 20 D8 ED  JSR sub_EDD8_генератор_рандома_по_сложности_игры_2
...
; if персы достаточно близко друг к другу
- - - - - - 0x03654E 0D:A53E: 20 9B ED  JSR sub_ED9B_очистка_адресов_cpu
...
C - - - - - 0x036747 0D:A737: 4C 14 EE  JMP loc_EE14_проверка_доступности_мяча_для_подбора
bra_A73A:
...
; if персы достаточно далеко друг от друга
- - - - - - 0x037F0C 0D:BEFC: 20 C2 EC  JSR sub_ECC2_генератор_рандома_для_Y_1
...
sub_ECC2_генератор_рандома_для_Y_1:
; перемещено из банка FF
...
sub_ECCD_генератор_рандома_для_Y_2:
; перемещено из банка FF
...
sub_ED2C_генератор_рандома_с_учетом_запущенного_мяча:
; перемещено из банка FF
...
sub_ED96_очистка_адресов_cpu_при_необходимости:
loc_ED96_очистка_адресов_cpu_при_необходимости:
; перемещено из банка FF
C D 3 - - - 0x03EDA6 0F:ED96: BD E6 06  LDA ram_06E6_cpu,X ; 06E6 06E7 
C - - - - - 0x03EDA9 0F:ED99: D0 28     BNE bra_EDC2_RTS
sub_ED9B_очистка_адресов_cpu:
...
; перемещено из банка FF
C - - - - - 0x03EDD6 0F:EDC6: 20 04 F2  JSR sub_0x03F214_генератор_рандома
...
; перемещено из банка FF
C - - - - - 0x03EDE8 0F:EDD8: 20 04 F2  JSR sub_0x03F214_генератор_рандома
...
sub_EE14_проверка_доступности_мяча_для_подбора:
loc_EE14_проверка_доступности_мяча_для_подбора:
; перемещено из банка FF
; на выходе C
