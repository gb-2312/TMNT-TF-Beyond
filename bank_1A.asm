...
C - - - - - 0x03416C 0D:815C: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x0341F8 0D:81E8: 20 C6 ED  JSR sub_0x03EDD6_генератор_рандома_по_сложности_игры_1
...
C - - - - - 0x03426C 0D:825C: 20 14 ED  JSR sub_0x03ED24_запись_поведения_cpu
...
C - - - - - 0x0342BA 0D:82AA: 4C 96 ED  JMP loc_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x0344AD 0D:849D: B9 E8 06  LDA ram_06E8,Y ; 06E8 06E9 06EA 06EB 06EC 06ED 06EE 06EF 
C - - - - - 0x0344B0 0D:84A0: 85 0C     STA ram_000C
C - - - - - 0x0344B2 0D:84A2: AD D6 06  LDA ram_дистанция_до_соперника_X_hi
C - - - - - 0x0344B5 0D:84A5: 85 0F     STA ram_000F
C - - - - - 0x0344B7 0D:84A7: AD D7 06  LDA ram_дистанция_до_соперника_X_lo
C - - - - - 0x0344BA 0D:84AA: 85 0E     STA ram_000E
C - - - - - 0x0344BC 0D:84AC: BD D4 06  LDA ram_06D4_cpu_script,X ; 06D4 06D5 
...
- - - - - - 0x0344D4 0D:84C4: 23 8A     .word ofs_033_8A23_09   ; unused, индекс не найден
...
- - - - - - 0x0344E6 0D:84D6: 7C 87     .word ofs_033_877C_12   ; unused, индекс не найден
...
- - - - - - 0x0344F2 0D:84E2: 43 85     .word ofs_033_8543_18   ; unused, индекс не найден
- D 0 - I - 0x0344F4 0D:84E4: E6 84     .word ofs_033_84E6_19



ofs_033_84E6_19:
C - - J - - 0x0344F6 0D:84E6: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x0344F9 0D:84E9: BD 7A 06  LDA ram_067A_plr,X ; 067A 067B 
...
bra_84F7:
C - - - - - 0x034507 0D:84F7: BD DA 06  LDA ram_06DA_cpu_script,X ; 06DA 06DB 
C - - - - - 0x03450A 0D:84FA: D0 14     BNE bra_8510
C - - - - - 0x03450C 0D:84FC: FE DA 06  INC ram_06DA_cpu_script,X ; 06DA 06DB 
C - - - - - 0x03450F 0D:84FF: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
C - - - - - 0x034512 0D:8502: C9 10     CMP #$10
C - - - - - 0x034514 0D:8504: B0 03     BCS bra_8509
C - - - - - 0x034516 0D:8506: FE DA 06  INC ram_06DA_cpu_script,X ; 06DB 
bra_8509:
C - - - - - 0x034519 0D:8509: C9 20     CMP #$20
C - - - - - 0x03451B 0D:850B: 90 03     BCC bra_8510
C - - - - - 0x03451D 0D:850D: FE DA 06  INC ram_06DA_cpu_script,X ; 06DA 06DB 
bra_8510:
C - - - - - 0x034520 0D:8510: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x034523 0D:8513: B9 40 05  LDA ram_obj_state_lo,Y ; 0540 0541 
...
bra_8521:
C - - - - - 0x034531 0D:8521: BD DA 06  LDA ram_06DA_cpu_script,X ; 06DB 
C - - - - - 0x034534 0D:8524: C9 03     CMP #$03
C - - - - - 0x034536 0D:8526: D0 0D     BNE bra_8535
- - - - - - 0x034538 0D:8528: 4C FB 89  JMP loc_89FB
bra_852B:
C - - - - - 0x03453B 0D:852B: BD DA 06  LDA ram_06DA_cpu_script,X ; 06DA 06DB 
...
- - - - - - 0x03455B 0D:854B: BD 20 05  LDA ram_obj_state_hi,X
...
- - - - - - 0x034565 0D:8555: DD 2E 01  CMP ram_012E_plr,X
...
- - - - - - 0x034584 0D:8574: BD 20 05  LDA ram_obj_state_hi,X
...
C - - - - - 0x0345D5 0D:85C5: DD 2E 01  CMP ram_012E_plr,X ; 012E 012F 
...
bra_85CF:
loc_85CF:
C - - - - - 0x0345DF 0D:85CF: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x0345E2 0D:85D2: B9 7A 06  LDA ram_067A_plr,Y
...
bra_85DD:
C - - - - - 0x0345ED 0D:85DD: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
...
ofs_033_860A_15:
C - - J - - 0x03461A 0D:860A: BD DA 06  LDA ram_06DA_cpu_script,X ; 06DA 06DB 
...
ofs_032_8624_09:
C - - J - - 0x034634 0D:8624: BD 20 05  LDA ram_obj_state_hi,X ; 0521 
C - - - - - 0x034637 0D:8627: C9 03     CMP #con_plr_state_получает_урон
C - - - - - 0x034639 0D:8629: D0 03     BNE bra_862E
C - - - - - 0x03463B 0D:862B: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
bra_862E:
...
C - - - - - 0x034654 0D:8644: 20 2F EE  JSR sub_0x03EE3F_проверка_запущенного_мяча_соперником
C - - - - - 0x034657 0D:8647: 90 1B     BCC bra_8664    ; if true
; if false
C - - - - - 0x034659 0D:8649: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x03465C 0D:864C: B9 7A 06  LDA ram_067A_plr,Y
...
C - - - - - 0x03466C 0D:865C: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x03466F 0D:865F: 90 03     BCC bra_8664    ; if true
; if false
C - - - - - 0x034671 0D:8661: 4C 0E 8A  JMP loc_8A0E
bra_8664:
C - - - - - 0x034674 0D:8664: A9 00     LDA #$00
C - - - - - 0x034676 0D:8666: 9D FA 06  STA ram_06FA_plr,X ; 06FB 
C - - - - - 0x034679 0D:8669: 4C FB 89  JMP loc_89FB



ofs_032_866C_07:
C - - J - - 0x03467C 0D:866C: BD 20 05  LDA ram_obj_state_hi,X ; 0521 
...
ofs_032_867F_06:
C - - J - - 0x03468F 0D:867F: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
...
ofs_032_869C_05:
C - - J - - 0x0346AC 0D:869C: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
C - - - - - 0x0346AF 0D:869F: C9 3C     CMP #$3C
C - - - - - 0x0346B1 0D:86A1: 90 03     BCC bra_86A6
C - - - - - 0x0346B3 0D:86A3: 4C FB 89  JMP loc_89FB
bra_86A6:
C - - - - - 0x0346B6 0D:86A6: 4C 96 ED  JMP loc_0x03EDA6_очистка_адресов_cpu_при_необходимости



ofs_032_86A9_04:
C - - J - - 0x0346B9 0D:86A9: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
...
ofs_032_86B2_03:
- - - - - - 0x0346C2 0D:86B2: BD 20 05  LDA ram_obj_state_hi,X
- - - - - - 0x0346C5 0D:86B5: C9 01     CMP #con_plr_state_в_прыжке
- - - - - - 0x0346C7 0D:86B7: D0 0A     BNE bra_86C3
- - - - - - 0x0346C9 0D:86B9: BD 10 04  LDA ram_obj_pos_Y_lo,X
...
ofs_032_86CB_02:
C - - J - - 0x0346DB 0D:86CB: BD 20 05  LDA ram_obj_state_hi,X ; 0521 
C - - - - - 0x0346DE 0D:86CE: C9 08     CMP #con_plr_state_делает_суперку
C - - - - - 0x0346E0 0D:86D0: D0 03     BNE bra_86D5
C - - - - - 0x0346E2 0D:86D2: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
bra_86D5:
...
- - - - - - 0x034714 0D:8704: 9D F6 06  STA ram_06F6_plr,X
- - - - - - 0x034717 0D:8707: 60        RTS



ofs_032_8708_00:
- - - - - - 0x034718 0D:8708: BD 20 05  LDA ram_obj_state_hi,X
...
bra_8731:
C - - - - - 0x034741 0D:8731: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
bra_8734:
...
ofs_033_8737_14:
C - - J - - 0x034747 0D:8737: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x03474A 0D:873A: B9 20 05  LDA ram_obj_state_hi,Y ; 0520 
...
C - - - - - 0x03477B 0D:876B: B9 20 05  LDA ram_obj_state_hi,Y ; 0520 0521 
...
ofs_033_8796_11:
C - - J - - 0x0347A6 0D:8796: 20 2F EE  JSR sub_0x03EE3F_проверка_запущенного_мяча_соперником
C - - - - - 0x0347A9 0D:8799: B0 4F     BCS bra_87EA    ; if false
; if true
...
- - - - - - 0x0347F2 0D:87E2: BD 20 05  LDA ram_obj_state_hi,X
...
ofs_033_87ED_0A:
C - - J - - 0x0347FD 0D:87ED: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x034800 0D:87F0: B9 30 05  LDA ram_0530_obj_state,Y ; 0530 0531 
C - - - - - 0x034803 0D:87F3: C9 05     CMP #$05
C - - - - - 0x034805 0D:87F5: D0 03     BNE bra_87FA
- - - - - - 0x034807 0D:87F7: 4C FB 89  JMP loc_89FB
bra_87FA:
C - - - - - 0x03480A 0D:87FA: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x03480D 0D:87FD: A9 00     LDA #$00
C - - - - - 0x03480F 0D:87FF: 85 0D     STA ram_000D
C - - - - - 0x034811 0D:8801: AD D6 06  LDA ram_дистанция_до_соперника_X_hi
...
C - - - - - 0x034860 0D:8850: BD 40 04  LDA ram_obj_pos_X_lo,X ; 0440 0441 
...
C - - - - - 0x034870 0D:8860: BD 40 04  LDA ram_obj_pos_X_lo,X ; 0440 0441 
...
ofs_033_88A2_04:
C - - J - - 0x0348B2 0D:88A2: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
C - - - - - 0x0348B5 0D:88A5: C9 03     CMP #con_plr_state_получает_урон
C - - - - - 0x0348B7 0D:88A7: F0 1E     BEQ bra_88C7
C - - - - - 0x0348B9 0D:88A9: BD DA 06  LDA ram_06DA_cpu_script,X
...
bra_88C7:
C - - - - - 0x0348D7 0D:88C7: 4C 96 ED  JMP loc_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_033_8907_07:
C - - J - - 0x034917 0D:8907: BD 10 04  LDA ram_obj_pos_Y_lo,X ; 0410 0411 
C - - - - - 0x03491A 0D:890A: C9 A0     CMP #$A0
C - - - - - 0x03491C 0D:890C: B0 08     BCS bra_8916
C - - - - - 0x03491E 0D:890E: BD 60 04  LDA ram_obj_spd_Z_hi,X ; 0460 0461 
C - - - - - 0x034921 0D:8911: 30 03     BMI bra_8916
C - - - - - 0x034923 0D:8913: 4C 96 ED  JMP loc_0x03EDA6_очистка_адресов_cpu_при_необходимости
bra_8916:
C - - - - - 0x034926 0D:8916: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x034929 0D:8919: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
C - - - - - 0x03492C 0D:891C: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x03492F 0D:891F: B9 04 8B  LDA tbl_8B04,Y
C - - - - - 0x034932 0D:8922: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
C - - - - - 0x034935 0D:8925: 90 03     BCC bra_892A    ; if достаточно близко
; if далеко
...
ofs_033_892D_08:
bra_892D:
C - - J - - 0x03493D 0D:892D: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
C - - - - - 0x034940 0D:8930: C9 03     CMP #con_plr_state_получает_урон
C - - - - - 0x034942 0D:8932: F0 93     BEQ bra_88C7
C - - - - - 0x034944 0D:8934: BD DA 06  LDA ram_06DA_cpu_script,X ; 06DA 06DB 
...
- - - - - - 0x034958 0D:8948: 9D DA 06  STA ram_06DA_cpu_script,X
- - - - - - 0x03495B 0D:894B: F0 E0     BEQ bra_892D   ; jmp



ofs_030_894D_02:
C - - J - - 0x03495D 0D:894D: BD 10 06  LDA ram_plr_флаг_индекса_атаки,X ; 0610 0611 
C - - - - - 0x034960 0D:8950: D0 03     BNE bra_8955
C - - - - - 0x034962 0D:8952: 4C CA 88  JMP loc_88CA
bra_8955:
C - - - - - 0x034965 0D:8955: FE DA 06  INC ram_06DA_cpu_script,X
C - - - - - 0x034968 0D:8958: 60        RTS



ofs_030_8959_03:
C - - J - - 0x034969 0D:8959: BD 10 06  LDA ram_plr_флаг_индекса_атаки,X ; 0610 0611 
...
ofs_033_896F_00:
C - - J - - 0x03497F 0D:896F: BD DA 06  LDA ram_06DA_cpu_script,X ; 06DA 06DB 
...
C - - - - - 0x034990 0D:8980: 9D DA 06  STA ram_06DA_cpu_script,X ; 06DA 06DB 
...
C - - - - - 0x0349A5 0D:8995: D9 EA 06  CMP ram_06EA,Y ; 06EA 06EE 
...
ofs_033_899D_0D:
C - - J - - 0x0349AD 0D:899D: BD DA 06  LDA ram_06DA_cpu_script,X ; 06DA 06DB 
...
C - - - - - 0x0349B8 0D:89A8: 9D DA 06  STA ram_06DA_cpu_script,X ; 06DA 06DB 
C - - - - - 0x0349BB 0D:89AB: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
...
; con_fighter_don
; con_fighter___don
C - - - - - 0x0349C5 0D:89B5: B9 7A 06  LDA ram_067A_plr,Y
...
C - - - - - 0x0349D0 0D:89C0: A9 19     LDA #con_06D4_19
C - - - - - 0x0349D2 0D:89C2: 9D D4 06  STA ram_06D4_cpu_script,X ; 06D4 06D5 
C - - - - - 0x0349D5 0D:89C5: A9 00     LDA #$00
C - - - - - 0x0349D7 0D:89C7: 9D DA 06  STA ram_06DA_cpu_script,X
C - - - - - 0x0349DA 0D:89CA: 4C F9 EC  JMP loc_ECF9
bra_89CD:
C - - - - - 0x0349DD 0D:89CD: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x0349E0 0D:89D0: B9 7A 06  LDA ram_067A_plr,Y
...
bra_89DD:
C - - - - - 0x0349ED 0D:89DD: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x0349F0 0D:89E0: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
C - - - - - 0x0349F3 0D:89E3: D0 B5     BNE bra_899A
C - - - - - 0x0349F5 0D:89E5: AD F8 06  LDA ram_06F8
C - - - - - 0x0349F8 0D:89E8: 10 B0     BPL bra_899A
C - - - - - 0x0349FA 0D:89EA: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
C - - - - - 0x0349FD 0D:89ED: C9 03     CMP #con_plr_state_получает_урон
C - - - - - 0x0349FF 0D:89EF: F0 A9     BEQ bra_899A
C - - - - - 0x034A01 0D:89F1: 20 2F EE  JSR sub_0x03EE3F_проверка_запущенного_мяча_соперником
C - - - - - 0x034A04 0D:89F4: 90 A4     BCC bra_899A    ; if true
; if false
C - - - - - 0x034A06 0D:89F6: DE DA 06  DEC ram_06DA_cpu_script,X
...
ofs_033_8A73_03:
C - - J - - 0x034A83 0D:8A73: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x034A86 0D:8A76: B9 30 05  LDA ram_0530_obj_state,Y ; 0530 0531 
C - - - - - 0x034A89 0D:8A79: C9 05     CMP #$05
C - - - - - 0x034A8B 0D:8A7B: D0 03     BNE bra_8A80
- - - - - - 0x034A8D 0D:8A7D: 4C FB 89  JMP loc_89FB
bra_8A80:
C - - - - - 0x034A90 0D:8A80: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
...
bra_8AA9:
- - - - - - 0x034AB9 0D:8AA9: 4C 96 ED  JMP loc_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x034ACD 0D:8ABD: 4C 96 ED  JMP loc_0x03EDA6_очистка_адресов_cpu_при_необходимости
bra_8AC0:
C - - - - - 0x034AD0 0D:8AC0: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x034AD3 0D:8AC3: B0 11     BCS bra_8AD6    ; if false
; if true
...
C - - - - - 0x034AE1 0D:8AD1: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
C - - - - - 0x034AE4 0D:8AD4: B0 03     BCS bra_8AD9    ; if далеко
...
; bzk garbage? или для всех 7 персов?
...
con_8B0B_FD                             = $FD ; 
con_8B0B_FE                             = $FE ; 
con_8B0B_FF_end_token                   = $FF ; 



_off015_8B97_44:
- D 0 - I - 0x034BA7 0D:8B97: DA        .byte con_8B0B_DA   ; 
- D 0 - I - 0x034BA8 0D:8B98: D7        .byte con_8B0B_D7, $08   ; 
- D 0 - I - 0x034BAA 0D:8B9A: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034BB6 0D:8BA6: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034BBA 0D:8BAA: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8BAB_00:
- - - - - - 0x034BBB 0D:8BAB: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8BAD_10:
- D 0 - I - 0x034BBD 0D:8BAD: 40        .byte $40   ; 
- D 0 - I - 0x034BBE 0D:8BAE: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8BAF_11:
- D 0 - I - 0x034BBF 0D:8BAF: FD        .byte con_8B0B_FD, con_06D4_08   ; 
- D 0 - I - 0x034BC1 0D:8BB1: 04        .byte $04   ; 
- D 0 - I - 0x034BC2 0D:8BB2: 40        .byte $40   ; 
- D 0 - I - 0x034BC3 0D:8BB3: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8BB4_12:
- D 0 - I - 0x034BC4 0D:8BB4: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
- D 0 - I - 0x034BC6 0D:8BB6: F0        .byte con_8B0B_F0   ; 
- D 0 - I - 0x034BC7 0D:8BB7: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034BCA 0D:8BBA: FD        .byte con_8B0B_FD, con_06D4_02   ; 
- D 0 - I - 0x034BCC 0D:8BBC: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034BCD 0D:8BBD: F7        .byte con_8B0B_F7   ; 
- D 0 - I - 0x034BCE 0D:8BBE: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034BD1 0D:8BC1: FD        .byte con_8B0B_FD, con_06D4_03   ; 
- D 0 - I - 0x034BD3 0D:8BC3: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034BD4 0D:8BC4: FD        .byte con_8B0B_FD, con_06D4_08   ; 
- D 0 - I - 0x034BD6 0D:8BC6: 04        .byte $04   ; 
- D 0 - I - 0x034BD7 0D:8BC7: 40        .byte $40   ; 
- D 0 - I - 0x034BD8 0D:8BC8: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8BC9_15:
- D 0 - I - 0x034BD9 0D:8BC9: D7        .byte con_8B0B_D7, $04   ; 
- D 0 - I - 0x034BDB 0D:8BCB: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034BDC 0D:8BCC: D5        .byte con_8B0B_D5   ; 
- D 0 - I - 0x034BDD 0D:8BCD: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
- D 0 - I - 0x034BDF 0D:8BCF: F0        .byte con_8B0B_F0   ; 
- D 0 - I - 0x034BE0 0D:8BD0: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034BE5 0D:8BD5: FD        .byte con_8B0B_FD, con_06D4_05   ; 
- D 0 - I - 0x034BE7 0D:8BD7: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034BE8 0D:8BD8: FF        .byte con_8B0B_FF_end_token   ; 
...
- - - - - - 0x034BED 0D:8BDD: FD        .byte con_8B0B_FD, con_06D4_0C   ; 
- - - - - - 0x034BEF 0D:8BDF: DE        .byte con_8B0B_DE   ; 
- - - - - - 0x034BF0 0D:8BE0: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8BE1_17:
- D 0 - I - 0x034BF1 0D:8BE1: 80        .byte $80   ; 
- D 0 - I - 0x034BF2 0D:8BE2: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8BE3_18:
- D 0 - I - 0x034BF3 0D:8BE3: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
- D 0 - I - 0x034BF5 0D:8BE5: F0        .byte con_8B0B_F0   ; 
- D 0 - I - 0x034BF6 0D:8BE6: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
- D 0 - I - 0x034BF8 0D:8BE8: F0        .byte con_8B0B_F0   ; 
- D 0 - I - 0x034BF9 0D:8BE9: 80        .byte $80   ; 
- D 0 - I - 0x034BFA 0D:8BEA: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8BEB_19:
- D 0 - I - 0x034BFB 0D:8BEB: FD        .byte con_8B0B_FD, con_06D4_08   ; 
- D 0 - I - 0x034BFD 0D:8BED: F3        .byte con_8B0B_F3   ; 
- D 0 - I - 0x034BFE 0D:8BEE: 80        .byte $80   ; 
- D 0 - I - 0x034BFF 0D:8BEF: F3        .byte con_8B0B_F3   ; 
- D 0 - I - 0x034C00 0D:8BF0: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034C03 0D:8BF3: FD        .byte con_8B0B_FD, con_06D4_02   ; 
- D 0 - I - 0x034C05 0D:8BF5: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034C06 0D:8BF6: F6        .byte con_8B0B_F6   ; 
- D 0 - I - 0x034C07 0D:8BF7: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034C0A 0D:8BFA: FD        .byte con_8B0B_FD, con_06D4_02   ; 
- D 0 - I - 0x034C0C 0D:8BFC: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034C0D 0D:8BFD: FD        .byte con_8B0B_FD, con_06D4_08   ; 
- D 0 - I - 0x034C0F 0D:8BFF: 04        .byte $04   ; 
- D 0 - I - 0x034C10 0D:8C00: 80        .byte $80   ; 
- D 0 - I - 0x034C11 0D:8C01: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8C02_1C:
- D 0 - I - 0x034C12 0D:8C02: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034C13 0D:8C03: FD        .byte con_8B0B_FD, con_06D4_0E   ; 
- D 0 - I - 0x034C15 0D:8C05: D5        .byte con_8B0B_D5   ; 
- D 0 - I - 0x034C16 0D:8C06: FD        .byte con_8B0B_FD, con_06D4_0B   ; 
- D 0 - I - 0x034C18 0D:8C08: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034C19 0D:8C09: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
- D 0 - I - 0x034C1B 0D:8C0B: F0        .byte con_8B0B_F0   ; 
- D 0 - I - 0x034C1C 0D:8C0C: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034C20 0D:8C10: FD        .byte con_8B0B_FD, con_06D4_01   ; 
- D 0 - I - 0x034C22 0D:8C12: DF        .byte con_8B0B_DF   ; 
- D 0 - I - 0x034C23 0D:8C13: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034C26 0D:8C16: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
- D 0 - I - 0x034C28 0D:8C18: F1        .byte con_8B0B_F1   ; 
- D 0 - I - 0x034C29 0D:8C19: D9        .byte con_8B0B_D9   ; 
- D 0 - I - 0x034C2A 0D:8C1A: FD        .byte con_8B0B_FD, con_06D4_07   ; 
- D 0 - I - 0x034C2C 0D:8C1C: F3        .byte con_8B0B_F3   ; 
- D 0 - I - 0x034C2D 0D:8C1D: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034C30 0D:8C20: FD        .byte con_8B0B_FD, con_06D4_0D   ; 
- D 0 - I - 0x034C32 0D:8C22: DF        .byte con_8B0B_DF   ; 
- D 0 - I - 0x034C33 0D:8C23: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8C24_02:
- D 0 - I - 0x034C34 0D:8C24: DA        .byte con_8B0B_DA   ; 
- D 0 - I - 0x034C35 0D:8C25: FD        .byte con_8B0B_FD, con_06D4_0D   ; 
- D 0 - I - 0x034C37 0D:8C27: F3        .byte con_8B0B_F3   ; 
- D 0 - I - 0x034C38 0D:8C28: FF        .byte con_8B0B_FF_end_token   ; 
...
_off015_8C2B_0B:
- D 0 - I - 0x034C3B 0D:8C2B: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
- D 0 - I - 0x034C3D 0D:8C2D: F0        .byte con_8B0B_F0   ; 
- D 0 - I - 0x034C3E 0D:8C2E: FD        .byte con_8B0B_FD, con_06D4_07   ; 
- D 0 - I - 0x034C40 0D:8C30: 04        .byte $04   ; 
- D 0 - I - 0x034C41 0D:8C31: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8C32_04:
- D 0 - I - 0x034C42 0D:8C32: DA        .byte con_8B0B_DA   ; 
- D 0 - I - 0x034C43 0D:8C33: FD        .byte con_8B0B_FD, con_06D4_0D   ; 
- D 0 - I - 0x034C45 0D:8C35: DF        .byte con_8B0B_DF   ; 
- D 0 - I - 0x034C46 0D:8C36: FD        .byte con_8B0B_FD, con_06D4_05   ; 
- D 0 - I - 0x034C48 0D:8C38: DF        .byte con_8B0B_DF   ; 
- D 0 - I - 0x034C49 0D:8C39: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8C3A_08:
- D 0 - I - 0x034C4A 0D:8C3A: DA        .byte con_8B0B_DA   ; 
- D 0 - I - 0x034C4B 0D:8C3B: FD        .byte con_8B0B_FD, con_06D4_11   ; 
- D 0 - I - 0x034C4D 0D:8C3D: DF        .byte con_8B0B_DF   ; 
- D 0 - I - 0x034C4E 0D:8C3E: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8C3F_03:
- D 0 - I - 0x034C4F 0D:8C3F: DA        .byte con_8B0B_DA   ; 
- D 0 - I - 0x034C50 0D:8C40: D6        .byte con_8B0B_D6, $02   ; 
- D 0 - I - 0x034C52 0D:8C42: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8C43_0A:
- D 0 - I - 0x034C53 0D:8C43: D6        .byte con_8B0B_D6, $01   ; 
- D 0 - I - 0x034C55 0D:8C45: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034C60 0D:8C50: FD        .byte con_8B0B_FD, con_06D4_03   ; 
- D 0 - I - 0x034C62 0D:8C52: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034C63 0D:8C53: D4        .byte con_8B0B_D4   ; 
- D 0 - I - 0x034C64 0D:8C54: FD        .byte con_8B0B_FD, con_06D4_16   ; 
- D 0 - I - 0x034C66 0D:8C56: DF        .byte con_8B0B_DF   ; 
- D 0 - I - 0x034C67 0D:8C57: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034C6A 0D:8C5A: FD        .byte con_8B0B_FD, con_06D4_03   ; 
- D 0 - I - 0x034C6C 0D:8C5C: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034C6D 0D:8C5D: D4        .byte con_8B0B_D4   ; 
- D 0 - I - 0x034C6E 0D:8C5E: FD        .byte con_8B0B_FD, con_06D4_16   ; 
- D 0 - I - 0x034C70 0D:8C60: DF        .byte con_8B0B_DF   ; 
- D 0 - I - 0x034C71 0D:8C61: DC        .byte con_8B0B_DC, $50   ; 
- D 0 - I - 0x034C73 0D:8C63: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034C76 0D:8C66: FD        .byte con_8B0B_FD, con_06D4_02   ; 
- D 0 - I - 0x034C78 0D:8C68: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034C79 0D:8C69: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034C7C 0D:8C6C: FD        .byte con_8B0B_FD, con_06D4_01   ; 
- D 0 - I - 0x034C7E 0D:8C6E: DF        .byte con_8B0B_DF   ; 
- D 0 - I - 0x034C7F 0D:8C6F: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034C82 0D:8C72: FD        .byte con_8B0B_FD, con_06D4_06   ; 
- D 0 - I - 0x034C84 0D:8C74: F4        .byte con_8B0B_F4   ; 
- D 0 - I - 0x034C85 0D:8C75: DA        .byte con_8B0B_DA   ; 
- D 0 - I - 0x034C86 0D:8C76: FD        .byte con_8B0B_FD, con_06D4_04   ; 
- D 0 - I - 0x034C88 0D:8C78: 04        .byte $04   ; 
- D 0 - I - 0x034C89 0D:8C79: 40        .byte $40   ; 
- D 0 - I - 0x034C8A 0D:8C7A: FF        .byte con_8B0B_FF_end_token   ; 
...
- - - - - - 0x034C8D 0D:8C7D: FD        .byte con_8B0B_FD, con_06D4_06   ; 
- - - - - - 0x034C8F 0D:8C7F: F5        .byte con_8B0B_F5   ; 
- - - - - - 0x034C90 0D:8C80: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034C95 0D:8C85: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
- D 0 - I - 0x034C97 0D:8C87: 08        .byte $08   ; 
- D 0 - I - 0x034C98 0D:8C88: 40        .byte $40   ; 
- D 0 - I - 0x034C99 0D:8C89: FF        .byte con_8B0B_FF_end_token   ; 
...
- - - - - - 0x034C9C 0D:8C8C: FD        .byte con_8B0B_FD, con_06D4_0D   ; 
- - - - - - 0x034C9E 0D:8C8E: DF        .byte con_8B0B_DF   ; 



_off015_8C8F_3A:
- D 0 - I - 0x034C9F 0D:8C8F: D7        .byte con_8B0B_D7, $02   ; 
...
- D 0 - I - 0x034CA7 0D:8C97: FD        .byte con_8B0B_FD, con_06D4_14   ; 
- D 0 - I - 0x034CA9 0D:8C99: DF        .byte con_8B0B_DF   ; 
- D 0 - I - 0x034CAA 0D:8C9A: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034CB0 0D:8CA0: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034CB7 0D:8CA7: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034CBA 0D:8CAA: FD        .byte con_8B0B_FD, con_06D4_00   ; 
...
- D 0 - I - 0x034CC2 0D:8CB2: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8CB3_43:
- D 0 - I - 0x034CC3 0D:8CB3: DF        .byte con_8B0B_DF   ; 
- D 0 - I - 0x034CC4 0D:8CB4: FD        .byte con_8B0B_FD, con_06D4_07   ; 
...
- D 0 - I - 0x034CCA 0D:8CBA: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034CCF 0D:8CBF: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8CC0_21:
- D 0 - I - 0x034CD0 0D:8CC0: D7        .byte con_8B0B_D7, $06   ; 
...
- D 0 - I - 0x034CD7 0D:8CC7: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034CDC 0D:8CCC: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034CE2 0D:8CD2: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8CD3_24:
- D 0 - I - 0x034CE3 0D:8CD3: D7        .byte con_8B0B_D7, $09   ; 
- D 0 - I - 0x034CE5 0D:8CD5: D7        .byte con_8B0B_D7, $06   ; 
...
- D 0 - I - 0x034CEB 0D:8CDB: D7        .byte con_8B0B_D7, $07   ; 
- D 0 - I - 0x034CED 0D:8CDD: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8CDE_33:
- D 0 - I - 0x034CEE 0D:8CDE: DC        .byte con_8B0B_DC, $20   ; 
- D 0 - I - 0x034CF0 0D:8CE0: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
...
- D 0 - I - 0x034CF7 0D:8CE7: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8CE8_45:
- - - - - - 0x034CF8 0D:8CE8: DC        .byte con_8B0B_DC, $68   ; 
- - - - - - 0x034CFA 0D:8CEA: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
...
- - - - - - 0x034D01 0D:8CF1: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034D06 0D:8CF6: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034D0B 0D:8CFB: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8CFC_28:
- - - - - - 0x034D0C 0D:8CFC: DA        .byte con_8B0B_DA   ; 
- - - - - - 0x034D0D 0D:8CFD: FD        .byte con_8B0B_FD, con_06D4_00   ; 
...
- D 0 - I - 0x034D36 0D:8D26: FD        .byte con_8B0B_FD, con_06D4_03   ; 
- D 0 - I - 0x034D38 0D:8D28: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034D39 0D:8D29: D4        .byte con_8B0B_D4   ; 
- D 0 - I - 0x034D3A 0D:8D2A: FD        .byte con_8B0B_FD, con_06D4_16   ; 
- D 0 - I - 0x034D3C 0D:8D2C: DF        .byte con_8B0B_DF   ; 
- D 0 - I - 0x034D3D 0D:8D2D: D7        .byte con_8B0B_D7, $05   ; 
- D 0 - I - 0x034D3F 0D:8D2F: D8        .byte con_8B0B_D8, con_шаблон_ai_07   ; 
- D 0 - I - 0x034D41 0D:8D31: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8D32_2A:
- - - - - - 0x034D42 0D:8D32: DA        .byte con_8B0B_DA   ; 
- - - - - - 0x034D43 0D:8D33: FD        .byte con_8B0B_FD, con_06D4_08   ; 
...
- - - - - - 0x034D4B 0D:8D3B: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8D3C_2F:
- D 0 - I - 0x034D4C 0D:8D3C: DA        .byte con_8B0B_DA   ; 
- D 0 - I - 0x034D4D 0D:8D3D: FD        .byte con_8B0B_FD, con_06D4_00   ; 
...
- D 0 - I - 0x034D53 0D:8D43: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8D44_2B:
- D 0 - I - 0x034D54 0D:8D44: DA        .byte con_8B0B_DA   ; 
- D 0 - I - 0x034D55 0D:8D45: FD        .byte con_8B0B_FD, con_06D4_00   ; 
...
- D 0 - I - 0x034D5C 0D:8D4C: D7        .byte con_8B0B_D7, $05   ; 
- D 0 - I - 0x034D5E 0D:8D4E: D8        .byte con_8B0B_D8, con_шаблон_ai_07   ; 
- D 0 - I - 0x034D60 0D:8D50: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8D51_3D:
- D 0 - I - 0x034D61 0D:8D51: DA        .byte con_8B0B_DA   ; 
- D 0 - I - 0x034D62 0D:8D52: FD        .byte con_8B0B_FD, con_06D4_00   ; 
...
- D 0 - I - 0x034D67 0D:8D57: FD        .byte con_8B0B_FD, con_06D4_0B   ; 
- D 0 - I - 0x034D69 0D:8D59: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034D6A 0D:8D5A: F7        .byte con_8B0B_F7   ; 
- D 0 - I - 0x034D6B 0D:8D5B: D7        .byte con_8B0B_D7, $05   ; 
- D 0 - I - 0x034D6D 0D:8D5D: D8        .byte con_8B0B_D8, con_шаблон_ai_07   ; 
- D 0 - I - 0x034D6F 0D:8D5F: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034D75 0D:8D65: D7        .byte con_8B0B_D7, $04   ; 
- D 0 - I - 0x034D77 0D:8D67: D8        .byte con_8B0B_D8, con_шаблон_ai_07   ; 
- D 0 - I - 0x034D79 0D:8D69: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8D6A_2C:
- D 0 - I - 0x034D7A 0D:8D6A: 04        .byte $04   ; 
- D 0 - I - 0x034D7B 0D:8D6B: FD        .byte con_8B0B_FD, con_06D4_10   ; 
- D 0 - I - 0x034D7D 0D:8D6D: 04        .byte $04   ; 
- D 0 - I - 0x034D7E 0D:8D6E: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8D6F_2D:
- D 0 - I - 0x034D7F 0D:8D6F: DC        .byte con_8B0B_DC, $48   ; 
- D 0 - I - 0x034D81 0D:8D71: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
- D 0 - I - 0x034D83 0D:8D73: F0        .byte con_8B0B_F0   ; 
- D 0 - I - 0x034D84 0D:8D74: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8D75_31:
- D 0 - I - 0x034D85 0D:8D75: DC        .byte con_8B0B_DC, $48   ; 
- D 0 - I - 0x034D87 0D:8D77: FD        .byte con_8B0B_FD, con_06D4_0F   ; 
- D 0 - I - 0x034D89 0D:8D79: F0        .byte con_8B0B_F0   ; 
- D 0 - I - 0x034D8A 0D:8D7A: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8D7B_34:
- D 0 - I - 0x034D8B 0D:8D7B: DC        .byte con_8B0B_DC, $35   ; 
- D 0 - I - 0x034D8D 0D:8D7D: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034D8E 0D:8D7E: D5        .byte con_8B0B_D5   ; 
- D 0 - I - 0x034D8F 0D:8D7F: FD        .byte con_8B0B_FD, con_06D4_0C   ; 
- D 0 - I - 0x034D91 0D:8D81: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034D92 0D:8D82: FD        .byte con_8B0B_FD, con_06D4_13   ; 
- D 0 - I - 0x034D94 0D:8D84: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034D95 0D:8D85: D5        .byte con_8B0B_D5   ; 
- D 0 - I - 0x034D96 0D:8D86: FD        .byte con_8B0B_FD, con_06D4_0C   ; 
- D 0 - I - 0x034D98 0D:8D88: F7        .byte con_8B0B_F7   ; 
- D 0 - I - 0x034D99 0D:8D89: FD        .byte con_8B0B_FD, con_06D4_13   ; 
- D 0 - I - 0x034D9B 0D:8D8B: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034D9C 0D:8D8C: D8        .byte con_8B0B_D8, con_шаблон_ai_35   ; 
- D 0 - I - 0x034D9E 0D:8D8E: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034DA1 0D:8D91: FD        .byte con_8B0B_FD, con_06D4_0C   ; 
- D 0 - I - 0x034DA3 0D:8D93: F6        .byte con_8B0B_F6   ; 
- D 0 - I - 0x034DA4 0D:8D94: FD        .byte con_8B0B_FD, con_06D4_13   ; 
- D 0 - I - 0x034DA6 0D:8D96: DE        .byte con_8B0B_DE   ; 
- D 0 - I - 0x034DA7 0D:8D97: D7        .byte con_8B0B_D7, $00   ; 
- D 0 - I - 0x034DA9 0D:8D99: D8        .byte con_8B0B_D8, con_шаблон_ai_35   ; 
- D 0 - I - 0x034DAB 0D:8D9B: D8        .byte con_8B0B_D8, con_шаблон_ai_37   ; 
- D 0 - I - 0x034DAD 0D:8D9D: FF        .byte con_8B0B_FF_end_token   ; 
...
- - - - - - 0x034DB1 0D:8DA1: D7        .byte con_8B0B_D7, $01   ; 
- - - - - - 0x034DB3 0D:8DA3: FF        .byte con_8B0B_FF_end_token   ; 



_off015_8DA4_3C:
- - - - - - 0x034DB4 0D:8DA4: DA        .byte con_8B0B_DA   ; 
- - - - - - 0x034DB5 0D:8DA5: D7        .byte con_8B0B_D7, $03   ; 
- - - - - - 0x034DB7 0D:8DA7: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - I - 0x034DBD 0D:8DAD: FF        .byte con_8B0B_FF_end_token   ; 
...
- D 0 - - - 0x034DDD 0D:8DCD: 08        .byte $08, $04, $00, $00   ; 06 con_fighter_shred
                                    .if con_новые_персы <> $00
                                        .byte $40, $20, $00, $00   ; 07 con_fighter___leo
                                        .byte $10, $08, $00, $00   ; 08 con_fighter___raph
                                        .byte $10, $08, $00, $00   ; 09 con_fighter___mike
                                        .byte $10, $08, $00, $00   ; 0A con_fighter___don
                                        .byte $10, $08, $00, $00   ; 0B con_fighter___casey
                                        .byte $20, $10, $00, $00   ; 0C con_fighter___hot
                                        .byte $08, $04, $00, $00   ; 0D con_fighter___shred
                                    .endif
...
- - - - - - 0x034DF8 0D:8DE8: 10        .byte $10, $05, $01, $01   ; 06 con_fighter_shred
                                    .if con_новые_персы <> $00
                                        .byte $14, $08, $03, $01   ; 07 con_fighter___leo
                                        .byte $14, $08, $03, $01   ; 08 con_fighter___raph
                                        .byte $14, $08, $03, $01   ; 09 con_fighter___mike
                                        .byte $14, $08, $03, $01   ; 0A con_fighter___don
                                        .byte $08, $04, $01, $01   ; 0B con_fighter___casey
                                        .byte $18, $0A, $05, $01   ; 0C con_fighter___hot
                                        .byte $10, $05, $01, $01   ; 0D con_fighter___shred
                                    .endif
...
C - - - - - 0x034E01 0D:8DF1: 20 C6 ED  JSR sub_0x03EDD6_генератор_рандома_по_сложности_игры_1
...
bra_8E08:
loc_8E08:
C D 0 - - - 0x034E18 0D:8E08: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_029_8E17_00:
C - - J - - 0x034E27 0D:8E17: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x034E3F 0D:8E2F: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x034E42 0D:8E32: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
...
C - - - - - 0x034E4D 0D:8E3D: B9 10 04  LDA ram_obj_pos_Y_lo,Y ; 0410 0411 
...
C - - - - - 0x034E5E 0D:8E4E: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x034E61 0D:8E51: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
C - - - - - 0x034E64 0D:8E54: B9 B4 90  LDA tbl_90B4_шаблоны_leo,Y
C - - - - - 0x034E67 0D:8E57: 60        RTS
bra_8E58:
loc_8E58:
C D 0 - - - 0x034E68 0D:8E58: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x034E6B 0D:8E5B: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
...
loc_8E62:
C D 0 - - - 0x034E72 0D:8E62: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
...
bra_8E77:
C - - - - - 0x034E87 0D:8E77: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x034E8A 0D:8E7A: A9 10     LDA #con_шаблон_ai_10
C - - - - - 0x034E8C 0D:8E7C: 60        RTS



bra_8E7D:
C - - - - - 0x034E8D 0D:8E7D: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
bra_8EBE:
loc_8EBE:
C D 0 - - - 0x034ECE 0D:8EBE: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_029_8EC4_01:
C - - J - - 0x034ED4 0D:8EC4: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
bra_8EDF:
C - - - - - 0x034EEF 0D:8EDF: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
...
C - - - - - 0x034F06 0D:8EF6: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x034F16 0D:8F06: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x034F19 0D:8F09: B0 2C     BCS bra_8F37
loc_8F0B:
C D 0 - - - 0x034F1B 0D:8F0B: A9 16     LDA #con_шаблон_ai_16
C - - - - - 0x034F1D 0D:8F0D: 60        RTS
bra_8F0E:
C - - - - - 0x034F1E 0D:8F0E: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x034F21 0D:8F11: A9 34     LDA #con_шаблон_ai_34
C - - - - - 0x034F23 0D:8F13: 60        RTS
bra_8F14:
C - - - - - 0x034F24 0D:8F14: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x034F27 0D:8F17: A5 11     LDA ram_0011
C - - - - - 0x034F29 0D:8F19: C9 01     CMP #$01
C - - - - - 0x034F2B 0D:8F1B: F0 0D     BEQ bra_8F2A
C - - - - - 0x034F2D 0D:8F1D: 20 C6 ED  JSR sub_0x03EDD6_генератор_рандома_по_сложности_игры_1
...
bra_8F2A:
C - - - - - 0x034F3A 0D:8F2A: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
- - - - - - 0x034F96 0D:8F86: 9D E6 06  STA ram_06E6_cpu,X
- - - - - - 0x034F99 0D:8F89: 60        RTS
bra_8F8A:
- - - - - - 0x034F9A 0D:8F8A: B9 10 04  LDA ram_obj_pos_Y_lo,Y
...
ofs_029_8F94_02:
C - - J - - 0x034FA4 0D:8F94: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x034FB2 0D:8FA2: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
...
bra_8FB0:
C - - - - - 0x034FC0 0D:8FB0: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
C - - - - - 0x034FC3 0D:8FB3: A9 70     LDA #$70
C - - - - - 0x034FC5 0D:8FB5: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
C - - - - - 0x034FC8 0D:8FB8: B0 08     BCS bra_8FC2    ; if далеко
; if достаточно близко
C - - - - - 0x034FCA 0D:8FBA: 20 5E 90  JSR sub_905E
C - - - - - 0x034FCD 0D:8FBD: B0 03     BCS bra_8FC2
C - - - - - 0x034FCF 0D:8FBF: 4C 0B 8F  JMP loc_8F0B
bra_8FC2:
C - - - - - 0x034FD2 0D:8FC2: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x034FD5 0D:8FC5: B0 10     BCS bra_8FD7    ; if false
; if true
...
bra_8FDF:
C - - - - - 0x034FEF 0D:8FDF: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
C - - - - - 0x034FF2 0D:8FE2: D0 2E     BNE bra_9012
C - - - - - 0x034FF4 0D:8FE4: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x034FF7 0D:8FE7: 90 32     BCC bra_901B
C - - - - - 0x034FF9 0D:8FE9: A5 12     LDA ram_0012
C - - - - - 0x034FFB 0D:8FEB: D0 12     BNE bra_8FFF
C - - - - - 0x034FFD 0D:8FED: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x035000 0D:8FF0: B0 0D     BCS bra_8FFF    ; if false
; if true
- - - - - - 0x035002 0D:8FF2: 20 C6 ED  JSR sub_0x03EDD6_генератор_рандома_по_сложности_игры_1
...
bra_9015:
C - - - - - 0x035025 0D:9015: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_029_901E_03:
C - - J - - 0x03502E 0D:901E: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x035040 0D:9030: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
...
- - - - - - 0x03504B 0D:903B: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
- - - - - - 0x03504E 0D:903E: A9 30     LDA #$30
- - - - - - 0x035050 0D:9040: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
- - - - - - 0x035053 0D:9043: B0 05     BCS bra_904A    ; if далеко
; if достаточно близко
- - - - - - 0x035055 0D:9045: 20 5E 90  JSR sub_905E
- - - - - - 0x035058 0D:9048: 90 11     BCC bra_905B
bra_904A:
C - - - - - 0x03505A 0D:904A: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x03505D 0D:904D: B0 09     BCS bra_9058    ; if false
; if true
...
C - - - - - 0x035087 0D:9077: DD E2 06  CMP ram_06E2_cpu,X ; 06E2 
...
- - - - - - 0x0350A9 0D:9099: DD E2 06  CMP ram_06E2_cpu,X
...
ofs_028_90C9_00:
C - - J - - 0x0350D9 0D:90C9: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x0350DC 0D:90CC: 90 60     BCC bra_912E
C - - - - - 0x0350DE 0D:90CE: 20 5A ED  JSR sub_0x03ED6A
C - - - - - 0x0350E1 0D:90D1: 90 07     BCC bra_90DA
C - - - - - 0x0350E3 0D:90D3: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
C - - - - - 0x0350E6 0D:90D6: B9 90 92  LDA tbl_9290_шаблоны_raph,Y
C - - - - - 0x0350E9 0D:90D9: 60        RTS
bra_90DA:
C - - - - - 0x0350EA 0D:90DA: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x0350ED 0D:90DD: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
...
C - - - - - 0x035100 0D:90F0: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
C - - - - - 0x035103 0D:90F3: C9 60     CMP #$60
C - - - - - 0x035105 0D:90F5: B0 22     BCS bra_9119
C - - - - - 0x035107 0D:90F7: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x03510A 0D:90FA: A9 1F     LDA #con_шаблон_ai_1F
C - - - - - 0x03510C 0D:90FC: 60        RTS
bra_90FD:
C - - - - - 0x03510D 0D:90FD: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x035119 0D:9109: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
...
bra_911C:
C - - - - - 0x03512C 0D:911C: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_912E:
loc_912E:
- - - - - - 0x03513E 0D:912E: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_028_9134_01:
C - - J - - 0x035144 0D:9134: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
C - - - - - 0x035147 0D:9137: C9 01     CMP #con_plr_state_в_прыжке
C - - - - - 0x035149 0D:9139: D0 0F     BNE bra_914A
C - - - - - 0x03514B 0D:913B: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
bra_914A:
C - - - - - 0x03515A 0D:914A: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x035169 0D:9159: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x03516C 0D:915C: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
C - - - - - 0x03516F 0D:915F: F0 14     BEQ bra_9175
bra_9161:
C - - - - - 0x035171 0D:9161: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_9170:
C - - - - - 0x035180 0D:9170: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
...
C - - - - - 0x03518B 0D:917B: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
...
ofs_028_91AB_02:
C - - J - - 0x0351BB 0D:91AB: BD E2 06  LDA ram_06E2_cpu,X ; 06E2 06E3 
C - - - - - 0x0351BE 0D:91AE: C9 06     CMP #con_шаблон_ai_06
C - - - - - 0x0351C0 0D:91B0: D0 0A     BNE bra_91BC
C - - - - - 0x0351C2 0D:91B2: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
bra_91BC:
C - - - - - 0x0351CC 0D:91BC: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x0351E7 0D:91D7: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x0351EA 0D:91DA: B0 10     BCS bra_91EC
- - - - - - 0x0351EC 0D:91DC: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
- - - - - - 0x0351EF 0D:91DF: A9 30     LDA #$30
- - - - - - 0x0351F1 0D:91E1: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
- - - - - - 0x0351F4 0D:91E4: B0 06     BCS bra_91EC    ; if далеко
; if достаточно близко
- - - - - - 0x0351F6 0D:91E6: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x035202 0D:91F2: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x035205 0D:91F5: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
C - - - - - 0x035208 0D:91F8: D0 34     BNE bra_922E
C - - - - - 0x03520A 0D:91FA: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x03520D 0D:91FD: B0 04     BCS bra_9203    ; if false
; if true
...
C - - - - - 0x035218 0D:9208: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
C - - - - - 0x03521B 0D:920B: B9 88 92  LDA tbl_9288_шаблоны_raph,Y
C - - - - - 0x03521E 0D:920E: 60        RTS
bra_920F:
C - - - - - 0x03521F 0D:920F: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
...
ofs_028_9231_03:
C - - J - - 0x035241 0D:9231: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x035244 0D:9234: B0 03     BCS bra_9239
- - - - - - 0x035246 0D:9236: 4C 2E 91  JMP loc_912E
bra_9239:
C - - - - - 0x035249 0D:9239: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
...
- - - - - - 0x035260 0D:9250: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
- - - - - - 0x035263 0D:9253: A9 30     LDA #$30
- - - - - - 0x035265 0D:9255: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
- - - - - - 0x035268 0D:9258: B0 03     BCS bra_925D    ; if далеко
; if достаточно близко
bra_925A:
- - - - - - 0x03526A 0D:925A: A9 16     LDA #con_шаблон_ai_16
- - - - - - 0x03526C 0D:925C: 60        RTS
bra_925D:
C - - - - - 0x03526D 0D:925D: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x035270 0D:9260: B0 0C     BCS bra_926E    ; if false
; if true
C - - - - - 0x035272 0D:9262: A5 12     LDA ram_0012
C - - - - - 0x035274 0D:9264: C9 02     CMP #$02
C - - - - - 0x035276 0D:9266: B0 06     BCS bra_926E
bra_9268:
- - - - - - 0x035278 0D:9268: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
- - - - - - 0x03527B 0D:926B: A9 0F     LDA #con_шаблон_ai_0F
- - - - - - 0x03527D 0D:926D: 60        RTS
bra_926E:
C - - - - - 0x03527E 0D:926E: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
...
ofs_027_92B1_00:
C - - J - - 0x0352C1 0D:92B1: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x0352CF 0D:92BF: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x0352D2 0D:92C2: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 
C - - - - - 0x0352D5 0D:92C5: D0 37     BNE bra_92FE
C - - - - - 0x0352D7 0D:92C7: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
loc_92D4:
C D 0 - - - 0x0352E4 0D:92D4: BD 60 04  LDA ram_obj_spd_Z_hi,X ; 0461 
C - - - - - 0x0352E7 0D:92D7: 10 07     BPL bra_92E0
C - - - - - 0x0352E9 0D:92D9: BD 10 04  LDA ram_obj_pos_Y_lo,X ; 0411 
...
bra_92E3:
- - - - - - 0x0352F3 0D:92E3: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
- - - - - - 0x0352F6 0D:92E6: A9 08     LDA #con_шаблон_ai_08
- - - - - - 0x0352F8 0D:92E8: 60        RTS
bra_92E9:
C - - - - - 0x0352F9 0D:92E9: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x0352FC 0D:92EC: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
...
bra_92FE:
C - - - - - 0x03530E 0D:92FE: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_027_930D_01:
C - - J - - 0x03531D 0D:930D: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x035320 0D:9310: 90 D1     BCC bra_92E3
C - - - - - 0x035322 0D:9312: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x035325 0D:9315: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 
...
C - - - - - 0x035334 0D:9324: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
...
C - - - - - 0x035342 0D:9332: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
...
sub_9339:
C - - - - - 0x035349 0D:9339: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x03534C 0D:933C: B0 12     BCS bra_9350    ; if false
; if true
...
C - - - - - 0x035356 0D:9346: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
ofs_027_9353_03:
C - - J - - 0x035363 0D:9353: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
bra_935E:
C - - - - - 0x03536E 0D:935E: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x035371 0D:9361: B0 0C     BCS bra_936F    ; if false
; if true
...
bra_936F:
ofs_027_936F_02:
C - - - - - 0x03537F 0D:936F: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x035382 0D:9372: B0 06     BCS bra_937A
- - - - - - 0x035384 0D:9374: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_9380:
C - - - - - 0x035390 0D:9380: BD 20 05  LDA ram_obj_state_hi,X ; 0521 
...
bra_9395:
C - - - - - 0x0353A5 0D:9395: BD 10 04  LDA ram_obj_pos_Y_lo,X ; 0411 
C - - - - - 0x0353A8 0D:9398: C9 A0     CMP #$A0
C - - - - - 0x0353AA 0D:939A: B0 EB     BCS bra_9387
C - - - - - 0x0353AC 0D:939C: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
C - - - - - 0x0353AF 0D:939F: A9 20     LDA #$20
C - - - - - 0x0353B1 0D:93A1: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
C - - - - - 0x0353B5 0D:93A5: B0 E0     BCS bra_9387    ; if далеко
; if достаточно близко
C - - - - - 0x0353B7 0D:93A7: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_026_93CA_00:
C - - J - - 0x0353DA 0D:93CA: BD 2E 01  LDA ram_012E_plr,X ; 012E 012F 
...
- - - - - - 0x0353F9 0D:93E9: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X
- - - - - - 0x0353FC 0D:93EC: B9 40 05  LDA ram_obj_state_lo,Y
...
bra_9407:
C - - - - - 0x035417 0D:9407: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x03541A 0D:940A: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
C - - - - - 0x03541D 0D:940D: B9 8F 95  LDA tbl_958F_шаблоны_mike,Y
C - - - - - 0x035420 0D:9410: 9D E6 06  STA ram_06E6_cpu,X ; 06E7 
C - - - - - 0x035423 0D:9413: 60        RTS
bra_9414:
C - - - - - 0x035424 0D:9414: BD 60 04  LDA ram_obj_spd_Z_hi,X ; 0461 
C - - - - - 0x035427 0D:9417: 30 0C     BMI bra_9425
C - - - - - 0x035429 0D:9419: BD 10 06  LDA ram_plr_флаг_индекса_атаки,X ; 0611 
C - - - - - 0x03542C 0D:941C: D0 0E     BNE bra_942C
C - - - - - 0x03542E 0D:941E: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
...
tbl_9428:
; bzk bug? должно читаться через Y, как и все остальные случаи с JSR sub_0x03ECD2_генератор_рандома_для_Y_1?
...
bra_942C:
C - - - - - 0x03543C 0D:942C: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_943B:
loc_943B:
- - - - - - 0x03544B 0D:943B: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_026_9441_01:
C - - J - - 0x035451 0D:9441: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x03546E 0D:945E: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x035471 0D:9461: 90 D8     BCC bra_943B
C - - - - - 0x035473 0D:9463: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x035476 0D:9466: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
...
C - - - - - 0x035485 0D:9475: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
...
- - - - - - 0x03549B 0D:948B: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
- - - - - - 0x03549E 0D:948E: B0 06     BCS bra_9496    ; if далеко
; if достаточно близко
- - - - - - 0x0354A0 0D:9490: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x0354AC 0D:949C: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
...
C - - - - - 0x0354B7 0D:94A7: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
...
bra_94DC:
- - - - - - 0x0354EC 0D:94DC: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X
- - - - - - 0x0354EF 0D:94DF: B9 20 05  LDA ram_obj_state_hi,Y
...
ofs_026_94EC_03:
C - - J - - 0x0354FC 0D:94EC: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x0354FF 0D:94EF: B0 03     BCS bra_94F4
- - - - - - 0x035501 0D:94F1: 4C 3B 94  JMP loc_943B
bra_94F4:
C - - - - - 0x035504 0D:94F4: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x035507 0D:94F7: B0 06     BCS bra_94FF    ; if false
; if true
...
bra_9511:
C - - - - - 0x035521 0D:9511: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
C - - - - - 0x035524 0D:9514: B9 87 95  LDA tbl_9587_шаблоны_mike,Y
C - - - - - 0x035527 0D:9517: 60        RTS
bra_9518:
C - - - - - 0x035528 0D:9518: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_026_951E_02:
C - - J - - 0x03552E 0D:951E: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x035531 0D:9521: B0 03     BCS bra_9526
- - - - - - 0x035533 0D:9523: 4C 3B 94  JMP loc_943B
bra_9526:
C - - - - - 0x035536 0D:9526: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x035539 0D:9529: B0 06     BCS bra_9531    ; if false
; if true
C - - - - - 0x03553B 0D:952B: A5 12     LDA ram_0012
C - - - - - 0x03553D 0D:952D: C9 02     CMP #$02
C - - - - - 0x03553F 0D:952F: 90 E7     BCC bra_9518
bra_9531:
C - - - - - 0x035541 0D:9531: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
...
C - - - - - 0x03555A 0D:954A: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x03555D 0D:954D: B9 40 05  LDA ram_obj_state_lo,Y ; 0540 0541 
C - - - - - 0x035560 0D:9550: F0 1D     BEQ bra_956F
C - - - - - 0x035562 0D:9552: C9 01     CMP #$01
C - - - - - 0x035564 0D:9554: F0 1F     BEQ bra_9575
bra_9556:
C - - - - - 0x035566 0D:9556: 20 2F EE  JSR sub_0x03EE3F_проверка_запущенного_мяча_соперником
C - - - - - 0x035569 0D:9559: 90 0E     BCC bra_9569_true
C - - - - - 0x03556B 0D:955B: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
...
bra_9569_true:
- - - - - - 0x035579 0D:9569: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
- - - - - - 0x03557C 0D:956C: A9 3D     LDA #con_шаблон_ai_3D
- - - - - - 0x03557E 0D:956E: 60        RTS
bra_956F:
C - - - - - 0x03557F 0D:956F: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x035582 0D:9572: A9 22     LDA #con_шаблон_ai_22
C - - - - - 0x035584 0D:9574: 60        RTS
bra_9575:
loc_9575:
C D 0 - - - 0x035585 0D:9575: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x0355AD 0D:959D: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
ofs_025_95B4_00:
C - - J - - 0x0355C4 0D:95B4: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x0355C7 0D:95B7: B0 03     BCS bra_95BC
C - - - - - 0x0355C9 0D:95B9: 4C 53 97  JMP loc_9753
bra_95BC:
C - - - - - 0x0355CC 0D:95BC: BD 20 05  LDA ram_obj_state_hi,X ; 0521 
...
C - - - - - 0x0355E7 0D:95D7: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x0355EA 0D:95DA: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
...
- - - - - - 0x0355FC 0D:95EC: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
- - - - - - 0x0355FF 0D:95EF: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
- - - - - - 0x035602 0D:95F2: B9 58 98  LDA tbl_9858_шаблоны_casey,Y
- - - - - - 0x035605 0D:95F5: 60        RTS
bra_95F6:
C - - - - - 0x035606 0D:95F6: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x035609 0D:95F9: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 
...
C - - - - - 0x035618 0D:9608: BD 20 05  LDA ram_obj_state_hi,X ; 0521 
C - - - - - 0x03561B 0D:960B: C9 01     CMP #con_plr_state_в_прыжке
C - - - - - 0x03561D 0D:960D: D0 19     BNE bra_9628
C - - - - - 0x03561F 0D:960F: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
C - - - - - 0x035622 0D:9612: A9 50     LDA #$50
C - - - - - 0x035624 0D:9614: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
C - - - - - 0x035627 0D:9617: B0 0F     BCS bra_9628    ; if далеко
; if достаточно близко
C - - - - - 0x035629 0D:9619: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
C - - - - - 0x03562C 0D:961C: A9 30     LDA #$30
C - - - - - 0x03562E 0D:961E: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
...
bra_9628:
C - - - - - 0x035638 0D:9628: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
- - - - - - 0x035648 0D:9638: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X
- - - - - - 0x03564B 0D:963B: B9 40 05  LDA ram_obj_state_lo,Y
- - - - - - 0x03564E 0D:963E: F0 07     BEQ bra_9647
bra_9640:
C - - - - - 0x035650 0D:9640: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
C - - - - - 0x035653 0D:9643: B9 3C 98  LDA tbl_983C_шаблоны_casey,Y
C - - - - - 0x035656 0D:9646: 60        RTS
bra_9647:
- - - - - - 0x035657 0D:9647: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x035668 0D:9658: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_965E:
loc_965E:
C D 0 - - - 0x03566E 0D:965E: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x035671 0D:9661: BD 20 05  LDA ram_obj_state_hi,X ; 0521 
...
ofs_025_966F_01:
C - - J - - 0x03567F 0D:966F: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x035682 0D:9672: B0 03     BCS bra_9677
C - - - - - 0x035684 0D:9674: 4C 53 97  JMP loc_9753
bra_9677:
C - - - - - 0x035687 0D:9677: BD 10 04  LDA ram_obj_pos_Y_lo,X ; 0411 
C - - - - - 0x03568A 0D:967A: C9 80     CMP #$80
C - - - - - 0x03568C 0D:967C: 90 2A     BCC bra_96A8
C - - - - - 0x03568E 0D:967E: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x035691 0D:9681: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 
...
C - - - - - 0x0356AA 0D:969A: BD 20 05  LDA ram_obj_state_hi,X ; 0521 
...
bra_96A8:
C - - - - - 0x0356B8 0D:96A8: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
C - - - - - 0x0356BB 0D:96AB: A9 50     LDA #$50
C - - - - - 0x0356BD 0D:96AD: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
C - - - - - 0x0356C0 0D:96B0: B0 27     BCS bra_96D9    ; if далеко
; if достаточно близко
C - - - - - 0x0356C2 0D:96B2: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
C - - - - - 0x0356C5 0D:96B5: A9 30     LDA #$30
C - - - - - 0x0356C7 0D:96B7: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
...
C - - - - - 0x0356D5 0D:96C5: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x0356D8 0D:96C8: B0 09     BCS bra_96D3    ; if false
; if true
...
C - - - - - 0x0356EE 0D:96DE: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x0356FB 0D:96EB: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x0356FE 0D:96EE: B9 40 05  LDA ram_obj_state_lo,Y ; 0540 
C - - - - - 0x035701 0D:96F1: F0 37     BEQ bra_972A
bra_96F3:
C - - - - - 0x035703 0D:96F3: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x035706 0D:96F6: B9 60 04  LDA ram_obj_spd_Z_hi,Y ; 0460 
C - - - - - 0x035709 0D:96F9: 30 18     BMI bra_9713
C - - - - - 0x03570B 0D:96FB: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
C - - - - - 0x03570E 0D:96FE: A9 40     LDA #$40
C - - - - - 0x035710 0D:9700: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
...
C - - - - - 0x03572D 0D:971D: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
C - - - - - 0x035730 0D:9720: C9 38     CMP #$38
C - - - - - 0x035732 0D:9722: B0 24     BCS bra_9748
loc_9724:
C D 0 - - - 0x035734 0D:9724: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_9748:
C - - - - - 0x035758 0D:9748: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x03575B 0D:974B: B0 0D     BCS bra_975A
bra_974D:
- - - - - - 0x03575D 0D:974D: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
- - - - - - 0x035760 0D:9750: A9 16     LDA #con_шаблон_ai_16
- - - - - - 0x035762 0D:9752: 60        RTS
bra_9753:
loc_9753:
C - - - - - 0x035764 0D:9754: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x03577E 0D:976E: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
bra_9771:
...
ofs_025_977D_03:
C - - J - - 0x03578D 0D:977D: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x035798 0D:9788: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x03579B 0D:978B: B0 09     BCS bra_9796    ; if false
; if true
...
bra_9796:
C - - - - - 0x0357A6 0D:9796: BD E2 06  LDA ram_06E2_cpu,X ; 06E3 
...
ofs_025_97A6_02:
C - - J - - 0x0357B6 0D:97A6: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
C - - - - - 0x0357B9 0D:97A9: 90 BE     BCC bra_9769
C - - - - - 0x0357BB 0D:97AB: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x0357BE 0D:97AE: 90 9D     BCC bra_974D
C - - - - - 0x0357C0 0D:97B0: 20 5A ED  JSR sub_0x03ED6A
C - - - - - 0x0357C3 0D:97B3: 90 14     BCC bra_97C9
C - - - - - 0x0357C5 0D:97B5: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x0357C8 0D:97B8: A5 11     LDA ram_0011
C - - - - - 0x0357CA 0D:97BA: C9 08     CMP #$08
C - - - - - 0x0357CC 0D:97BC: D0 0B     BNE bra_97C9
C - - - - - 0x0357CE 0D:97BE: BD 10 06  LDA ram_plr_флаг_индекса_атаки,X ; 0611 
...
C - - - - - 0x0357ED 0D:97DD: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x0357F0 0D:97E0: B9 2E 01  LDA ram_012E_plr,Y ; 012E 
C - - - - - 0x0357F3 0D:97E3: D9 0C 06  CMP ram_plr_таймер_для_суперки,Y ; 060C 
C - - - - - 0x0357F6 0D:97E6: F0 3E     BEQ bra_9826
bra_97E8:
C - - - - - 0x0357F8 0D:97E8: B9 12 06  LDA ram_plr_индекс_атаки,Y ; 0612 
C - - - - - 0x0357FB 0D:97EB: C9 0D     CMP #con_0612_черепаха_деш_ногой
C - - - - - 0x0357FD 0D:97ED: F0 2A     BEQ bra_9819
C - - - - - 0x0357FF 0D:97EF: C9 0A     CMP #con_0612_черепаха_деш_локтем
C - - - - - 0x035801 0D:97F1: F0 26     BEQ bra_9819
C - - - - - 0x035803 0D:97F3: B9 26 06  LDA ram_0626_plr,Y ; 0626 
C - - - - - 0x035806 0D:97F6: C9 02     CMP #$02
C - - - - - 0x035808 0D:97F8: F0 2C     BEQ bra_9826
C - - - - - 0x03580A 0D:97FA: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 
C - - - - - 0x03580D 0D:97FD: D0 24     BNE bra_9823
C - - - - - 0x03580F 0D:97FF: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x035812 0D:9802: B0 0C     BCS bra_9810    ; if false
; if true
...
bra_9826:
loc_9826:
C D 0 - - - 0x035836 0D:9826: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
...
C - - - - - 0x03583E 0D:982E: F0 06     BEQ bra_9836_raph
                                    .else
                                        ...
                                        BEQ bra_9836_raph
                                    .endif
C - - - - - 0x035840 0D:9830: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x035843 0D:9833: A9 3A     LDA #con_шаблон_ai_3A
C - - - - - 0x035845 0D:9835: 60        RTS
bra_9836_raph:
; con_fighter_raph
; con_fighter___raph
C - - - - - 0x035846 0D:9836: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
C - - - - - 0x035872 0D:9862: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x03587D 0D:986D: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
ofs_024_9884_00:
C - - J - - 0x035894 0D:9884: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
C - - - - - 0x035897 0D:9887: C9 01     CMP #con_plr_state_в_прыжке
C - - - - - 0x035899 0D:9889: D0 07     BNE bra_9892
C - - - - - 0x03589B 0D:988B: BD 10 04  LDA ram_obj_pos_Y_lo,X ; 0411 
C - - - - - 0x03589E 0D:988E: C9 80     CMP #$80
C - - - - - 0x0358A0 0D:9890: 90 26     BCC bra_98B8
bra_9892:
C - - - - - 0x0358A2 0D:9892: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x0358A5 0D:9895: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
...
C - - - - - 0x0358B8 0D:98A8: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
bra_98B2:
C - - - - - 0x0358C2 0D:98B2: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x0358C5 0D:98B5: A9 10     LDA #con_шаблон_ai_10
C - - - - - 0x0358C7 0D:98B7: 60        RTS
bra_98B8:
C - - - - - 0x0358C8 0D:98B8: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x0358CB 0D:98BB: A9 2C     LDA #con_шаблон_ai_2C
C - - - - - 0x0358CD 0D:98BD: 60        RTS
bra_98BE:
C - - - - - 0x0358CE 0D:98BE: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x0358D1 0D:98C1: A9 32     LDA #con_шаблон_ai_32
C - - - - - 0x0358D3 0D:98C3: 60        RTS
bra_98C4:
C - - - - - 0x0358D4 0D:98C4: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_98D0:
C - - - - - 0x0358E0 0D:98D0: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_98D6:
loc_98D6:
C D 0 - - - 0x0358E6 0D:98D6: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_024_98E8_01:
C - - J - - 0x0358F8 0D:98E8: BD 10 04  LDA ram_obj_pos_Y_lo,X ; 0410 0411 
C - - - - - 0x0358FB 0D:98EB: C9 70     CMP #$70
C - - - - - 0x0358FD 0D:98ED: 90 07     BCC bra_98F6
C - - - - - 0x0358FF 0D:98EF: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
...
bra_990D:
C - - - - - 0x03591D 0D:990D: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_9913:
C - - - - - 0x035923 0D:9913: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x035926 0D:9916: B0 06     BCS bra_991E
bra_9918:
C - - - - - 0x035928 0D:9918: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_9933:
- - - - - - 0x035943 0D:9933: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
- - - - - - 0x035946 0D:9936: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
...
ofs_024_993D_03:
C - - J - - 0x03594D 0D:993D: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x035950 0D:9940: 90 D6     BCC bra_9918
C - - - - - 0x035952 0D:9942: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x035955 0D:9945: B0 09     BCS bra_9950    ; if false
; if true
...
bra_9950:
C - - - - - 0x035960 0D:9950: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x035973 0D:9963: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
...
C - - - - - 0x035988 0D:9978: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
C - - - - - 0x03598B 0D:997B: F0 03     BEQ bra_9980
C - - - - - 0x03598D 0D:997D: 4C AD 99  JMP loc_99AD
bra_9980:
C - - - - - 0x035990 0D:9980: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x035993 0D:9983: 90 93     BCC bra_9918
C - - - - - 0x035995 0D:9985: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x035998 0D:9988: B0 29     BCS bra_99B3    ; if false
; if true
...
C - - - - - 0x0359AC 0D:999C: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
C - - - - - 0x0359AF 0D:999F: B0 12     BCS bra_99B3    ; if далеко
; if достаточно близко
C - - - - - 0x0359B1 0D:99A1: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
loc_99A7:
C D 0 - - - 0x0359B7 0D:99A7: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
loc_99AD:
C D 0 - - - 0x0359BD 0D:99AD: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_99B3:
C - - - - - 0x0359C3 0D:99B3: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
...
ofs_035_99CA_0D:
C - - J - - 0x0359DA 0D:99CA: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x0359DD 0D:99CD: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 
...
C - - - - - 0x0359E8 0D:99D8: B9 12 06  LDA ram_plr_индекс_атаки,Y ; 0612 
C - - - - - 0x0359EB 0D:99DB: C9 0D     CMP #con_0612_черепаха_деш_ногой
C - - - - - 0x0359ED 0D:99DD: D0 03     BNE bra_99E2
C - - - - - 0x0359EF 0D:99DF: 4C E2 9A  JMP loc_9AE2
bra_99E2:
C - - - - - 0x0359F2 0D:99E2: C9 0A     CMP #con_0612_черепаха_деш_локтем
...
ofs_023_99F6_00:
C - - J - - 0x035A06 0D:99F6: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x035A2E 0D:9A1E: BD 20 05  LDA ram_obj_state_hi,X ; 0521 
...
bra_9A3C:
C - - - - - 0x035A4C 0D:9A3C: 20 C6 ED  JSR sub_0x03EDD6_генератор_рандома_по_сложности_игры_1
...
C - - - - - 0x035A5A 0D:9A4A: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x035A5D 0D:9A4D: A9 12     LDA #con_шаблон_ai_12
bra_9A4F_RTS:
C - - - - - 0x035A5F 0D:9A4F: 60        RTS
bra_9A50:
- - - - - - 0x035A60 0D:9A50: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
loc_9A59:
C D 0 - - - 0x035A69 0D:9A59: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
C - - - - - 0x035A6C 0D:9A5C: C9 60     CMP #$60
C - - - - - 0x035A6E 0D:9A5E: B0 03     BCS bra_9A63
C - - - - - 0x035A70 0D:9A60: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
bra_9A63:
...
bra_9A66:
C - - - - - 0x035A76 0D:9A66: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x035A79 0D:9A69: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
...
bra_9A70:
C - - - - - 0x035A80 0D:9A70: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
bra_9A82:
loc_9A82:
C D 0 - - - 0x035A92 0D:9A82: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_023_9A88_01:
C - - J - - 0x035A98 0D:9A88: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
bra_9AA8:
C - - - - - 0x035AB8 0D:9AA8: B9 10 04  LDA ram_obj_pos_Y_lo,Y ; 0410 
C - - - - - 0x035ABB 0D:9AAB: C9 98     CMP #$98
C - - - - - 0x035ABD 0D:9AAD: B0 03     BCS bra_9AB2
C - - - - - 0x035ABF 0D:9AAF: 4C 59 9A  JMP loc_9A59
bra_9AB2:
loc_9AB2:
C D 0 - - - 0x035AC2 0D:9AB2: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 
C - - - - - 0x035AC5 0D:9AB5: D0 B9     BNE bra_9A70
C - - - - - 0x035AC7 0D:9AB7: BD 20 05  LDA ram_obj_state_hi,X ; 0521 
...
C - - - - - 0x035AD8 0D:9AC8: 20 14 EE  JSR sub_0x03EE24_проверка_доступности_мяча_для_подбора
C - - - - - 0x035ADB 0D:9ACB: B0 03     BCS bra_9AD0    ; if false
; if true
...
bra_9AE5:
C - - - - - 0x035AF5 0D:9AE5: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
...
C - - - - - 0x035B04 0D:9AF4: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
C - - - - - 0x035B07 0D:9AF7: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
...
bra_9B12:
C - - - - - 0x035B22 0D:9B12: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x035B25 0D:9B15: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
...
ofs_023_9B2B_03:
C - - J - - 0x035B3B 0D:9B2B: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
C - - - - - 0x035B50 0D:9B40: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x035B60 0D:9B50: B0 57     BCS bra_9BA9    ; if false
; if true
...
bra_9B5B:
loc_9B5B:
C D 0 - - - 0x035B6B 0D:9B5B: 20 96 ED  JSR sub_0x03EDA6_очистка_адресов_cpu_при_необходимости
...
ofs_023_9B61_02:
C - - J - - 0x035B71 0D:9B61: 20 2C ED  JSR sub_0x03ED3C_генератор_рандома_с_учетом_запущенного_мяча
...
bra_9B7E:
C - - - - - 0x035B8E 0D:9B7E: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x035B91 0D:9B81: B9 60 04  LDA ram_obj_spd_Z_hi,Y ; 0460 
...
bra_9BB4:
C - - - - - 0x035BC4 0D:9BB4: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x035BC7 0D:9BB7: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
...
sub_9BD6:
C - - - - - 0x035BE6 0D:9BD6: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
...
C - - - - - 0x035BF6 0D:9BE6: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
C - - - - - 0x035BF9 0D:9BE9: C9 07     CMP #con_plr_state_сидит
C - - - - - 0x035BFB 0D:9BEB: D0 09     BNE bra_9BF6
C - - - - - 0x035BFD 0D:9BED: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
...
bra_9BF6:
C - - - - - 0x035C06 0D:9BF6: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x035C09 0D:9BF9: B9 10 06  LDA ram_plr_флаг_индекса_атаки,Y ; 0610 0611 
C - - - - - 0x035C0C 0D:9BFC: F0 0B     BEQ bra_9C09
C - - - - - 0x035C0E 0D:9BFE: B9 12 06  LDA ram_plr_индекс_атаки,Y ; 0612 0613 
C - - - - - 0x035C11 0D:9C01: C9 0D     CMP #con_0612_черепаха_деш_ногой
...
C - - - - - 0x035C19 0D:9C09: A9 00     LDA #$00    ; con_шаблон_ai_00
...
C - - - - - 0x035C28 0D:9C18: F0 01     BEQ bra_9C1B_шаблон_не_выбран
C - - - - - 0x035C2A 0D:9C1A: 60        RTS
bra_9C1B_шаблон_не_выбран:
C - - - - - 0x035C2B 0D:9C1B: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x035C2E 0D:9C1E: B9 50 05  LDA ram_obj_id,Y ; 0550 0551 
C - - - - - 0x035C31 0D:9C21: 20 32 D0  JSR sub_0x03D042_поинтеры_после_JSR
- - - - - - 0x035C34 0D:9C24: 32 9C     .word ofs_022_9C32_00_leo_vs_leo   ; con_fighter_leo
- D 0 - I - 0x035C36 0D:9C26: 75 9C     .word ofs_022_9C75_01_leo_vs_raph   ; con_fighter_raph
- D 0 - I - 0x035C38 0D:9C28: B2 9C     .word _общий_RTS ; 02   ; con_fighter_mike
- - - - - - 0x035C3A 0D:9C2A: B3 9C     .word ofs_022_9CB3_03_leo_vs_don   ; con_fighter_don
- - - - - - 0x035C3C 0D:9C2C: C4 9C     .word _общий_RTS ; 04   ; con_fighter_casey
- - - - - - 0x035C3E 0D:9C2E: C5 9C     .word ofs_022_9CC5_05_leo_vs_hot   ; con_fighter_hot
- - - - - - 0x035C40 0D:9C30: D0 9C     .word ofs_022_9CD0_06_leo_vs_shred   ; con_fighter_shred
                                    .if con_новые_персы <> $00
                                        .word ofs_022_9C32_07   ; con_fighter___leo
                                        .word ofs_022_9C75_08   ; con_fighter___raph
                                        .word _общий_RTS ; 09   ; con_fighter___mike
                                        .word ofs_022_9CB3_0A   ; con_fighter___don
                                        .word _общий_RTS ; 0B   ; con_fighter___casey
                                        .word ofs_022_9CC5_0C   ; con_fighter___hot
                                        .word ofs_022_9CD0_0D   ; con_fighter___shred
                                    .endif



loc_9C32:
ofs_019_9C32_00_don_vs_leo:
ofs_021_9C32_00_raph_vs_leo:
ofs_022_9C32_00_leo_vs_leo:
ofs_019_9C32_07:
ofs_021_9C32_07:
ofs_022_9C32_07:
...
C - - - - - 0x035C92 0D:9C82: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
...
- D 0 - - - 0x035CC1 0D:9CB1: 10        .byte $10   ; 06 con_fighter_shred
                                    .if con_новые_персы <> $00
                                        .byte $30   ; 07 con_fighter___leo
                                        .byte $30   ; 08 con_fighter___raph
                                        .byte $40   ; 09 con_fighter___mike
                                        .byte $40   ; 0A con_fighter___don
                                        .byte $18   ; 0B con_fighter___casey
...
ofs_016_9CB3_03_shred_vs_don:
ofs_016_9CB3_0A:
ofs_017_9CB3_03_hot_vs_don:
ofs_017_9CB3_0A:
ofs_018_9CB3_03_casey_vs_don:
ofs_018_9CB3_0A:
ofs_019_9CB3_03_don_vs_don:
ofs_019_9CB3_0A:
ofs_020_9CB3_03_mike_vs_don:
ofs_020_9CB3_0A:
ofs_021_9CB3_03_raph_vs_don:
ofs_021_9CB3_0A:
ofs_022_9CB3_03_leo_vs_don:
ofs_022_9CB3_0A:
...
- - - - - - 0x035CF0 0D:9CE0: 20 CD EC  JSR sub_0x03ECDD_генератор_рандома_для_Y_2
...
C - - - - - 0x035D0D 0D:9CFD: F0 01     BEQ bra_9D00_шаблон_не_выбран
C - - - - - 0x035D0F 0D:9CFF: 60        RTS
bra_9D00_шаблон_не_выбран:
C - - - - - 0x035D10 0D:9D00: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x035D13 0D:9D03: B9 50 05  LDA ram_obj_id,Y ; 0550 0551 
C - - - - - 0x035D16 0D:9D06: 20 32 D0  JSR sub_0x03D042_поинтеры_после_JSR
- D 0 - I - 0x035D19 0D:9D09: 32 9C     .word ofs_021_9C32_00_raph_vs_leo   ; con_fighter_leo
- - - - - - 0x035D1B 0D:9D0B: 75 9C     .word ofs_021_9C75_01_raph_vs_raph   ; con_fighter_raph
- D 0 - I - 0x035D1D 0D:9D0D: 17 9D     .word _общий_RTS ; 02   ; con_fighter_mike
- - - - - - 0x035D1F 0D:9D0F: B3 9C     .word ofs_021_9CB3_03_raph_vs_don   ; con_fighter_don
...
- - - - - - 0x035D25 0D:9D15: 1B 9D     .word _общий_RTS ; 06   ; con_fighter_shred
                                    .if con_новые_персы <> $00
                                        .word ofs_021_9C32_07   ; con_fighter___leo
                                        .word ofs_021_9C75_08   ; con_fighter___raph
                                        .word _общий_RTS ; 09   ; con_fighter___mike
                                        .word ofs_021_9CB3_0A   ; con_fighter___don
                                        .word _общий_RTS ; 0B   ; con_fighter___casey
                                        .word _общий_RTS ; 0C   ; con_fighter___hot
                                        .word _общий_RTS ; 0D   ; con_fighter___shred
                                    .endif
...
C - - - - - 0x035D33 0D:9D23: F0 01     BEQ bra_9D26_шаблон_не_выбран
C - - - - - 0x035D35 0D:9D25: 60        RTS
bra_9D26_шаблон_не_выбран:
C - - - - - 0x035D36 0D:9D26: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x035D39 0D:9D29: B9 50 05  LDA ram_obj_id,Y ; 0550 0551 
C - - - - - 0x035D3C 0D:9D2C: 20 32 D0  JSR sub_0x03D042_поинтеры_после_JSR
- D 0 - I - 0x035D3F 0D:9D2F: 3D 9D     .word ofs_020_9D3D_00_mike_vs_leo   ; con_fighter_leo
- D 0 - I - 0x035D41 0D:9D31: 75 9C     .word ofs_020_9C75_01_mike_vs_raph   ; con_fighter_raph
- - - - - - 0x035D43 0D:9D33: 5F 9D     .word _общий_RTS ; 02   ; con_fighter_mike
- D 0 - I - 0x035D45 0D:9D35: B3 9C     .word ofs_020_9CB3_03_mike_vs_don   ; con_fighter_don
...
- - - - - - 0x035D4B 0D:9D3B: 63 9D     .word _общий_RTS ; 06   ; con_fighter_shred
                                    .if con_новые_персы <> $00
                                        .word ofs_020_9D3D_07   ; con_fighter___leo
                                        .word ofs_020_9C75_08   ; con_fighter___raph
                                        .word _общий_RTS ; 09   ; con_fighter___mike
                                        .word ofs_020_9CB3_0A   ; con_fighter___don
                                        .word _общий_RTS ; 0B   ; con_fighter___casey
                                        .word _общий_RTS ; 0C   ; con_fighter___hot
                                        .word _общий_RTS ; 0D   ; con_fighter___shred
                                    .endif
...
C - - - - - 0x035D7B 0D:9D6B: F0 01     BEQ bra_9D6E_шаблон_не_выбран
C - - - - - 0x035D7D 0D:9D6D: 60        RTS
bra_9D6E_шаблон_не_выбран:
C - - - - - 0x035D7E 0D:9D6E: BD 20 05  LDA ram_obj_state_hi,X ; 0521 
C - - - - - 0x035D81 0D:9D71: C9 01     CMP #con_plr_state_в_прыжке
C - - - - - 0x035D83 0D:9D73: D0 1E     BNE bra_9D93
C - - - - - 0x035D85 0D:9D75: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
C - - - - - 0x035D88 0D:9D78: B0 19     BCS bra_9D93
- - - - - - 0x035D8A 0D:9D7A: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
- - - - - - 0x035D8D 0D:9D7D: C9 30     CMP #$30
- - - - - - 0x035D8F 0D:9D7F: 90 12     BCC bra_9D93
- - - - - - 0x035D91 0D:9D81: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X
- - - - - - 0x035D94 0D:9D84: 20 A9 EE  JSR sub_0x03EEB9_вычислить_разницу_pos_Y_персов
- - - - - - 0x035D97 0D:9D87: A9 20     LDA #$20
- - - - - - 0x035D99 0D:9D89: 20 3E EE  JSR sub_0x03EE4E_проверка_близости_объектов_с_областью_A
- - - - - - 0x035D9C 0D:9D8C: B0 05     BCS bra_9D93    ; if далеко
; if достаточно близко
- - - - - - 0x035D9E 0D:9D8E: A9 16     LDA #con_шаблон_ai_16
- - - - - - 0x035DA0 0D:9D90: 85 17     STA ram_0017
- - - - - - 0x035DA2 0D:9D92: 60        RTS
bra_9D93:
C - - - - - 0x035DA3 0D:9D93: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF
C - - - - - 0x035DA6 0D:9D96: B9 50 05  LDA ram_obj_id,Y ; 0550 
C - - - - - 0x035DA9 0D:9D99: 20 32 D0  JSR sub_0x03D042_поинтеры_после_JSR
- D 0 - I - 0x035DAC 0D:9D9C: 32 9C     .word ofs_019_9C32_00_don_vs_leo   ; con_fighter_leo
- - - - - - 0x035DAE 0D:9D9E: 75 9C     .word ofs_019_9C75_01_don_vs_raph   ; con_fighter_raph
- D 0 - I - 0x035DB0 0D:9DA0: AA 9D     .word _общий_RTS ; 02   ; con_fighter_mike
- - - - - - 0x035DB2 0D:9DA2: B3 9C     .word ofs_019_9CB3_03_don_vs_don   ; con_fighter_don
...
- - - - - - 0x035DB8 0D:9DA8: AE 9D     .word _общий_RTS ; 06   ; con_fighter_shred
                                    .if con_новые_персы <> $00
                                        .word ofs_019_9C32_07   ; con_fighter___leo
                                        .word ofs_019_9C75_08   ; con_fighter___raph
                                        .word _общий_RTS ; 09   ; con_fighter___mike
                                        .word ofs_019_9CB3_0A   ; con_fighter___don
                                        .word _общий_RTS ; 0B   ; con_fighter___casey
                                        .word _общий_RTS ; 0C   ; con_fighter___hot
                                        .word _общий_RTS ; 0D   ; con_fighter___shred
                                    .endif
...
C - - - - - 0x035DC6 0D:9DB6: F0 01     BEQ bra_9DB9_шаблон_не_выбран
C - - - - - 0x035DC8 0D:9DB8: 60        RTS
bra_9DB9_шаблон_не_выбран:
C - - - - - 0x035DC9 0D:9DB9: A5 13     LDA ram_0013
C - - - - - 0x035DCB 0D:9DBB: C9 02     CMP #$02
C - - - - - 0x035DCD 0D:9DBD: D0 19     BNE bra_9DD8
C - - - - - 0x035DCF 0D:9DBF: 20 C6 ED  JSR sub_0x03EDD6_генератор_рандома_по_сложности_игры_1
...
bra_9DD8:
C - - - - - 0x035DE8 0D:9DD8: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF
C - - - - - 0x035DEB 0D:9DDB: B9 50 05  LDA ram_obj_id,Y ; 0550 
C - - - - - 0x035DEE 0D:9DDE: 20 32 D0  JSR sub_0x03D042_поинтеры_после_JSR
- - - - - - 0x035DF1 0D:9DE1: EF 9D     .word ofs_018_9DEF_00_casey_vs_leo   ; con_fighter_leo
- D 0 - I - 0x035DF3 0D:9DE3: 36 9E     .word ofs_018_9E36_01_casey_vs_raph   ; con_fighter_raph
- - - - - - 0x035DF5 0D:9DE5: 7F 9E     .word ofs_018_9E7F_02_casey_vs_mike   ; con_fighter_mike
- D 0 - I - 0x035DF7 0D:9DE7: B3 9C     .word ofs_018_9CB3_03_casey_vs_don   ; con_fighter_don
- - - - - - 0x035DF9 0D:9DE9: B1 9E     .word _общий_RTS ; 04   ; con_fighter_casey
- - - - - - 0x035DFB 0D:9DEB: B2 9E     .word ofs_018_9EB2_05_casey_vs_hot   ; con_fighter_hot
- - - - - - 0x035DFD 0D:9DED: E3 9E     .word _общий_RTS ; 06   ; con_fighter_shred
                                    .if con_новые_персы <> $00
                                        .word ofs_018_9DEF_07   ; con_fighter___leo
                                        .word ofs_018_9E36_08   ; con_fighter___raph
                                        .word ofs_018_9E7F_09   ; con_fighter___mike
                                        .word ofs_018_9CB3_0A   ; con_fighter___don
                                        .word _общий_RTS ; 0B   ; con_fighter___casey
                                        .word ofs_018_9EB2_0C   ; con_fighter___hot
                                        .word _общий_RTS ; 0D   ; con_fighter___shred
                                    .endif



ofs_018_9DEF_00_casey_vs_leo:
ofs_018_9DEF_07:
- - - - - - 0x035DFF 0D:9DEF: BD 20 05  LDA ram_obj_state_hi,X
- - - - - - 0x035E02 0D:9DF2: C9 08     CMP #con_plr_state_делает_суперку
- - - - - - 0x035E04 0D:9DF4: F0 07     BEQ bra_9DFD
- - - - - - 0x035E06 0D:9DF6: BD 20 05  LDA ram_obj_state_hi,X
...
bra_9E0D:
- - - - - - 0x035E1D 0D:9E0D: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X
...
bra_9EC3:
- - - - - - 0x035ED3 0D:9EC3: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
C - - - - - 0x035F03 0D:9EF3: BD 10 04  LDA ram_obj_pos_Y_lo,X ; 0411 
...
C - - - - - 0x035F12 0D:9F02: F0 01     BEQ bra_9F05_шаблон_не_выбран
C - - - - - 0x035F14 0D:9F04: 60        RTS
bra_9F05_шаблон_не_выбран:
C - - - - - 0x035F15 0D:9F05: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x035F18 0D:9F08: B9 50 05  LDA ram_obj_id,Y ; 0550 0551 
C - - - - - 0x035F1B 0D:9F0B: 20 32 D0  JSR sub_0x03D042_поинтеры_после_JSR
- - - - - - 0x035F1E 0D:9F0E: 1C 9F     .word ofs_017_9F1C_00_hot_vs_leo   ; con_fighter_leo
- - - - - - 0x035F20 0D:9F10: 68 9F     .word ofs_017_9F68_01_hot_vs_raph   ; con_fighter_raph
- - - - - - 0x035F22 0D:9F12: 84 A0     .word ofs_017_A084_02_hot_vs_mike   ; con_fighter_mike
- D 0 - I - 0x035F24 0D:9F14: B3 9C     .word ofs_017_9CB3_03_hot_vs_don   ; con_fighter_don
- D 0 - I - 0x035F26 0D:9F16: 15 A1     .word ofs_017_A115_04_hot_vs_casey   ; con_fighter_casey
- - - - - - 0x035F28 0D:9F18: 9D 9F     .word _общий_RTS ; 05   ; con_fighter_hot
- D 0 - I - 0x035F2A 0D:9F1A: 9E 9F     .word ofs_017_9F9E_06_hot_vs_shred   ; con_fighter_shred
                                    .if con_новые_персы <> $00
                                        .word ofs_017_9F1C_07   ; con_fighter___leo
                                        .word ofs_017_9F68_08   ; con_fighter___raph
                                        .word ofs_017_A084_09   ; con_fighter___mike
                                        .word ofs_017_9CB3_0A   ; con_fighter___don
                                        .word ofs_017_A115_0B   ; con_fighter___casey
                                        .word _общий_RTS ; 0C   ; con_fighter___hot
                                        .word ofs_017_9F9E_0D   ; con_fighter___shred
                                    .endif



ofs_017_9F1C_00_hot_vs_leo:
ofs_017_9F1C_07:
- - - - - - 0x035F2C 0D:9F1C: BD 20 05  LDA ram_obj_state_hi,X
...
- - - - - - 0x035F42 0D:9F32: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X
...
ofs_036_9FAF_0D:
C - - - - - 0x035FC3 0D:9FB3: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
...
C - - - - - 0x035FD3 0D:9FC3: B9 12 06  LDA ram_plr_индекс_атаки,Y ; 0612 
C - - - - - 0x035FD6 0D:9FC6: C9 0D     CMP #con_0612_черепаха_деш_ногой
C - - - - - 0x035FD8 0D:9FC8: D0 03     BNE bra_9FCD
C - - - - - 0x035FDA 0D:9FCA: 4C F7 A0  JMP loc_A760
bra_9FCD:
C - - - - - 0x035FDD 0D:9FCD: C9 0A     CMP #con_0612_черепаха_деш_локтем
...
C - - - - - 0x035FEA 0D:9FDA: BD E2 06  LDA ram_06E2_cpu,X ; 06E3 
...
C - - - - - 0x035FFC 0D:9FEC: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
...
bra_9FF9:
C - - - - - 0x036009 0D:9FF9: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x03600C 0D:9FFC: B9 50 05  LDA ram_obj_id,Y ; 0550
C - - - - - 0x03600F 0D:9FFF: 20 32 D0  JSR sub_0x03D042_поинтеры_после_JSR
- - - - - - 0x036012 0D:A002: 10 A0     .word ofs_016_A010_00_shred_vs_leo   ; con_fighter_leo
- D 1 - I - 0x036014 0D:A004: 46 A0     .word ofs_016_A046_01_shred_vs_raph   ; con_fighter_raph
- - - - - - 0x036016 0D:A006: 84 A0     .word ofs_016_A084_02_shred_vs_mike   ; con_fighter_mike
- D 1 - I - 0x036018 0D:A008: B3 9C     .word ofs_016_9CB3_03_shred_vs_don   ; con_fighter_don
- - - - - - 0x03601A 0D:A00A: 15 A1     .word ofs_016_A115_04_shred_vs_casey   ; con_fighter_casey
- D 1 - I - 0x03601C 0D:A00C: 30 A1     .word ofs_016_A130_05_shred_vs_hot   ; con_fighter_hot
- - - - - - 0x03601E 0D:A00E: 67 A1     .word ofs_016_A167_06_shred_vs_shred   ; con_fighter_shred
                                    .if con_новые_персы <> $00
                                        .word ofs_016_A010_07   ; con_fighter___leo
                                        .word ofs_016_A046_08   ; con_fighter___raph
                                        .word ofs_016_A084_09   ; con_fighter___mike
                                        .word ofs_016_9CB3_0A   ; con_fighter___don
                                        .word ofs_016_A115_0B   ; con_fighter___casey
                                        .word ofs_016_A130_0C   ; con_fighter___hot
                                        .word ofs_016_A167_0D   ; con_fighter___shred
                                    .endif
...
bra_A072:
loc_A072:
- - - - - - 0x036082 0D:A072: 20 FE ED  JSR sub_0x03EE0E_проверка_наличия_мяча_у_игрока_X
...
ofs_016_A084_02_shred_vs_mike:
ofs_016_A084_09:
ofs_017_A084_02_hot_vs_mike:
ofs_017_A084_09:
...
- - - - - - 0x0360A5 0D:A095: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X
- - - - - - 0x0360A8 0D:A098: B9 60 04  LDA ram_obj_spd_Z_hi,Y
- - - - - - 0x0360AB 0D:A09B: 30 F1     BMI bra_A08E_RTS
- - - - - - 0x0360AD 0D:A09D: B9 10 04  LDA ram_obj_pos_Y_lo,Y
...
ofs_016_A115_04_shred_vs_casey:
ofs_016_A115_0B:
ofs_017_A115_04_hot_vs_casey:
ofs_017_A115_0B:
C - - J - - 0x036125 0D:A115: A5 11     LDA ram_0011
C - - - - - 0x036127 0D:A117: C9 08     CMP #$08
C - - - - - 0x036129 0D:A119: D0 14     BNE bra_A12F_RTS
C - - - - - 0x03612B 0D:A11B: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x03612E 0D:A11E: B9 E2 06  LDA ram_06E2_cpu,Y ; 06E2 
...
ofs_016_A130_05_shred_vs_hot:
ofs_016_A130_0C:
C - - J - - 0x036140 0D:A130: A5 11     LDA ram_0011
C - - - - - 0x036142 0D:A132: C9 08     CMP #$08
C - - - - - 0x036144 0D:A134: D0 2B     BNE bra_A161_RTS
C - - - - - 0x036146 0D:A136: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DF 
C - - - - - 0x036149 0D:A139: B9 40 05  LDA ram_obj_state_lo,Y ; 0540 
...
- - - - - - 0x03615E 0D:A14E: BD 20 05  LDA ram_obj_state_hi,X
- - - - - - 0x036161 0D:A151: C9 03     CMP #con_plr_state_получает_урон
- - - - - - 0x036163 0D:A153: F0 0C     BEQ bra_A161_RTS
- - - - - - 0x036165 0D:A155: 20 D8 ED  JSR sub_0x03EDE8_генератор_рандома_по_сложности_игры_2
...
ofs_016_A167_06_shred_vs_shred:
ofs_016_A167_0D:
...
C - - - - - 0x0361C3 0D:A1B3: BD 10 05  LDA ram_obj_flip,X ; 0510 0511 
...
loc_A1BF:
C - - - - - 0x0361D2 0D:A1C2: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
...
C - - - - - 0x0361F0 0D:A1E0: 19 64 05  ORA ram_0564,Y ; 0564 0565 
C - - - - - 0x0361F3 0D:A1E3: 19 80 05  ORA ram_0580_obj,Y ; 0580 0581 
C - - - - - 0x0361F6 0D:A1E6: D0 09     BNE bra_A1F1_RTS
C - - - - - 0x0361F8 0D:A1E8: 20 AD A1  JSR sub_A1AD_проверка_за_спиной_ли_перс
...
bra_A1FC:
C - - - - - 0x03620C 0D:A1FC: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x03620F 0D:A1FF: BD 54 05  LDA ram_obj_id + $04,X ; 0554 0555 
...
- - - - - - 0x03621B 0D:A20B: B9 20 05  LDA ram_obj_state_hi,Y
...
C - - - - - 0x036235 0D:A225: BD 50 05  LDA ram_obj_id,X ; 0550 0551 
                                    .if con_новые_персы = $00
C - - - - - 0x036238 0D:A228: C9 06     CMP #con_fighter_shred
                                        BEQ bra_A226_shred
...
- - - - - - 0x036241 0D:A231: B9 20 05  LDA ram_obj_state_hi,Y
...
- - - - - - 0x036255 0D:A245: B9 40 05  LDA ram_obj_state_lo,Y
...
- - - - - - 0x03626C 0D:A25C: C9 A5     CMP #con_0612_shred_рука_дальняя + $80
- - - - - - 0x03626E 0D:A25E: D0 07     BNE bra_A267
- - - - - - 0x036270 0D:A260: B9 54 05  LDA ram_obj_id + $04,Y
...
- - - - - - 0x036288 0D:A278: BD 00 06  LDA ram_0600_plr,X
...
C - - - - - 0x0362AC 0D:A29C: BD 60 04  LDA ram_obj_spd_Z_hi,X ; 0460 
C - - - - - 0x0362AF 0D:A29F: 10 E4     BPL bra_A285
bra_A2A1:
loc_A2A1:
C - - - - - 0x0362B1 0D:A2A1: BC 20 05  LDY ram_obj_state_hi,X ; 0520 0521 
C - - - - - 0x0362B4 0D:A2A4: C0 0A     CPY #$0A
C - - - - - 0x0362B6 0D:A2A6: F0 26     BEQ bra_A2CE_выход_ai_из_песка_нокдауна_и_кусания
...
C - - - - - 0x0362C0 0D:A2B0: BD C0 04  LDA ram_obj_hit_state,X ; 04C0 04C1 
...
bra_A2C3:
C - - - - - 0x0362D3 0D:A2C3: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x0362D6 0D:A2C6: A9 01     LDA #con_шаблон_ai_01
C - - - - - 0x0362D8 0D:A2C8: 9D C0 06  STA ram_cpu_шаблон_ai,X
C - - - - - 0x0362DB 0D:A2CB: 20 7C A3  JSR sub_A374
bra_A2CE_выход_ai_из_песка_нокдауна_и_кусания:
C - - - - - 0x0362DE 0D:A2CE: BD 50 05  LDA ram_obj_id,X ; 0550 0551 
                                    .if con_новые_персы = $00
C - - - - - 0x0362E1 0D:A2D1: 49 06     EOR #con_fighter_shred
...
C - - - - - 0x036303 0D:A2F3: 19 80 05  ORA ram_0580_obj,Y ; 0580 0581 
C - - - - - 0x036306 0D:A2F6: D0 51     BNE bra_A349
C - - - - - 0x036308 0D:A2F8: 20 AD A1  JSR sub_A1AD_проверка_за_спиной_ли_перс
C - - - - - 0x03630B 0D:A2FB: D0 4C     BNE bra_A349
C - - - - - 0x03630D 0D:A2FD: BD 20 05  LDA ram_obj_state_hi,X ; 0520 0521 
C - - - - - 0x036310 0D:A300: F0 14     BEQ bra_A316_ограничение_ai_броска    ; if con_plr_state_на_земле
...
C - - - - - 0x036326 0D:A316: BD 50 05  LDA ram_флаг_черепахи,X ; 0550 0551 
C - - - - - 0x036329 0D:A319: 49 06     CMP #$40
C - - - - - 0x03632B 0D:A31B: F0 09     BEQ bra_A326_не_черепаха
; C = 0
; con_fighter_leo
; con_fighter_raph
; con_fighter_mike
...
; con_fighter_shred
; con_fighter___shred
- - - - - - 0x036352 0D:A342: BD 10 04  LDA ram_obj_pos_Y_lo,X
...
C - - - - - 0x036366 0D:A356: B9 54 05  LDA ram_obj_id + $04,Y
...
C - - - - - 0x0363CF 0D:A3BF: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X ; 06DE 06DF 
C - - - - - 0x0363D2 0D:A3C2: 20 42 BF  JSR sub_BF42_проверка_на_запущенный_мяч
...
- - - - - - 0x0363EC 0D:A3DC: DD 10 05  CMP ram_obj_flip,X
- - - - - - 0x0363EF 0D:A3DF: D0 27     BNE bra_A408
- - - - - - 0x0363F1 0D:A3E1: F0 2E     BEQ bra_A411   ; jmp
bra_A3E3:
C - - - - - 0x0363F3 0D:A3E3: B9 54 05  LDA ram_obj_id + $04,Y
...
C - - - - - 0x036409 0D:A3F9: BD C0 04  LDA ram_obj_hit_state,X ; 04C0 04C1 
...
- - - - - - 0x03648C 0D:A47C: B9 50 05  LDA ram_obj_id,Y ; 0551
                                    .if con_новые_персы = $00
- - - - - - 0x03648F 0D:A47F: C9 01     CMP #con_fighter_raph
...
sub_A4B4:
- - - - - - 0x0364C4 0D:A4B4: BD E6 06  LDA ram_06E6_cpu,X
- - - - - - 0x0364C7 0D:A4B7: C9 24     CMP #con_шаблон_ai_24
- - - - - - 0x0364C9 0D:A4B9: D0 58     BNE bra_A513
- - - - - - 0x0364CB 0D:A4BB: BD 20 05  LDA ram_obj_state_hi,X
...
- - - - - - 0x0364E1 0D:A4D1: 9D D2 06  STA ram_06D2_cpu_script,X
bra_A4D4:
...
bra_A504:
- - - - - - 0x036514 0D:A504: 7D 10 05  ADC ram_obj_flip,X
...
; con_fighter_raph
; con_fighter___raph
- - - - - - 0x03652A 0D:A51A: BD F0 05  LDA ram_05F0_obj,X
- - - - - - 0x03652D 0D:A51D: C9 16     CMP #$16
- - - - - - 0x03652F 0D:A51F: D0 25     BNE bra_A546
- - - - - - 0x036531 0D:A521: BD C0 04  LDA ram_obj_hit_state,X
...
; if персы достаточно близко друг к другу
- - - - - - 0x03654E 0D:A53E: 20 9B ED  JSR sub_0x03EDAB_очистка_адресов_cpu
...
C - - - - - 0x036562 0D:A552: B9 20 05  LDA ram_obj_state_hi,Y ; 0520 
...
sub_A56E:
C - - - - - 0x03657E 0D:A56E: 9D E2 06  STA ram_06E2_cpu,X ; 06E2 06E3 
...
- - - - - - 0x03658F 0D:A57F: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X
...
; con_fighter___hot
                                        ...
                                        BNE bra_A573_casey_ai_ждет    ; jmp
bra_A571:
                                        LDA ram_plr_индекс_атаки,Y
...
- - - - - - 0x03659A 0D:A58A: B9 20 05  LDA ram_obj_state_hi,Y
- - - - - - 0x03659D 0D:A58D: C9 08     CMP #con_plr_state_делает_суперку
- - - - - - 0x03659F 0D:A58F: D0 49     BNE bra_A5DA
- - - - - - 0x0365A1 0D:A591: B9 54 05  LDA ram_obj_id + $04,Y
...
- - - - - - 0x0365AC 0D:A59C: C9 37     CMP #con_0552_special_casey_клюшка
...
- - - - - - 0x036606 0D:A5F6: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X
bra_A5F9:
- - - - - - 0x036609 0D:A5F9: 90 05     BCC bra_A600
- - - - - - 0x03660B 0D:A5FB: B9 40 05  LDA ram_obj_state_lo,Y
- - - - - - 0x03660E 0D:A5FE: D0 5A     BNE bra_A65A
bra_A600:
- - - - - - 0x036612 0D:A602: B9 10 05  LDA ram_obj_flip,Y
- - - - - - 0x036615 0D:A605: DD 10 05  CMP ram_obj_flip,X
...
- - - - - - 0x036620 0D:A610: BD 20 05  LDA ram_obj_state_hi,X
...
bra_A65C:
loc_A65C:
- - - - - - 0x03666C 0D:A65C: 9D C0 06  STA ram_cpu_шаблон_ai,X
- - - - - - 0x03666F 0D:A65F: 9D E2 06  STA ram_06E2_cpu,X
bra_A662_RTS:
...
- - - - - - 0x036689 0D:A679: B9 00 06  LDA ram_0600_plr,Y
...
bra_A694:
- - - - - - 0x0366A4 0D:A694: BD C0 06  LDA ram_cpu_шаблон_ai,X
...
- - - - - - 0x0366A9 0D:A699: D0 0E     BNE bra_A6A9
                                    ...
                                    .else
                                        ...
                                        BEQ bra_A6A8_shred
                                    .endif
- - - - - - 0x0366AB 0D:A69B: BD C0 04  LDA ram_obj_hit_state,X
...
- - - - - - 0x0366FE 0D:A6EE: C9 05     CMP #con_0612_черепаха_нога_сидя_обычная
- - - - - - 0x036700 0D:A6F0: D0 0A     BNE bra_A6FC
- - - - - - 0x036702 0D:A6F2: BD 2C 06  LDA ram_062C_plr,X
...
C - - - - - 0x036747 0D:A737: 4C 14 EE  JMP loc_0x03EE24_проверка_доступности_мяча_для_подбора
bra_A73A:
...
bra_A814:
- - - - - - 0x036824 0D:A814: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X
- - - - - - 0x036827 0D:A817: B9 20 05  LDA ram_obj_state_hi,Y
...
- - - - - - 0x037C34 0D:BC24: B9 54 05  LDA ram_obj_id + $04,Y
- - - - - - 0x037C37 0D:BC27: D0 D1     BNE bra_BBFA
; if con_0552_00
- - - - - - 0x037C39 0D:BC29: 4C 07 BE  JMP loc_BE07
bra_BC34:
- - - - - - 0x037C44 0D:BC34: BD 20 05  LDA ram_obj_state_hi,X
...
- - - - - - 0x037C52 0D:BC42: B9 54 05  LDA ram_obj_id + $04,Y
- - - - - - 0x037C55 0D:BC45: D0 B0     BNE bra_BBF7
; if con_0552_00
- - - - - - 0x037C57 0D:BC47: BD 2C 06  LDA ram_062C_plr,X
- - - - - - 0x037C5A 0D:BC4A: F0 16     BEQ bra_BC62
- - - - - - 0x037C5C 0D:BC4C: BD 26 06  LDA ram_0626_plr,X
...
- - - - - - 0x037D76 0D:BD66: 00        .byte $00   ; 06 con_fighter_shred
                                    .if con_новые_персы <> $00
                                        ...
                                        .byte con_шаблон_ai_01   ; 0A con_fighter___don
                                        .byte con_шаблон_ai_01   ; 0B con_fighter___casey
...
C - - - - - 0x037D9A 0D:BD8A: BD 50 05  LDA ram_obj_id,X ; 0550 0551 
                                    .if con_новые_персы = $00
C - - - - - 0x037D9D 0D:BD8D: C9 06     CMP #con_fighter_shred
...
- - - - - - 0x037DAF 0D:BD9F: BD 2C 06  LDA ram_062C_plr,X
...
- - - - - - 0x037DBA 0D:BDAA: 90 13     BCC bra_BDBF
                                        JSR sub_BDEE_проверка_нахождения_в_углу
                                        BCC bra_BDBF
- - - - - - 0x037DC7 0D:BDB7: BD C0 04  LDA ram_obj_hit_state,X
- - - - - - 0x037DCA 0D:BDBA: 49 06     EOR #$06
- - - - - - 0x037DCC 0D:BDBC: D0 27     BNE bra_BDE5
bra_BDBF:
- - - - - - 0x037DCF 0D:BDBF: BD 00 06  LDA ram_0600_plr,X
- - - - - - 0x037DD2 0D:BDC2: 30 1E     BMI bra_BDE2
- - - - - - 0x037DD4 0D:BDC4: B9 00 06  LDA ram_0600_plr,Y
- - - - - - 0x037DD7 0D:BDC7: 30 1C     BMI bra_BDE5
- - - - - - 0x037DD9 0D:BDC9: B9 12 06  LDA ram_plr_индекс_атаки,Y
- - - - - - 0x037DDC 0D:BDCC: C9 01     CMP #con_0612_черепаха_нога_ближняя
...
loc_BE07:
- - - - - - 0x037E17 0D:BE07: BD 20 05  LDA ram_obj_state_hi,X
...
- - - - - - 0x037E2D 0D:BE1D: 7D 10 05  ADC ram_obj_flip,X
- - - - - - 0x037E30 0D:BE20: C9 41     CMP #$41
- - - - - - 0x037E32 0D:BE22: 90 0F     BCC bra_BE33
- - - - - - 0x037E34 0D:BE24: BD F0 05  LDA ram_05F0_obj,X
...
- - - - - - 0x037EA9 0D:BE99: BC DE 06  LDY ram_06DE_cpu_индекс_соперника,X
- - - - - - 0x037EAC 0D:BE9C: 20 AD A1  JSR sub_A1AD_проверка_за_спиной_ли_перс
- - - - - - 0x037EAF 0D:BE9F: D0 43     BNE bra_BEE4_RTS
- - - - - - 0x037EB1 0D:BEA1: 20 42 BF  JSR sub_BF42_проверка_на_запущенный_мяч
- - - - - - 0x037EB4 0D:BEA4: D0 04     BNE bra_BEAA
- - - - - - 0x037EB6 0D:BEA6: A9 01     LDA #con_шаблон_ai_01
- - - - - - 0x037EB8 0D:BEA8: D0 38     BNE bra_BEE2   ; jmp
bra_BEAA:
- - - - - - 0x037EBA 0D:BEAA: B9 20 05  LDA ram_obj_state_hi,Y
...
; if персы достаточно далеко друг от друга
- - - - - - 0x037F0C 0D:BEFC: 20 C2 EC  JSR sub_0x03ECD2_генератор_рандома_для_Y_1
...
sub_BF42_проверка_на_запущенный_мяч:
C - - - - - 0x037F52 0D:BF42: B9 20 05  LDA ram_obj_state_hi,Y ; 0520 0521 
...
C - - - - - 0x037F5C 0D:BF4C: CD A6 05  CMP ram_05A0_obj_флаги_мяча + $06
...
; con_fighter_shred
; con_fighter___shred
- - - - - - 0x037F7D 0D:BF6D: BD 10 05  LDA ram_obj_flip,X
- - - - - - 0x037F80 0D:BF70: D9 10 05  CMP ram_obj_flip,Y
- - - - - - 0x037F83 0D:BF73: F0 24     BEQ bra_BF99_RTS
- - - - - - 0x037F85 0D:BF75: 20 AD A1  JSR sub_A1AD_проверка_за_спиной_ли_перс
- - - - - - 0x037F88 0D:BF78: D0 20     BNE bra_BF9A
- - - - - - 0x037F8A 0D:BF7A: BD 20 05  LDA ram_obj_state_hi,X
...
.out .sprintf("Free bytes in bank 1A: %d [%Xh]", ($C000 - *), ($C000 - *))
