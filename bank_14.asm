...
C - - - - - 0x02BF4C 0A:BF3C: 9D 60 04  STA ram_obj_spd_Z_hi,X
C - - - - - 0x02BF4F 0A:BF3F: B9 EA BF  LDA tbl_BFEA,Y
C - - - - - 0x02BF52 0A:BF42: 9D 80 04  STA ram_obj_spd_X_hi,X
...
C - - - - - 0x02BF78 0A:BF68: 9D 60 04  STA ram_obj_spd_Z_hi,X
