...
; bzk garbage, данные спрайтов для несуществующего 8го перса
- - - - - - 0x02BBAE 0A:BB9E: B8 BB     .word _мусор_BBB8_80
- - - - - - 0x02BBB0 0A:BBA0: D1 BB     .word _мусор_BBD1_81
- - - - - - 0x02BBB2 0A:BBA2: D9 BB     .word _мусор_BBD9_82
- - - - - - 0x02BBB4 0A:BBA4: E1 BB     .word _мусор_BBE1_83
- - - - - - 0x02BBB6 0A:BBA6: E9 BB     .word _мусор_BBE9_84
- - - - - - 0x02BBB8 0A:BBA8: 02 BC     .word _мусор_BC02_85
- - - - - - 0x02BBBA 0A:BBAA: 1B BC     .word _мусор_BC1B_86
- - - - - - 0x02BBBC 0A:BBAC: 33 BC     .word _мусор_BC33_87
- - - - - - 0x02BBBE 0A:BBAE: 3F BC     .word _мусор_BC3F_88
- - - - - - 0x02BBC0 0A:BBB0: 58 BC     .word _мусор_BC58_89
- - - - - - 0x02BBC2 0A:BBB2: 23 BC     .word _мусор_BC23_8A
- - - - - - 0x02BBC4 0A:BBB4: 2B BC     .word _мусор_BC2B_8B
- - - - - - 0x02BBC6 0A:BBB6: 79 BC     .word _мусор_BC79_8C

_мусор_BBB8_80:
- - - - - - 0x02BBC8 0A:BBB8: 06        .byte $06   ; 
- - - - - - 0x02BBC9 0A:BBB9: 00        .byte $00, $C2, $02, $00   ; 
- - - - - - 0x02BBCD 0A:BBBD: 00        .byte $00, $C4, $02, $08   ; 
- - - - - - 0x02BBD1 0A:BBC1: 00        .byte $00, $C6, $02, $10   ; 
- - - - - - 0x02BBD5 0A:BBC5: 00        .byte $00, $C8, $02, $18   ; 
- - - - - - 0x02BBD9 0A:BBC9: 00        .byte $00, $CA, $02, $20   ; 
- - - - - - 0x02BBDD 0A:BBCD: 00        .byte $00, $CC, $02, $28   ; 

_мусор_BBD1_81:
- - - - - - 0x02BBE1 0A:BBD1: 06        .byte $06   ; 
- - - - - - 0x02BBE2 0A:BBD2: 00        .byte $00, $CE, $02, $28   ; 
- - - - - - 0x02BBE6 0A:BBD6: 80        .byte $80, $B9, $BB   ; 

_мусор_BBD9_82:
- - - - - - 0x02BBE9 0A:BBD9: 06        .byte $06   ; 
- - - - - - 0x02BBEA 0A:BBDA: 00        .byte $00, $D0, $02, $28   ; 
- - - - - - 0x02BBEE 0A:BBDE: 80        .byte $80, $B9, $BB   ; 

_мусор_BBE1_83:
- - - - - - 0x02BBF1 0A:BBE1: 06        .byte $06   ; 
- - - - - - 0x02BBF2 0A:BBE2: 00        .byte $00, $D2, $02, $28   ; 
- - - - - - 0x02BBF6 0A:BBE6: 80        .byte $80, $B9, $BB   ; 

_мусор_BBE9_84:
- - - - - - 0x02BBF9 0A:BBE9: 06        .byte $06   ; 
- - - - - - 0x02BBFA 0A:BBEA: 00        .byte $00, $D4, $02, $00   ; 
- - - - - - 0x02BBFE 0A:BBEE: 00        .byte $00, $D6, $02, $08   ; 
- - - - - - 0x02BC02 0A:BBF2: 00        .byte $00, $D8, $02, $10   ; 
- - - - - - 0x02BC06 0A:BBF6: 00        .byte $00, $DA, $02, $18   ; 
- - - - - - 0x02BC0A 0A:BBFA: 00        .byte $00, $DC, $02, $20   ; 
- - - - - - 0x02BC0E 0A:BBFE: 00        .byte $00, $DE, $02, $28   ; 

_мусор_BC02_85:
- - - - - - 0x02BC12 0A:BC02: 06        .byte $06   ; 
- - - - - - 0x02BC13 0A:BC03: 00        .byte $00, $CC, $02, $08   ; 
- - - - - - 0x02BC17 0A:BC07: 00        .byte $00, $E0, $02, $10   ; 
- - - - - - 0x02BC1B 0A:BC0B: 00        .byte $00, $FE, $02, $00   ; 
- - - - - - 0x02BC1F 0A:BC0F: 00        .byte $00, $E6, $02, $18   ; 
- - - - - - 0x02BC23 0A:BC13: 00        .byte $00, $E8, $02, $20   ; 
- - - - - - 0x02BC27 0A:BC17: 00        .byte $00, $EA, $02, $28   ; 

_мусор_BC1B_86:
- - - - - - 0x02BC2B 0A:BC1B: 06        .byte $06   ; 
- - - - - - 0x02BC2C 0A:BC1C: 00        .byte $00, $CE, $02, $08   ; 
- - - - - - 0x02BC30 0A:BC20: 80        .byte $80, $07, $BC   ; 

_мусор_BC23_8A:
- - - - - - 0x02BC33 0A:BC23: 06        .byte $06   ; 
- - - - - - 0x02BC34 0A:BC24: 00        .byte $00, $D0, $02, $08   ; 
- - - - - - 0x02BC38 0A:BC28: 80        .byte $80, $07, $BC   ; 

_мусор_BC2B_8B:
- - - - - - 0x02BC3B 0A:BC2B: 06        .byte $06   ; 
- - - - - - 0x02BC3C 0A:BC2C: 00        .byte $00, $D2, $02, $08   ; 
- - - - - - 0x02BC40 0A:BC30: 80        .byte $80, $07, $BC   ; 

_мусор_BC33_87:
- - - - - - 0x02BC43 0A:BC33: 06        .byte $06   ; 
- - - - - - 0x02BC44 0A:BC34: 00        .byte $00, $E2, $02, $08   ; 
- - - - - - 0x02BC48 0A:BC38: 00        .byte $00, $E4, $02, $10   ; 
- - - - - - 0x02BC4C 0A:BC3C: 80        .byte $80, $0B, $BC   ; 

_мусор_BC3F_88:
- - - - - - 0x02BC4F 0A:BC3F: 06        .byte $06   ; 
- - - - - - 0x02BC50 0A:BC40: 00        .byte $00, $FE, $02, $00   ; 
- - - - - - 0x02BC54 0A:BC44: 00        .byte $00, $EC, $02, $08   ; 
- - - - - - 0x02BC58 0A:BC48: 00        .byte $00, $EE, $02, $10   ; 
- - - - - - 0x02BC5C 0A:BC4C: 00        .byte $00, $F0, $02, $18   ; 
- - - - - - 0x02BC60 0A:BC50: 00        .byte $00, $F2, $02, $20   ; 
- - - - - - 0x02BC64 0A:BC54: 00        .byte $00, $FE, $02, $28   ; 

_мусор_BC58_89:
- - - - - - 0x02BC68 0A:BC58: 08        .byte $08   ; 
- - - - - - 0x02BC69 0A:BC59: 00        .byte $00, $EC, $02, $00   ; 
- - - - - - 0x02BC6D 0A:BC5D: 00        .byte $00, $C4, $02, $08   ; 
- - - - - - 0x02BC71 0A:BC61: 00        .byte $00, $C6, $02, $10   ; 
- - - - - - 0x02BC75 0A:BC65: 00        .byte $00, $F4, $02, $18   ; 
- - - - - - 0x02BC79 0A:BC69: 00        .byte $00, $F6, $02, $20   ; 
- - - - - - 0x02BC7D 0A:BC6D: 00        .byte $00, $F8, $02, $28   ; 
- - - - - - 0x02BC81 0A:BC71: 00        .byte $00, $FA, $02, $30   ; 
- - - - - - 0x02BC85 0A:BC75: 00        .byte $00, $FC, $02, $38   ; 

_мусор_BC79_8C:
- - - - - - 0x02BC89 0A:BC79: 08        .byte $08   ; 
- - - - - - 0x02BC8A 0A:BC7A: 09        .byte $09, $6F, $03, $F8   ; 
- - - - - - 0x02BC8E 0A:BC7E: 09        .byte $09, $6F, $43, $00   ; 
- - - - - - 0x02BC92 0A:BC82: E9        .byte $E9, $67, $02, $F4   ; 
- - - - - - 0x02BC96 0A:BC86: E9        .byte $E9, $69, $02, $FC   ; 
- - - - - - 0x02BC9A 0A:BC8A: F9        .byte $F9, $6B, $02, $F4   ; 
- - - - - - 0x02BC9E 0A:BC8E: F9        .byte $F9, $6D, $02, $FC   ; 
- - - - - - 0x02BCA2 0A:BC92: E9        .byte $E9, $67, $42, $04   ; 
- - - - - - 0x02BCA6 0A:BC96: F9        .byte $F9, $6B, $42, $04   ; 
...
C - - - - - 0x02BDA8 0A:BD98: 8D A1 04  STA ram_obj_04A0 + $01
loc_BD9B:
...
C - - - - - 0x02BDBD 0A:BDAD: 8D B1 04  STA ram_obj_04B0 + $01
...
C - - - - - 0x02BE04 0A:BDF4: AC B1 04  LDY ram_obj_04B0 + $01
...
C - - - - - 0x02BE52 0A:BE42: EE B1 04  INC ram_obj_04B0 + $01
bra_BE45_RTS:
...
C - - - - - 0x02BE67 0A:BE57: 99 40 04  STA ram_obj_pos_X,Y
C - - - - - 0x02BE6A 0A:BE5A: A9 80     LDA #$80
C - - - - - 0x02BE6C 0A:BE5C: 99 10 04  STA ram_obj_pos_Y,Y
C - - - - - 0x02BE6F 0A:BE5F: A9 01     LDA #$01
C - - - - - 0x02BE71 0A:BE61: 99 30 05  STA ram_obj_0530,Y
...
C - - - - - 0x02BE7A 0A:BE6A: EE A1 04  INC ram_obj_04A0 + $01
C - - - - - 0x02BE7D 0A:BE6D: AD A1 04  LDA ram_obj_04A0 + $01
...
sub_BEC3:
C - - - - - 0x02BED3 0A:BEC3: AD A1 04  LDA ram_obj_04A0 + $01
...
C - - - - - 0x02BEEF 0A:BEDF: 20 5F D2  JSR sub_0x03D26F_записать_A_в_буфер_без_чтения_индекса
C - - - - - 0x02BEF2 0A:BEE2: A5 00     LDA ram_0000
C - - - - - 0x02BEF4 0A:BEE4: 20 5F D2  JSR sub_0x03D26F_записать_A_в_буфер_без_чтения_индекса
bra_BEE7_loop:
C - - - - - 0x02BEF7 0A:BEE7: B9 90 BF  LDA tbl_BF90,Y
C - - - - - 0x02BEFA 0A:BEEA: 20 5F D2  JSR sub_0x03D26F_записать_A_в_буфер_без_чтения_индекса
...
bra_BEFB:
C - - - - - 0x02BF0B 0A:BEFB: AD A1 04  LDA ram_obj_04A0 + $01
...
C - - - - - 0x02BF1B 0A:BF0B: 20 5F D2  JSR sub_0x03D26F_записать_A_в_буфер_без_чтения_индекса
C - - - - - 0x02BF1E 0A:BF0E: 4C 5B D2  JMP loc_0x03D26B_записать_FF_в_буфер
...
bra_BF13_loop:
C - - - - - 0x02BF23 0A:BF13: BD 30 05  LDA ram_obj_0530,X
...
sub_BF22:
C - - - - - 0x02BF32 0A:BF22: 20 49 DB  JSR sub_0x03DB59
C - - - - - 0x02BF35 0A:BF25: BD 30 05  LDA ram_obj_0530,X
...
C - - - - - 0x02BF4C 0A:BF3C: 9D 60 04  STA ram_obj_0460,X
C - - - - - 0x02BF4F 0A:BF3F: B9 EA BF  LDA tbl_BFEA,Y
C - - - - - 0x02BF52 0A:BF42: 9D 80 04  STA ram_obj_0480,X
C - - - - - 0x02BF55 0A:BF45: B9 EF BF  LDA tbl_BFEF_анимация,Y
C - - - - - 0x02BF58 0A:BF48: 9D 00 04  STA ram_plr_anim_id,X
C - - - - - 0x02BF5B 0A:BF4B: B9 F4 BF  LDA tbl_BFF4,Y
C - - - - - 0x02BF5E 0A:BF4E: 9D 10 05  STA ram_obj_0510,X
C - - - - - 0x02BF61 0A:BF51: FE 30 05  INC ram_obj_0530,X
C - - - - - 0x02BF64 0A:BF54: A9 80     LDA #$80
C - - - - - 0x02BF66 0A:BF56: 9D E0 05  STA ram_obj_05E0,X
C - - - - - 0x02BF69 0A:BF59: 9D 80 05  STA ram_obj_0580,X
C - - - - - 0x02BF6C 0A:BF5C: 0A        ASL
C - - - - - 0x02BF6D 0A:BF5D: 9D B0 05  STA ram_obj_05B0,X
bra_BF60_RTS:
...
C - - - - - 0x02BF78 0A:BF68: 9D 60 04  STA ram_obj_0460,X
C - - - - - 0x02BF7B 0A:BF6B: FE 30 05  INC ram_obj_0530,X
ofs_042_BF6E_03:
...
ofs_042_BF7E_04:
C - - - - - 0x02BF8E 0A:BF7E: DE 60 05  DEC ram_obj_0560,X
