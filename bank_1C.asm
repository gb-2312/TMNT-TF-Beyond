...
C D 0 - - - 0x038011 0E:8001: A5 95     LDA ram_0095_скрипт
...
C - - - - - 0x0382E0 0E:82D0: A4 95     LDY ram_0095_скрипт
...
C - - - - - 0x0388A0 0E:8890: A5 95     LDA ram_0095_скрипт
...
C - - - - - 0x0388C5 0E:88B5: E6 95     INC ram_0095_скрипт    ; 00 -> 01
...
C - - - - - 0x0388E7 0E:88D7: E6 95     INC ram_0095_скрипт    ; 01 -> 02
...
C - - - - - 0x038996 0E:8986: E6 95     INC ram_0095_скрипт    ; 02 -> 03
...
C - - - - - 0x0389A9 0E:8999: E6 95     INC ram_0095_скрипт    ; 03 -> 04
...
; предположительно это уже основной для 0x03E197, а не для 0x0388A2
                                       ;LDA #con_0095_00
C - - - - - 0x0389B1 0E:89A1: 85 95     STA ram_0095_скрипт
...
C - - - - - 0x038B07 0E:8AF7: A5 95     LDA ram_0095_скрипт
...
bra_8B2F:
C - - - - - 0x038B3F 0E:8B2F: A5 95     LDA ram_0095_скрипт
...
C - - - - - 0x03A37C 0E:A36C: A5 95     LDA ram_0095_скрипт
...
bra_A383:
C - - - - - 0x03A393 0E:A383: E6 95     INC ram_0095_скрипт    ; ?? -> ??
...
C - - - - - 0x03A461 0E:A451: 85 96     STA ram_0096
                                       ;LDA #con_0095_12
C - - - - - 0x03A463 0E:A453: E6 95     INC ram_0095_скрипт    ; 11 -> 12
...
; con_gm_vs_cpu
; con_gm_tournament
C - - - - - 0x03BF49 0E:BF39: A5 95     LDA ram_0095_скрипт
