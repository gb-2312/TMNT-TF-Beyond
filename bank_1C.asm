...
; bzk optimize
; можно сразу отрисовать 2 части экрана с опциями в двух соседних nametable
; и переключаться между ними при необходимости. тогда не нужно будет постоянно
; перерисовывать все опции сразу, достаточно обрабатывать текущую опцию. также
; это позволит избавиться от зависимости 00AD и ускорит отрисовку экрана
