...
.export sub_0x0385E6
.export sub_0x0388A0_обработка_экрана_с_выбором_карты
...
sub_0x0388A0_обработка_экрана_с_выбором_карты:
...
- D 0 - I - 0x0388AD 0E:889D: 9E 89     .word ofs_013_899E_04_подготовить_следующий_скрипт
...
C - - - - - 0x03965C 0E:964C: B9 57 99  LDA tbl_9957_цвет,Y
...
C - - - - - 0x03972D 0E:971D: 20 7C D0  JSR sub_0x03D08C_обработка_анимации_объекта
