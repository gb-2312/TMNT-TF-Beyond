...
C - - - - - 0x038093 0E:8083: AD B0 04  LDA ram_obj_spd_Y_lo
...
C - - - - - 0x0380A5 0E:8095: 20 90 F6  JSR sub_0x03F6A0_записать_звук_сохранив_X_Y
...
C - - - - - 0x0380AF 0E:809F: 6D B0 04  ADC ram_obj_spd_Y_lo
...
; con_0x030C10_24
; con_0x030C10_25
C - - - - - 0x03812B 0E:811B: 4C E5 F6  JMP loc_0x03F6F5_написать_текст_на_экране
...
; con_0x030C10_13
; con_0x030C10_14
C - - - - - 0x03813C 0E:812C: 4C E5 F6  JMP loc_0x03F6F5_написать_текст_на_экране
...
; con_0x030C10_21
; con_0x030C10_22
C - - - - - 0x038162 0E:8152: 4C E5 F6  JMP loc_0x03F6F5_написать_текст_на_экране
...
; con_0x030C10_1D
; con_0x030C10_1E
C - - - - - 0x038188 0E:8178: 4C E5 F6  JMP loc_0x03F6F5_написать_текст_на_экране
bra_817B_RTS:
...
tbl_9073:
- D 0 - - - 0x039083 0E:9073: 04        .byte con_0x03D0C3_04   ; 00 leo
- D 0 - - - 0x039084 0E:9074: 04        .byte con_0x03D0C3_04   ; 01 raph
- D 0 - - - 0x039085 0E:9075: 04        .byte con_0x03D0C3_04   ; 02 mike
- D 0 - - - 0x039086 0E:9076: 04        .byte con_0x03D0C3_04   ; 03 don
- D 0 - - - 0x039087 0E:9077: 06        .byte con_0x03D0C3_06   ; 04 casey
- D 0 - - - 0x039088 0E:9078: 0A        .byte con_0x03D0C3_0A   ; 05 hot
- D 0 - - - 0x039089 0E:9079: 10        .byte con_0x03D0C3_10   ; 06 shred
...
C - - - - - 0x0390B7 0E:90A7: A5 21     LDA ram_subscript
...
ofs_010_90D6_00:
C - - J - - 0x0390E6 0E:90D6: E6 21     INC ram_subscript
...
C - - - - - 0x03911B 0E:910B: E6 21     INC ram_subscript
...
C - - - - - 0x039154 0E:9144: E6 21     INC ram_subscript
...
C - - - - - 0x039166 0E:9156: E6 21     INC ram_subscript
bra_9158_RTS:
...
bra_915E:
C - - - - - 0x03916E 0E:915E: E6 21     INC ram_subscript
...
C - - - - - 0x039185 0E:9175: E6 21     INC ram_subscript
...
C - - - - - 0x0391A6 0E:9196: E6 21     INC ram_subscript
...
C - - - - - 0x0391BB 0E:91AB: E6 21     INC ram_subscript
...
loc_91E5:
C D 0 - - - 0x0391F5 0E:91E5: E6 21     INC ram_subscript
...
C - - - - - 0x0392AD 0E:929D: A5 21     LDA ram_subscript
...
bra_92FB:
C - - - - - 0x03930B 0E:92FB: A5 21     LDA ram_subscript
...
C - - - - - 0x039328 0E:9318: A5 21     LDA ram_subscript
...
C - - - - - 0x0393A7 0E:9397: A5 21     LDA ram_subscript
...
sub_0x039610:
C - - - - - 0x039610 0E:9600: A5 21     LDA ram_subscript
...
ofs_007_9623_00:
C - - J - - 0x039633 0E:9623: E6 21     INC ram_subscript
...
C - - - - - 0x03969A 0E:968A: E6 21     INC ram_subscript
...
C - - - - - 0x0396BB 0E:96AB: E6 21     INC ram_subscript
C - - - - - 0x0396BD 0E:96AD: 4C 2E E1  JMP loc_0x03E13E
bra_96B0:
- - - - - - 0x0396C0 0E:96B0: A9 0D     LDA #$0D
- - - - - - 0x0396C2 0E:96B2: 85 21     STA ram_subscript
...
ofs_007_96BA_03:
C - - J - - 0x0396CA 0E:96BA: E6 21     INC ram_subscript
C - - - - - 0x0396CC 0E:96BC: 4C 42 F0  JMP loc_0x03F052_отрисовать_пустой_экран



ofs_007_96BF_04:
C - - J - - 0x0396CF 0E:96BF: E6 21     INC ram_subscript
...
C - - - - - 0x03972B 0E:971B: A0 19     LDY #con_0x03D0C3_19
...
C - - - - - 0x039780 0E:9770: A0 0E     LDY #con_0x03D0C3_0E
C - - - - - 0x039782 0E:9772: 20 7C D0  JSR sub_0x03D08C
C - - - - - 0x039785 0E:9775: A0 0E     LDY #con_0x03D0C3_0E
...
ofs_006_9838_0A:
C - - J - - 0x039848 0E:9838: E6 21     INC ram_subscript
...
C - - - - - 0x039855 0E:9845: E6 21     INC ram_subscript
...
C - - - - - 0x039875 0E:9865: E6 21     INC ram_subscript
...
; if expert
- - - - - - 0x0398B3 0E:98A3: E6 21     INC ram_subscript
- - - - - - 0x0398B5 0E:98A5: 4C 2E E1  JMP loc_0x03E13E
bra_98A8:
C - - - - - 0x0398B8 0E:98A8: A9 0E     LDA #$0E
C - - - - - 0x0398BA 0E:98AA: 85 21     STA ram_subscript
...
- - - - - - 0x0398CE 0E:98BE: 85 21     STA ram_subscript
...
C - - - - - 0x039958 0E:9948: 85 21     STA ram_subscript
...
tbl_994D:
- D 0 - - - 0x03995D 0E:994D: 22        .byte con_screen_ending_1   ; 00
- D 0 - - - 0x03995E 0E:994E: 24        .byte con_screen_ending_3   ; 01
...
bra_99D8_FD:
- - - - - - 0x0399E8 0E:99D8: E6 21     INC ram_subscript
...
C - - - - - 0x039FD7 0E:9FC7: A5 21     LDA ram_subscript
...
C - - - - - 0x039FEE 0E:9FDE: E6 21     INC ram_subscript
...
; con_0x030C10_2E
; con_0x030C10_2F
C - - - - - 0x03A655 0E:A645: 20 E5 F6  JSR sub_0x03F6F5_написать_текст_на_экране
...
; con_0x030C10_32
; con_0x030C10_33
C - - - - - 0x03A6B5 0E:A6A5: 4C E5 F6  JMP loc_0x03F6F5_написать_текст_на_экране
...
C - - - - - 0x03A6D2 0E:A6C2: 20 90 F6  JSR sub_0x03F6A0_записать_звук_сохранив_X_Y
sub_A6C5:
...
bra_A72F_loop:
C - - - - - 0x03A73F 0E:A72F: 20 5F D2  JSR sub_0x03D26F_записать_A_в_буфер_с_сохранением_индекса
C - - - - - 0x03A742 0E:A732: 88        DEY
C - - - - - 0x03A743 0E:A733: 10 FA     BPL bra_A72F_loop
C - - - - - 0x03A745 0E:A735: 4C 59 D2  JMP loc_0x03D269_записать_FF_в_буфер_без_чтения_индекса
