...
sub_8452_нарисовать_рожи_персов_на_экране_выбора_карты:
...
C - - - - - 0x0388C2 0E:88B2: 20 2F F7  JSR sub_8452_нарисовать_рожи_персов_на_экране_выбора_карты
...
tbl_994F:
- D 0 - - - 0x03995F 0E:994F: 0A        .byte con_chr_pair_0A   ; 00
- D 0 - - - 0x039960 0E:9950: 0C        .byte con_chr_pair_0C   ; 01
