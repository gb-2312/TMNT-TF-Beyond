...
C - - - - - 0x0300A1 0C:8091: 20 5F D2  JSR sub_0x03D26F_записать_A_в_буфер_без_с_сохранением_индекса
C - - - - - 0x0300A4 0C:8094: C8        INY
C - - - - - 0x0300A5 0C:8095: B1 00     LDA (ram_0000),Y
C - - - - - 0x0300A7 0C:8097: 20 5F D2  JSR sub_0x03D26F_записать_A_в_буфер_без_с_сохранением_индекса
...
C - - - - - 0x0300B8 0C:80A8: 20 5F D2  JSR sub_0x03D26F_записать_A_в_буфер_без_с_сохранением_индекса
