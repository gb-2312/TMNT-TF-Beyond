...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0307B7 0C:87A7: 2F        .byte $2F, $1B, $02, $09   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0307DC 0C:87CC: 1D        .byte $1D, $4F, $00, $00   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030805 0C:87F5: 10        .byte $10, $65, $00, $20   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x03082A 0C:881A: 08        .byte $08, $29, $00, $10   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- - - - - - 0x030847 0C:8837: 08        .byte $08, $37, $00, $10   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030864 0C:8854: 00        .byte $00, $0D, $00, $18   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0308A9 0C:8899: 10        .byte $10, $2F, $00, $10   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0308EA 0C:88DA: 10        .byte $10, $31, $00, $00   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- - - - - - 0x03091F 0C:890F: 10        .byte $10, $4B, $00, $13   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- - - - - - 0x030948 0C:8938: 00        .byte $00, $21, $00, $00   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- - - - - - 0x03095D 0C:894D: 00        .byte $00, $2D, $00, $00   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- - - - - - 0x030966 0C:8956: 00        .byte $00, $31, $00, $00   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x03096F 0C:895F: 00        .byte $00, $2B, $00, $00   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- - - - - - 0x030980 0C:8970: 00        .byte $00, $33, $00, $00   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- - - - - - 0x030989 0C:8979: 00        .byte $00, $37, $00, $00   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030992 0C:8982: F7        .byte $F7, $21, $00, $F8   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x03099B 0C:898B: F6        .byte $F6, $21, $00, $F8   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0309A4 0C:8994: F6        .byte $F6, $25, $00, $F9   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0309AD 0C:899D: F7        .byte $F7, $25, $00, $F9   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0309B6 0C:89A6: F7        .byte $F7, $29, $00, $F8   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0309BF 0C:89AF: F6        .byte $F6, $29, $00, $F8   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0309C8 0C:89B8: F5        .byte $F5, $2D, $00, $F8   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0309D1 0C:89C1: F6        .byte $F6, $2D, $00, $F8   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0309DA 0C:89CA: F7        .byte $F7, $31, $01, $F8   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x0309E3 0C:89D3: 00        .byte $00, $2B, $00, $18   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030A1C 0C:8A0C: 1A        .byte $1A, $19, $01, $D7   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030A45 0C:8A35: DF        .byte $DF, $31, $00, $F4   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030A66 0C:8A56: E9        .byte $E9, $31, $00, $F7   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030A77 0C:8A67: F3        .byte $F3, $35, $00, $F4   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030A90 0C:8A80: F4        .byte $F4, $33, $00, $E8   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030AAD 0C:8A9D: D5        .byte $D5, $27, $00, $FB   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030AC6 0C:8AB6: 15        .byte $15, $23, $00, $00   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030ACF 0C:8ABF: F8        .byte $F8, $71, $02, $F9   ; 
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030AD8 0C:8AC8: F8        .byte $F8, $75, $02, $FD   ; 
@end:
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030ADD 0C:8ACD: F8        .byte $F8, $77, $02, $FD   ; 
@end:
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030AE2 0C:8AD2: F8        .byte $F8, $79, $02, $FD   ; 
@end:
...
;                                              |    |    |    +----- spr_X
;                                              |    |    |    |
- D 0 - I - 0x030AE7 0C:8AD7: F8        .byte $F8, $43, $03, $00   ; 
...
bra_9008_loop:
C - - - - - 0x031018 0C:9008: BD 44 01  LDA ram_0144,X ; 0144 0145 
